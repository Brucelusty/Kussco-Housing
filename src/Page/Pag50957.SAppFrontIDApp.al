...
Page 50957 "SApp FrontID-App"
{
        ...
        area(processing)
        {
               ...
               action(ExportFile)
            {
                ...
                begin
                    ...
                    // ExportPath := TemporaryPath + Rec."No." + Format(Rec."ID Front".MediaId);
                    // Rec."ID Front".ExportFile(ExportPath);
  ...
  procedure ImportFromDevice()
    ...
    begin
        ...
        Clear(Rec."ID Front");
        // Rec."ID Front".ImportFile(FileName, ClientFileName);
    ...
    local procedure OnAfterTakeNewPicture(var Item: Record "FOSA Account Applicat. Details"; IsPictureAdded: Boolean)
    begin
    end;
    ...
    begin
        ...
        if Camera.GetPicture(PictureInstream, PictureDescription) then begin
            Clear(Rec."ID Front");
            Rec."ID Front".ImportStream(PictureInstream, PictureDescription, MimeTypeTok);
            Rec.Modify(true);
            exit(true);
        end;
