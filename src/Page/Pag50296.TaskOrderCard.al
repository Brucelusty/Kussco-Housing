Page 50296 "Task Order Card"
{
        ...
        area(processing)
        {
            ...
            action("Send Approval Request")
            {
                ...
                begin
                    ...
                    // if ApprovalsMgmt.CheckPurchaseOrderApprovalsWorkflowEnabled(Rec) then
                    //     ApprovalsMgmt.OnSendPurchaseOrderForApproval(Rec);
                end;
            }
            action("&Print")
            {
    ...
    begin
        ...
        Rec."No." := "No. Series".GetNextNo(PurchasesPayablesSetup."Requisition No", Today, true);
