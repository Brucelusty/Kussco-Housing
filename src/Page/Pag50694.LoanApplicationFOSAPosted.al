...
Page 50694 "Loan Application FOSA(Posted)"
{
    ApplicationArea = All;
    ...
    begin
        ...
        */
        ...
        GenJournalLine."account type"::Member, LoanApps."Client Code", Rec."Posting Date", LoanApps."Approved Amount", Format(LoanApps.Source), LoanApps."Loan  No.",
        ...
        if LoanApps."Loan Offset Amount" > 0 then begin
            ...
            if LoanTopUp.Find('-') then begin
                repeat
                    ...
                    GenJournalLine."account type"::Member, LoanApps."Client Code", Rec."Posting Date", LoanTopUp."Principle Top Up" * -1, Format(LoanApps.Source), LoanTopUp."Loan Top Up",
                    ...
                    GenJournalLine."account type"::Member, LoanApps."Client Code", Rec."Posting Date", LoanTopUp."Interest Top Up" * -1, Format(LoanApps.Source), LoanTopUp."Loan Top Up",
        ...
        if LoanApps."Boost this Loan" then begin
            ...
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Loan,
            GenJournalLine."account type"::Member, LoanApps."Client Code", Rec."Posting Date", LoanApps."Boosted Amount", Format(LoanApps.Source), BLoan,
            ...
            GenJournalLine."account type"::Member, Rec."Client Code", Rec."Posting Date", LoanApps."Boosted Amount" * -1, Format(LoanApps.Source), BLoan,
        ...
        if LoanApps."Boosting Commision" > 0 then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
            GenJournalLine."account type"::Member, Rec."Client Code", Rec."Posting Date", LoanApps."Boosted Amount Interest" * -1, Format(LoanApps.Source), BLoan,
