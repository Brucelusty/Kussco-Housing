...
Page 50866 "Posted Internal PV Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    PageType = Card;
            ...
            action("View Schedule")
            {
                ...
                begin
                    ...
                    if PVHeader.Find('-') then
                        Report.run(172875, true, true, PVHeader)
                end;
            }
        }
    }
    ...
    begin
        ...
        PVLinesDetails.SetRange(PVLinesDetails."Header No", Rec.No);
        PVLinesDetails.SetRange(PVLinesDetails.Type, PVLinesDetails.Type::Debit);
        if PVLinesDetails.Find('-') then begin
            repeat

                //------------------------------------1.1. Debit Source A/C---------------------------------------------------------------------------------------------
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                PVLinesDetails."Account Type", PVLinesDetails."Account No.", Today, PVLinesDetails.Amount, 'FOSA', '',
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, Rec."Cheque No", GenJournalLine."application source"::" ");
                //------------------------------------1.2. Credit Control A/C---------------------------------------------------------------------------------------------
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                GenJournalLine."account type"::"Bank Account", GenSetup."Internal PV Control Account", Today, PVLinesDetails.Amount * -1, 'FOSA', '',
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, '', GenJournalLine."application source"::" ");
        ...
        if PVLinesDetails.Find('-') then begin
            repeat
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                GenJournalLine."account type"::"Bank Account", GenSetup."Internal PV Control Account", Today, PVLinesDetails.Amount, 'FOSA', '',
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, Rec."Cheque No", GenJournalLine."application source"::" ");
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                PVLinesDetails."Account Type", PVLinesDetails."Account No.", Today, PVLinesDetails.Amount * -1, 'FOSA', '',
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, '', GenJournalLine."application source"::" ");
