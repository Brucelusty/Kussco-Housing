...
Page 50059 "Member FrontID-Uploaded"
{
    ApplicationArea = All;
    DelayedInsert = false;
    DeleteAllowed = false;
...
/*                     NameValueBuffer.DeleteAll;
                    ExportPath := TemporaryPath + "No." + Format("ID Front".MediaId);
                    "ID Front".ExportFile(ExportPath);
...
/*         ClientFileName := '';
    ...
    begin
        DeleteExportEnabled := Rec."ID Front".Count <> 0;
    end;
