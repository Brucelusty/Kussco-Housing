...
Page 50733 "BOSA Transfer"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    Caption = 'Account Transfer Card';
    PageType = Card;
            ...
            group(Posting)
            {
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        //Message('User%1Usered%2', FundsUSer.UserID, UserId);
                        //FundsUSer.Reset();
                        //FundsUSer.SetRange(FundsUSer.UserID, UserId);
                        //if FundsUSer.FindFirst() then begin
                ...
                action(Print)
                {
                    ...
                    begin
                        ...
                        if BTRANS.Find('-') then begin
                            Report.run(172442, true, true, BTRANS);
                        end;
                    end;
                }
            }
