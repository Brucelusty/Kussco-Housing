...
Page 50955 "Change FrontID-App"
{
    ...
    begin
        ...
        if UploadIntoStream('Import', '', 'All Files (*.*)|*.*', FileName, PictureStream) then begin
            Clear(Rec."ID Front");
            Rec."ID Front".ImportStream(PictureStream, FileName);
            Rec.Modify(true);
        end;
    ...
    local procedure OnAfterTakeNewPicture(var Item: Record "Change Request"; IsPictureAdded: Boolean)
    begin
    end;
