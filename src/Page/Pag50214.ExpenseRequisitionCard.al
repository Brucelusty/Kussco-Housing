Page 50214 "Expense Requisition Card"
{
    ApplicationArea = All;
            ...
            action(SendApprovalRequest)
            {
                ...
                begin
                    ...
                    if PurchaseLine3.Find('-') then begin
                        if PurchaseLine3."Shortcut Dimension 1 Code" = ' ' then Error('Fund No code must have a value in Lines');
                    end;
                    Rec.TestField(Status, Rec.Status::Open);
                    if ApprovalsMgmt.CheckPurchaseApprovalPossible(Rec) then
                        Rec.TestField("Total Unit Cost");
            ...
            action(ReopenforEditing)
            {
                ...
                begin
                    ...
                    if UserSetup.FindFirst() then begin
                        /* if UserSetup."Modify Forms" = false then begin
    ...
    begin
        ...
        //Rec."No." := "No. Series".GetNextNo(PurchasesPayablesSetup."Surrender Nos.", Today, true);
    ...
    */
    ...
    begin
        ...
        Rec."Document Type" := Rec."Document Type"::Quote;
        PurchasesPayablesSetup.Get;
        Rec."No." := "No. Series".GetNextNo(PurchasesPayablesSetup."Expense Reqisition Nos", Today, true);
        //Rec."Responsibility Center" := UserMgt.GetPurchasesFilter;
        Rec."Assigned User ID" := UserId;
        Rec."User ID" := UserId;
        Rec."Requested Receipt Date" := Today;
