page 51130 "Defaulter Case Card"
{
    ApplicationArea = All;
    PageType = Card;
    ...
    layout
    {
        area(Content)
        {
            group(General)
            {
                ...
                field("Loan Disbursement Date"; Rec."Loan Disbursement Date") { Editable=false;}
                field("Repayment Start Date"; Rec."Repayment Start Date") { Editable=false;}
                field("Expected Date of Completion"; Rec."Expected Date of Completion") {Editable=false; }
                field("Portfolio Officer"; Rec."Portfolio Officer") { }
                field("Followup Officer"; Rec."Followup Officer") { }
