...
Page 50071 "Loan Appraisal Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    InsertAllowed = false;
    Caption = 'Loan Pre-Appraisal Card';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Loan Payee"; Rec."Loan Payee")
                {
                    Caption = 'Who is Paying for the loan?';
            ...
            group("Individual Documents.")
            {
                ...
                field("Copy of M-Pesa Statement"; Rec."Copy of M-Pesa Statement")
                {
                    // Editable = CopyofPayslipEditable;
                }
    ...
    actions
    {
        area(navigation)
        {
            group(Loan)
            {
                ...
                {
                    Caption = 'Submit To Pre-Appraisal';
                ...
                action("Submit To Valuation")
                {
                    Caption = 'Submit for Valuation';
                    //Enabled = CanCancelApprovalForRecord;
                    Image = SendTo;
                    Promoted = true;
                    PromotedCategory = Process;
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to submit this form for valuation', false) = true then begin
                            rec."Loan Status" := rec."loan status"::Valuation;
                            rec."Approval Status" := rec."approval status"::Open;
