...
Page 50857 "Loan Reschedule Card"
{
    ApplicationArea = All;
    PageType = Card;
                ...
                action("Reschedule Loan")
                {
                    ...
                    begin
                        if Confirm('Are you sure you want to reshedule the loan') then begin
                           // Rec.TestField(Status, Rec.Status::Approved);
                            ...
                            if LoanRegister.FindFirst then begin
                                ...
                                LoanRegister.Installments := Rec."New Installments";
                                LoanRegister."Repayment Start Date" := Rec."Repayment Start Date";
                                LoanRegister.Modify;
                            end;
                            ...
                            Rec.TestField("New Installments");
                            ...
                            if LoanRegister.FindFirst then begin
                                ...
                                LoanAmount := Rec."Outstanding Loan Amount";
                                LoanBal := LoanAmount;
                                InterestRate := LoanRegister.Interest;
                                Installments := Rec."New Installments";
                                RepayDate := Rec."Repayment Start Date";
                                ...
                                repeat
                                    ...
                                    if LoanRegister."Repayment Method" = LoanRegister."repayment method"::"Reducing Balance" then begin
                                        ...
                                        LoanRegister."Loan Disbursement Date" := Rec."Repayment Start Date";
                                      //  LoanRegister.Modify;
                                    end;
                                    ...
                                    if LoanRegister."Repayment Method" = LoanRegister."repayment method"::Amortised then begin
                                        TotalMRepay := ROUND((InterestRate / 12 / 100) / (1 - Power((1 + (InterestRate / 12 / 100)), -(Rec."New Installments"))) * (LoanAmount), 0.05, '>');
                                    ...
                                    LoanSchedule."No Of Months" := Rec."New Installments";
                        ...
                        /*                         LineNo := LineNo + 10000;
                                                ...
                                                GenJournalLine."account type"::Customer, Rec."Member No", Rec."Rescheduled Date", (Rec."Outstanding Loan Amount" * SaccoGeneralSetUp."Reschedule Charge(%)" / 100), 'BOSA', LoanApps."Loan  No.",
                                               'Loan Rescheduling Fee -' + Rec."Loan No", LoanApps."Loan  No.", GenJournalLine."application source"::" ");


                                                //------------------------------------Interest on Reschesdule----------
                                                LineNo := LineNo + 10000;
                                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                                                GenJournalLine."account type"::"G/L Account", SaccoGeneralSetUp."Boosting Fees Account", Rec."Rescheduled Date", (Rec."Outstanding Loan Amount" * SaccoGeneralSetUp."Reschedule Charge(%)" / 100) * -1, 'BOSA', LoanApps."Loan  No.",
                                                'Loan Rescheduling Fee' + Rec."Loan No", LoanApps."Loan  No.", GenJournalLine."application source"::" ");
