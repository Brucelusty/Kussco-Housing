...
Page 50883 "Posted Sacco Transfer Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    Editable = false;
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to transfer schedule?', false) = true then begin
                            ...
                            //Partial Refund Fee=======================================================================================
                            if Rec."Deposit Debit Options" = Rec."deposit debit options"::"Partial Refund" then begin
                                ObjGensetup.Get();
                                ...
                                GenJournalLine."account type"::Member, Rec."Source Account No.", Today, ObjGensetup."Partial Deposit Refund Fee", 'BOSA', '',
                                Rec."Transaction Description" + ' ' + Rec."Source Account No.", '', AppSource::" ");
                                ...
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Deposit Contribution",
                                GenJournalLine."account type"::Member, Rec."Source Account No.", Today, VarExciseDuty, 'BOSA', '',
                                Rec."Transaction Description" + ' ' + Rec."Source Account No.", '', AppSource::" ");
                            ...
                            GenJournalLine.Description := Rec."Transaction Description";
    ...
    begin
        Rec."Source Account Type" := Rec."source account type"::"BOSA Account";
    end;
