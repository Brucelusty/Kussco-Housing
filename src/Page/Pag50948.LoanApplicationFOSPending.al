...
Page 50948 "Loan Application FOS(Pending)"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    InsertAllowed = false;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Cashier Branch"; Rec."Cashier Branch")
                {
                    Editable = false;
                }
            ...
            group(Loan)
            {
                ...
                action("Update PAYE")
                {
                    ...
                    begin
                        ...
                        NetUtilizable := ROUND((Rec."Utilizable Amount" + Rec."Bridge Amount Release" + Rec."Non Payroll Payments") / 3, 5, '<');
