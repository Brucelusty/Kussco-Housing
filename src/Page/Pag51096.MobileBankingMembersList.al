...
Page 51096 "Mobile Banking Members List"
{
    ApplicationArea = All;
    Caption = 'Member List';
    ...
    SourceTableView = order(ascending) where(ISNormalMember = filter(true), "Mobile Banking Registered" = filter(true));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field("Mobile Banking Status";Rec."Mobile Banking Status")
                {
                }
