...
Page 50376 "Voucher Payment Header"
{
    ApplicationArea = All;
        ...
        area(processing)
        {
            group("&Functions")
            {
                ...
                action("Check Budgetary Availability")
                {
                    ...
                    begin
                        if not (Rec.Status = Rec.Status::"Pending Approval") then begin
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        if PHeader2.FindFirst then
                            Report.run(172017, true, true, PHeader2);
                ...
                action("Print Check")
                {
                    ...
                    begin
                        ...
                        if Payments.Find('-') then
                            Report.run(172030, false, true, Payments)
                    end;
                }
            }
        }
    ...
    begin
        ...
        GenJnlLine.Description := CopyStr(Rec."Payment Description", 1, 50);//COPYSTR('Pay To:' + Payments.Payee,1,50);
    ...
    begin
        ...
        */
            ...
            if (Rec."Pay Mode" = Rec."pay mode"::Cheque) and (Rec."Cheque Type" = Rec."cheque type"::"Computer Cheque") then begin
