page 51149 "OD Application List"
{
    ApplicationArea = All;
    CardPageID = "OD Application Card";
    DeleteAllowed = false;
    Editable = false;
    PageType = List;
    PromotedActionCategories = 'New,Process,Reports,Approval,Budgetary Control,Cancellation,Category7_caption,Category8_caption,Category9_caption,Category10_caption';
    SourceTable = "Loans Register";
    SourceTableView = WHERE(Posted = FILTER(false), Source = CONST(FOSA),
    ...
    layout
    {
        area(content)
        {
            repeater(GroupName)
            {
                ...
                field("Overdrawn Reconciliation"; Rec."Overdrawn Reconciliation")
                {
                    Editable = false;
                }
    ...
    begin
        Loans.Reset();
        Loans.SetRange(Loans."Captured By", UserId);
        Loans.SetRange(Loans."Loan Status", Loans."Loan Status"::Application);
        if Loans.FindSet() then begin
            RecCount := Loans.Count;
            if RecCount > 2 then
    ...
    var
        ...
        CustomerRecord: Record //"51516223"
        "Members Register";
        Gnljnline: Record 81;
        ...
        FOSAName: Text[150];
        IDNo: Code[50];
        MovementTracker: Record //"51516254"
        "File Movement Tracker";
        SMSMessage: Record //"51516223"
        customer;
        InstallNo2: Integer;
        currency: Record 330;
