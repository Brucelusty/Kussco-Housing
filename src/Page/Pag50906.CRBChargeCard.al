...
Page 50906 "CRB Charge Card"
{
    ...
    actions
    {
        area(creation)
        {
            action("Post Charge")
            {
                ...
                trigger OnAction()
                begin
                    if Rec."Charge Effected" = true then begin
                    ...
                    if Confirm('Confirm CRB Check Charge?', false) = true then begin
                        ...
                        GenJournalLine."account type"::Vendor, Rec."FOSA Account to Charge", WorkDate, Rec."Charge Amount", 'FOSA', '',
                        ...
                        'Credit Reference Charge - ' + Rec."Loan No" + ' ' + Rec."Member Name", '', GenJournalLine."application source"::" ");
                        ...
                        'Credit Reference Income - ' + Rec."Loan No", '', GenJournalLine."application source"::" ");
                        ...
                        'Tax: Credit Reference Charge - ' + Rec."Loan No", '', GenJournalLine."application source"::" ");
                    ...
                    Rec."Charge Effected" := true;
                    Rec."Charged By" := UserId;
                    Rec."Charged On" := WorkDate;
                end;
            }
            ...
            action("BOSA Statement")
            {
                ...
                begin
                    ...
                    if ObjCust.Find('-') then
                        Report.run(172886, true, false, ObjCust);
                end;
            }
            action("FOSA Statement")
            {
                ...
                begin
                    ObjAccount.Reset;
                    ObjAccount.SetRange(ObjAccount."No.",Rec."FOSA Account to Charge");
    ...
    begin
        ...
        EnablePosting := true;
        if Rec."Charge Effected" = true then
            EnablePosting := false;
    end;
