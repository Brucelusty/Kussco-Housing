...
Page 50656 "Paybill Processing Header"
{
    ApplicationArea = All;
    // IF Posted=TRUE THEN
        ...
        area(processing)
        {
            ...
            action("Clear Lines")
            {
                ...
                begin
                    if Confirm('This Action will clear all the Lines for the current Salary Document. Do you want to Continue') = false then
                        exit;
                    ObjPaybillLines.Reset;
                    ObjPaybillLines.SetRange(ObjPaybillLines."Paybill Header No.", Rec.No);
                    ...
                    if ObjPaybillLines.FindSet then begin
                        repeat
                            ...
                            if ObjMpesaC2B.FindSet then begin
                                ...
                                GenJournalLine."account type"::Vendor, ObjPaybillLines."Correct Account No", WorkDate, VarAccountDesc, Rec."Account Type",
                                Rec."Account No", ObjPaybillLines.Amount * -1, 'FOSA', '');
                                ...
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE, BATCH_NAME, ObjPaybillLines."Document No.", LineNo, GenJournalLine."transaction type"::" ",
                                GenJournalLine."account type"::Vendor, ObjPaybillLines."Correct Account No", WorkDate, 'Paybill Deposit Charge', Rec."Account Type",
                                Rec."Account No", (VarChargeAmount + VarChargeAmountSaf) * -1, 'FOSA', '');

                                //==========================================================================================================Debit Member Account Tax: Charge
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE, BATCH_NAME, ObjPaybillLines."Document No.", LineNo, GenJournalLine."transaction type"::" ",
                                GenJournalLine."account type"::Vendor, ObjPaybillLines."Correct Account No", WorkDate,
                                'Tax: Paybill Charge:  Acc. ' + ObjPaybillLines."Correct Account No", Rec."Account Type",
                                Rec."Account No", VarTaxonCharge * -1, 'FOSA', '');
            ...
            action(Approval)
            {
                ...
                begin
                    ...
                    ApprovalEntries.SetRecordFilters(Database::"Paybill Processing Header", DocumentType, Rec.No);
                    ApprovalEntries.Run;
                end;
            }
        }
