...
Page 50858 "Group/Corporate Card-Member"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    Editable = false;
            ...
            group(ActionGroup32)
            {
                ...
                action("Member Risk Rating")
                {
                    ...
                    begin
                        ...
                        Rec."Member Residency Status" := 'Resident';
                        Rec."Individual Category" := 'Other';
                        Rec.Entities := 'Others';
                        Rec."Industry Type" := 'None of the above industries';
                        Rec."Length Of Relationship" := '';
                        Rec."International Trade" := 'No';
                        Rec."Electronic Payment" := 'None of the Above';
                        if Rec."Has ATM Card" = true then
                            Rec."Cards Type Taken" := 'ATM Debit'
                        else
                           Rec. "Cards Type Taken" := 'None';
                        Rec."Others(Channels)" := 'Others';
                        Rec.Modify;

                        SFactory.FnGetEntitiesAMLRiskRating(Rec."No.");
                ...
                action("Member Deposit Statement")
                {
                    ...
                    begin
                        ...
                        Cust.SetRange(Cust."No.", Rec."No.");
                        if Cust.Find('-') then
                            Report.run(172354, true, false, Cust);
                    end;
                }
