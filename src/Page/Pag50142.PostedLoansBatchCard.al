...
Page 50142 "Posted Loans Batch Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    //Editable = false;
            ...
            group(LoansB)
            {
                ...
                action("Loans Schedule")
                {
                    ...
                    begin
                        ...
                        if LoansBatch.Find('-') then begin
                            Report.run(172372, true, false, LoansBatch);
                        end;
                    end;
                }
                ...
                action("Post ")
                {
                    ...
                    begin
                        ...
                        if LoanApps.Find('-') then begin
                            repeat
                                ...
                                if (LoanApps.Source = LoanApps.Source::BOSA) and
                                   (rec."Mode Of Disbursement" <> rec."mode of disbursement"::"FOSA Loans") then
                                ...
                                if rec."Mode Of Disbursement" = rec."mode of disbursement"::"FOSA Loans" then begin
                                    DActivity := '';
                                    DBranch := '';
                                ...
                                if PCharges.Find('-') then begin
                                    repeat
                                        ...
                                        if (rec."Mode Of Disbursement" = rec."mode of disbursement"::"FOSA Loans") or
                                           (rec."Mode Of Disbursement" = rec."mode of disbursement"::"Transfer to FOSA") then begin
                        ...
                        //Transfer to FOSA
                        if (rec."Mode Of Disbursement" = rec."mode of disbursement"::"Transfer to FOSA") or
                           (rec."Mode Of Disbursement" = rec."mode of disbursement"::"FOSA Loans") then begin
                            DActivity := 'FOSA';
                            DBranch := 'NAIROBI';
                            ...
                            if LoanApps.Find('-') then begin
                                repeat
                                    ...
                                    if rec."Batch Type" =rec. "batch type"::"Appeal Loans" then
                                        ...
                                        if rec."Batch Type" = rec."batch type"::"Personal Loans" then
                                    ...
                                    GenJournalLine.Validate(GenJournalLine."Account No.");
                                    if (LoanApps."Account No" = '3172011') or (LoanApps."Account No" = '3172012') then begin
                                        GenJournalLine.Description := LoanApps."Client Name";
                                        if Cust.Get(LoanApps."Client Code") then begin
                ...
                action(SMSII)
                {
                    Caption = 'Reverse Posting Status';
                    ...
                    begin
                        ...
                        if LoanApps.FindSet() then begin
                            repeat
                            LoanApps."Loan Status":= LoanApps."Loan Status"::Approved;
                            LoanApps."Issued Date":= 0D;
                            LoanApps."Disbursed By":= '';
                            LoanApps."Disbursed By Date":= 0D;
                            LoanApps."Disbursed By Time":= 0T;
                            LoanApps."Disbursed Time":= 0T;
                            LoanApps."Offset Eligibility Amount":= 0;
                            LoanApps."Posting Date":= 0D;
                            LoanApps."Disbursed By":= '';
                            LoanApps."Loan Disbursement Date":= 0D;
                ...
                action("Print Cheque")
                {
                    ...
                    trigger OnAction()
                    begin
                        if (rec."Mode Of Disbursement" = rec."mode of disbursement"::EFT) or (rec."Mode Of Disbursement" = rec."mode of disbursement"::RTGS) then
