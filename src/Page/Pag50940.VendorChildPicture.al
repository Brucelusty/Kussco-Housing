...
Page 50940 "Vendor Child Picture"
{
    ApplicationArea = All;
    PageType = CardPart;
    SourceTable = Vendor;
    ...
    layout
    {
        area(content)
        {
            field("Child Picture";Rec."Child Picture")
            {
                ShowCaption = false;
                ToolTip = 'Specifies the picture that has been inserted for the child of the member.';
            }
        }
    }
        ...
        area(processing)
        {
            ...
            action(ExportFile)
            {
                ...
                begin
                    ...
                    // Rec.Download(TempNameValueBuffer.Name, DownloadImageTxt, '', '', ToFile);
