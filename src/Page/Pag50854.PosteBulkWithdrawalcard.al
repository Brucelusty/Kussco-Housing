...
Page 50854 "Poste Bulk Withdrawal card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    Editable = false;
            ...
            group(Approvals)
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        //if ApprovalsMgmt.IsSalesHeaderPendingApproval(Rec) then
                        // ApprovalsMgmt.IsPurchaseHeaderPendingApproval(Rec)
                    end;
                }
                action("Cancel Approval Request")
                {
                    ...
                    begin
                        //if ApprovalsMgmt.IsSalesHeaderPendingApproval(Rec) then
                        WKFLWIntegr.OnCancelBulkWithdrawalApprovalRequest(Rec);
