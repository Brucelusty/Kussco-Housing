...
Page 51011 "Loan Disburesment Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            ...
            field("Overdraft Reconciliation";Rec."Overdraft Reconciliation")
            {
            }
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        if LoanApps.find('-') then begin
                            Error('The loan has already been posted batch no %1-Loan No%2', Rec."Batch No.", LoanApps."Loan  No.");
                        end;
    ...
    var
        ...
        SMSAcc: Code[10];
        SaacoSetup: Record "Sacco General Set-Up";
        SMSFee: Decimal;
    ...
    begin
        ...
        IF LoanApps.GET(VarLoanNo) THEN BEGIN
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::Vendor, LoanApps."Account No", rec."Posting Date", LoanApps."Boosted Amount", 'BOSA', LoanApps."Loan  No.",
            ...
            GenJournalLine."Account Type"::Customer, LoanApps."Client Code", rec."Posting Date", LoanApps."Share Capital Boosting" * -1, FORMAT(LoanApps.Source), LoanApps."Loan  No.",
            'ShareCapital Boosting - ' + LoanApps."Loan Product Type Name", LoanApps."Loan  No.", GenJournalLine."Application Source"::" ");
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::Vendor, LoanApps."Account No", rec."Posting Date", LoanApps."Share Capital Boosting", 'BOSA', LoanApps."Loan  No.",
            'ShareCapital Boosting - ' + LoanApps."Loan Product Type Name" + ' - ' + LoanApps."Loan  No.", LoanApps."Loan  No.", GenJournalLine."Application Source"::" ");
            //----------------------------------(Debit Member Fosa Account)------------------------------------------------
            // Error('STOP');
            ...
            /*
                        //------------------------------------1. CREDIT EXCISE DUTY SHAREBOOSTING A/C---------------------------------------------------------------------------------------------

                        LineNo := LineNo + 10000;
                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                        GenJournalLine."Account Type"::"G/L Account", GenSetUp."Excise Duty Account", rec."Posting Date", LoanApps.* -1, FORMAT(LoanApps.Source), LoanApps."Loan  No.",
                        'ShareCapital Boosting - ' + LoanApps."Loan Product Type Name", LoanApps."Loan  No.", GenJournalLine."Application Source"::" ");
                        //--------------------------------CREDIT EXCISE DUTY SHAREBOOSTING A/C---------------------------------------------
            ...
            */
            ...
            IF PCharges.FIND('-') THEN BEGIN
                REPEAT
                    ...
                    IF SFactory.FnChargeExcise(PCharges.Code) THEN BEGIN
                        ...
                        LineNo := LineNo + 10000;
                        SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                        GenJournalLine."Account Type"::Vendor, LoanApps."Account No", rec."Posting Date", PChargeAmount * 0.1, 'BOSA', LoanApps."Loan  No.",
                ...
                IF LoanTopUp.FIND('-') THEN BEGIN
                    REPEAT
                        ...
                        IF LoanType.GET(LoanApps."Loan Product Type") THEN BEGIN
                            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                            GenJournalLine."Account Type"::Vendor, LoanApps."Account No", rec."Posting Date", LoanTopUp.Commision, 'BOSA', LoanTopUp."Loan Top Up",
                            'Refinancing Charges - ' + LoanApps."Loan Product Type Name", LoanTopUp."Loan Top Up", GenJournalLine."Application Source"::" ");
            ...
            //Kit Charge
            SaacoSetup.Get();
            SaacoSetup.TestField("Express Charge Account");
            ExpressCharge := 0;
            ExpressCharge := SaacoSetup."Express Charge %" * LoanApps."Approved Amount";
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::Vendor, LoanApps."Account No", rec."Posting Date", ExpressCharge, 'BOSA', BLoan,
            'Express Charge ' + LoanApps."Loan  No.", BLoan, GenJournalLine."Application Source"::" ");


            //------------------------------Credit Income G/L-----------------------------------------------
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::"G/L Account", GenSetUp."Express Charge Account", rec."Posting Date", -ExpressCharge, 'BOSA', BLoan,
            'Express Charge ' + LoanApps."Loan  No.", BLoan, GenJournalLine."Application Source"::" ");

            //Excise Duty
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::Vendor, LoanApps."Account No", rec."Posting Date", SaacoSetup."Excise Duty(%)" / 100 * ExpressCharge, 'BOSA', BLoan,
            'Excise on Express Charge ' + LoanApps."Loan  No.", BLoan, GenJournalLine."Application Source"::" ");
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
            GenJournalLine."Account Type"::"G/L Account", GenSetUp."Excise Duty Account", rec."Posting Date", -(SaacoSetup."Excise Duty(%)" / 100 * ExpressCharge), 'BOSA', BLoan,
            'Excise on Express Charge ' + LoanApps."Loan  No.", BLoan, GenJournalLine."Application Source"::" ");
