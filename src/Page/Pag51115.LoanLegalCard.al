...
Page 51115 "Loan Legal Card"
{
    ...
    layout
    {
        area(content)
        {
            ...
            group("SP Advance")
            {
                Caption = 'Special Advance';
                Visible = false;
                field("Special Advance Eligible"; Rec."Special Advance Eligible")
                {
                }
                field("Manual Special Advance"; Rec."Manual Special Advance")
                {
                }
                field("Special Advance"; Rec."Special Advance")
                {
                }
            ...
            group("Salary Details")
            {
                ...
                group("Payslip Details")
                {
                    ...
                    field("Reason for Other Income"; Rec."Reason for Other Income")
                    {
                    }
                    ...
                    field("T-Kash"; Rec."T-Kash")
                    {
                        Visible = (Rec."Employer Code" = 'TELKOM');
                    }
            ...
            group("Salary Details.")
            {
                ...
                group("Details")
                {
                    ...
                    field("Reason for Other Income Salary"; Rec."Reason for Other Income")
                    {
                    }
                    field("T-Kash_"; Rec."T-Kash")
                    {
                        Visible = (Rec."Employer Code" = 'TELKOM');
                    }
            ...
            group("Statement Details")
            {
                ...
                field("Bank Statement Average Credits"; Rec."Bank Statement Avarage Credits")
                {
                }
                field("Bank Statement Average Debits"; Rec."Bank Statement Avarage Debits")
                {
                }
            ...
            group(Loan)
            {
                ...
                action("Submit To Appraisal")
                {
                    ...
                    begin
                        ...
                        if Rec."Requested Amount" < (TotalL) then
                        ...
                        if Confirm('Are you sure you want to submit this form for Appraisal', false) = true then begin
                            ...
                            Rec."Appraissed By Date" := TODAY;
                            Rec."Appraissed By Time" := Time;
                            rec.Modify;
                ...
                action("Submit to finance")
                {
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to submit this form to finance For Dibursement?', false) = true then begin
