...
Page 50365 "Posted Teller & Treasury Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    PageType = Card;
        ...
        area(processing)
        {
            ...
            action("Issue/Return")
            {
                ...
                begin
                    ...
                    (Rec."Transaction Type" = Rec."transaction type"::"Treasury to Intra-Day") or
            ...
            action("EOD Report")
            {
                ...
                begin
                    ...
                    if Trans.Find('-') then
                        Report.run(172882, true, true, Trans)
                end;
            }
            action(SENDMAIL)
            {
            ...
            group(Approvals)
            {
                action(Approval)
                {
                    ...
                    begin
                        ...
                        //ApprovalEntries.Setfilters(Database::"Treasury Transactions", DocumentType, Rec.No);
                        //ApprovalEntries.Run;
                    end;
                }
    ...
    begin
       ...
       // OpenApprovalEntriesExist := ApprovalsMgmt.HasOpenApprovalEntries(vRecordId);
       // CanCancelApprovalForRecord := ApprovalsMgmt.CanCancelApprovalForRecord(vRecordId);
        EnabledApprovalWorkflowsExist := true;
