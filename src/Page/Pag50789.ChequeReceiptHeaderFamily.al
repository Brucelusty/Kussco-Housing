...
Page 50789 "Cheque Receipt Header-Family"
{
    ApplicationArea = All;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Mark All Verified";Rec."Mark All Verified")
                {
                    ...
                    begin
                        ...
                        ObjChqRecLines.SetRange(ObjChqRecLines."Header No", Rec."No.");
                        if ObjChqRecLines.FindSet then begin
                            repeat
                                if Rec."Mark All Verified" = true then
        ...
        area(creation)
        {
            action(Import)
            {
                ...
                begin
                    ...
                    //         ObjChequeFamily.SetRange(ObjChequeFamily."No.",Rec."No.");
                ...
                begin
                    ...
                    if objChequeTransactions.FindSet(true, false) then begin
                        repeat
                            ...
                            ObjChqRecLines."Header No" := Rec."No.";
                    ...
                    if Confirm('Confirm Inward Cheque Processing', false) = true then begin
                        ...
                        if ObjChqRecLines.Find('-') then begin
                            repeat
                                ...
                                GenJournalLine."account type"::Vendor, ObjChqRecLines."Account No.",Rec."Transaction Date", 'Inward Cheque #' + ObjChqRecLines."Cheque No" + ' to Acc. ' + ObjChqRecLines."Account No.",
                                GenJournalLine."bal. account type"::"Bank Account",Rec."Bank Account", ObjChqRecLines.Amount, 'FOSA', '', ObjChqRecLines."Cheque No", MemberBranch);

                                //=======================================================================================Debit FOSA Account Charges
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::Vendor,
                                        ObjChqRecLines."Account No.", WorkDate, ObjChqRecLines."Charge Amount", 'FOSA',Rec."No.", 'Inward Cheque Clearing Fees #' + ObjChqRecLines."Cheque No"
                                        , '', GenJournalLine."application source"::" ");

                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::Vendor,
                                        ObjChqRecLines."Account No.", WorkDate, (ObjChqRecLines."Charge Amount" * ObjGenSetup."Excise Duty(%)" / 100), 'FOSA',Rec."No.", 'Tax: Inward Cheque Clearing Fees #' +
                                        ObjChqRecLines."Cheque No", '',
                                        GenJournalLine."application source"::" ");

                                //=======================================================================================Credit Bank With Charge and Tax
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                        ObjGenSetup."Cheque Clearing Family Income", WorkDate, VarBankAmount * -1, 'FOSA',Rec."No.", 'Inward Cheque Clearing Fees #' + ObjChqRecLines."Cheque No" + ' to Acc. ' + ObjChqRecLines."Account No.",
                                        '', GenJournalLine."application source"::" ");

                                //=======================================================================================Credit Income Account
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                        ObjGenSetup."Cheque Processing Fee Account", WorkDate, ObjChqRecLines."Charge Amount Sacco Income" * -1, 'FOSA',Rec."No.",
                                ...
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                        ObjGenSetup."Excise Duty Account", WorkDate, (ObjChqRecLines."Charge Amount Sacco Income" * ObjGenSetup."Excise Duty(%)" / 100) * -1, 'FOSA',Rec."No.",
                    ...
                    if Confirm('Confirm Cheque Unpay', false) = true then begin
                        ...
                        if ObjChqRecLines.Find('-') then begin
                            repeat
                                ...
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLineBalancedChequeNo(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                                GenJournalLine."account type"::Vendor, ObjChqRecLines."Account No.",Rec."Transaction Date", 'Unpaid Inward Cheque #' + ObjChqRecLines."Cheque No" + ' for Acc. ' + ObjChqRecLines."Account No.",
                                GenJournalLine."bal. account type"::"Bank Account",Rec."Bank Account", ObjChqRecLines.Amount * -1, 'FOSA', '', ObjChqRecLines."Cheque No", MemberBranch);

                                //=======================================================================================Debit FOSA Account Charges
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::Vendor,
                                        ObjChqRecLines."Account No.", WorkDate, ObjChqRecLines."Un Pay Charge Amount", 'FOSA',Rec."No.", 'Unpaid Inward Cheque Fees #' + ObjChqRecLines."Cheque No"
                                        , '', GenJournalLine."application source"::" ");

                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::Vendor,
                                        ObjChqRecLines."Account No.", WorkDate, (ObjChqRecLines."Un Pay Charge Amount" * ObjGenSetup."Excise Duty(%)" / 100), 'FOSA',Rec."No.", 'Tax: Unpaid Inward Cheque Fees #' +
                                        ObjChqRecLines."Cheque No", '',
                                        GenJournalLine."application source"::" ");

                                //=======================================================================================Credit Bank With Charge and Tax
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"Bank Account",
                                        Rec."Bank Account", WorkDate, VarUnpayBankAmount * -1, 'FOSA',Rec."No.", 'Unpaid Inward Cheque Fees #' + ObjChqRecLines."Cheque No" + ' for Acc. ' + ObjChqRecLines."Account No.",
                                        '', GenJournalLine."application source"::" ");

                                //=======================================================================================Credit Income Account
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                        ObjGenSetup."Unpaid Cheques Fee Account", WorkDate, ObjChqRecLines."Charge Unpay Sacco Income" * -1, 'FOSA',Rec."No.",
                                        'Unpaid Inward Cheque Fees #' + ObjChqRecLines."Cheque No" + ' for Acc. ' + ObjChqRecLines."Account No.", '', GenJournalLine."application source"::" ");

                                //=======================================================================================Credit Tax:G/L Account
                                LineNo := LineNo + 10000;
                                SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME,Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                        ObjGenSetup."Excise Duty Account", WorkDate, (ObjChqRecLines."Charge Unpay Sacco Income" * ObjGenSetup."Excise Duty(%)" / 100) * -1, 'FOSA',Rec."No.",
            ...
            action("Export Unpaid Accounts")
            {
                ...
                begin
                    ...
                    ObjChqRecLines.Reset;
                    ObjChqRecLines.SetRange(ObjChqRecLines."Chq Receipt No",Rec."No.");
                end;
            }
            ...
            action(Approval)
            {
                ...
                begin
                    ...
                    ApprovalEntries.SetRecordFilters(Database::"Loan PayOff", DocumentType,Rec."No.");
                    ApprovalEntries.Run;
                end;
            }
        }
    ...
    begin
        ...
        EnableUnpay := false;
        if ((Rec.Status = Rec.Status::Approved) and (Rec.Posted = true)) then
            EnableUnpay := true;
    end;
