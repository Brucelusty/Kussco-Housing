page 51043 "ATM Pin Replacement Issued"
{
    ApplicationArea = All;
    PageType = List;
    UsageCategory = Lists;
    ...
    SourceTableView = where("Request Type" = filter("Pin Replacement"), Status = filter(Approved), "Pin Replacement Issued" = const(true), Posted = const(true));
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
