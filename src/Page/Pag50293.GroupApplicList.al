...
Page 50293 "Group Applic List"
{
    ...
    SourceTableView = where("Account Category" = filter(Corporate), "Incomplete Application" = filter(false), Created = filter(false));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1102755000)
            {
                ...
                field(Status; Rec."Membership Approval Status")
                {
                }
  ...
  /*                               ObjMemberNoseries.Reset;
    ...
    begin
        ...
        if Memb.Find('-') then begin
            ...
            //     Recipient.Add(Memb."E-Mail (Personal)");
