...
Page 51142 "Canceled Loans"
{
    ...
    SourceTableView = where(Posted = filter(false), "Approval Status" = filter(Canceled), "Loan Status" = filter(Canceled), "Archive Loan" = filter(true));
