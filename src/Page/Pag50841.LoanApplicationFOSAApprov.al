...
Page 50841 "Loan Application FOSA(Approv)"
{
    ApplicationArea = All;
    ...
    actions
    {
                ...
                begin
                    ...
                    if Rec."Mode of Disbursement" = Rec."mode of disbursement"::"FOSA Account" then begin
                        ...
                        if (Rec."Disburesment Type" = Rec."disburesment type"::" ") or (Rec."Disburesment Type" = Rec."disburesment type"::"Full/Single disbursement") then begin
                            ...
                            Rec."Tranch Amount Disbursed" := Rec."Amount to Disburse on Tranch 1";
                        Rec.Modify;
        ...
        area(Promoted)
        {
            ...
            {
                actionref("Go to FOSA Accounts_Promoted"; "Go to FOSA Accounts")
                {
                }
                actionref("Post Loans_Promoted"; "Post Loans")
                {
                }
    ...
    begin
        ...
        */
        ...
        if LoanApps."Loan Offset Amount" > 0 then begin
            ...
            if LoanTopUp.Find('-') then begin
                repeat
                    ...
                    GenJournalLine."account type"::Customer, LoanApps."Client Code", Rec."Posting Date", LoanTopUp."Principle Top Up" * -1, Format(LoanApps.Source), LoanTopUp."Loan Top Up",
                    ...
                    GenJournalLine."account type"::Customer, LoanApps."Client Code", Rec."Posting Date", LoanTopUp."Interest Top Up" * -1, Format(LoanApps.Source), LoanTopUp."Loan Top Up",
        ...
        if LoanApps."Boost this Loan" then begin
            ...
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::Loan,
            GenJournalLine."account type"::Customer, LoanApps."Client Code", Rec."Posting Date", LoanApps."Boosted Amount", Format(LoanApps.Source), BLoan,
            ...
            GenJournalLine."account type"::Customer, Rec."Client Code", Rec."Posting Date", LoanApps."Boosted Amount" * -1, Format(LoanApps.Source), BLoan,
        ...
        if LoanApps."Boosting Commision" > 0 then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
            GenJournalLine."account type"::"G/L Account", GenSetUp."Boosting Fees Account", Rec."Posting Date", LoanApps."Boosting Commision" * -1, Format(LoanApps.Source), BLoan,
        ...
        if LoanApps."Boosting Commision" > 0 then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
            GenJournalLine."account type"::Customer, Rec."Client Code", Rec."Posting Date", LoanApps."Boosted Amount Interest" * -1, Format(LoanApps.Source), BLoan,
