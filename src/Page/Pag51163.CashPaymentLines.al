            ...
            repeater(Control1102760000)
            {
                ...
                field(Amount; Rec.Amount)
                {
                    ...
                    begin
                        ...
                        Rec."Net Amount" := Rec.Amount - (Rec."VAT Amount" + Rec."Withholding Tax Amount");
                ...
                field("Withholding Tax Code"; Rec."Withholding Tax Code")
                {
                    ...
                    begin
                        ...
                        if TarriffCodes.FindFirst then begin
                            //    Rec."Withholding Tax Amount":=(TarriffCodes.Percentage/100)*Amount;
