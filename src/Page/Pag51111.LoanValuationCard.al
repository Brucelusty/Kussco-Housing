...
Page 51111 "Loan Valuation Card"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    InsertAllowed = false;
...
//
    ...
    actions
    {
        area(navigation)
        {
            group(Loan)
            {
                ...
                action("Submit To Credit Committee")
                {
                    Caption = 'Submit To Credit Committee';
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to submit this form for credit committee review?', false) = true then begin
                            rec."Loan Status" := rec."loan status"::"Credit Committee";
    ...
    begin
        ...
        if Rec."Account Type" = Rec."Account Type"::Corporate then
            Corporatevisible := true;

        IndividualVisible := false;
        if Rec."Account Type" = Rec."Account Type"::Individual then
            IndividualVisible := true;
        if Rec."Account Type" = Rec."Account Type"::Joint then
            IndividualVisible := true;
    end;
