            ...
            group(General)
            {
                ...
                field("Source Transaction Type";Rec."Source Transaction Type")
                {
                    ...
                    begin
                        ...
                        if (Rec."Source Transaction Type" = Rec."source transaction type"::"Loan Insurance Paid") or
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to transfer schedule?', false) = true then begin
                            ...
                            if Rec."Source Transaction Type" = Rec."source transaction type"::"Share Capital" then begin
                            ...
                            if Rec."Charge Transfer Fee" = true then begin
                                ...
                                if Rec."Source Account Type" = Rec."source account type"::"BOSA Account" then begin
                                    ...
                                    CalculatedTransferFee := 0.2 * Rec."Schedule Total";
                                    ...
                                    //GenJournalLine."Account Type":=GenJournalLine."Account Type"::"G/L Account";
                                    GenJournalLine.Description := 'Transfer Charges' + Rec."Transaction Description" + ' ' + Rec."Source Account No.";
