        ...
        area(processing)
        {
            ...
            action("View Schedule")
            {
                ...
                begin
                    ...
                    Report.run(172943,TRUE,TRUE,EFTHeader)*/
            ...
            action("Send Approval Request")
            {
                ...
                begin
                    Rec.CalcFields("Total Credits", Rec."Total Debits");
            ...
            action("Post Transfer And Print")
            {
                ...
                begin
                    ...
                    if PVHeader.Find('-') then
                        Report.run(172875, false, true, PVHeader)
    ...
    begin
        ...
        if PVLinesDetails.FindSet then begin
            repeat
                ...
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, Rec."Cheque No", GenJournalLine."application source"::" ", PVLinesDetails."Global Dimension 2 Code");
                ...
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, '', GenJournalLine."application source"::" ", PVLinesDetails."Global Dimension 2 Code");
        ...
        if PVLinesDetails.FindSet then begin
            repeat
                ...
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, Rec."Cheque No", GenJournalLine."application source"::" ", Rec."Global Dimension 2 Code");
                ...
                Rec."Cheque No" + ' ' + PVLinesDetails.Description, '', GenJournalLine."application source"::" ", Rec."Global Dimension 2 Code");
