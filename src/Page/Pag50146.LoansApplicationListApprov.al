...
Page 50146 "Loans Application List(Approv)"
{
    ApplicationArea = All;
            ...
            action("Post Loans")
            {
                ...
                begin
                    ...
                    if LoanGuar.Find('-') then begin
                        repeat
                            ...
                            if Cust.Find('-') then begin
                               ...
                               'Loan Type ' + Rec."Loan Product Type" + ' ' + 'of ' + Format(Rec."Requested Amount") + ' at ', Cust."FOSA Account No.", Cust."Phone No.");
                            end;
                    ...
                    if Rec."Mode of Disbursement" = Rec."mode of disbursement"::"FOSA Account" then begin
                        ...
                        Rec.Posted := true;
                        Rec."Loan Status" := Rec."loan status"::Closed;
    ...
    begin
        ...
        */
        ...
        GenJournalLine."account type"::Customer, LoanApps."Client Code", Rec."Posting Date", LoanApps."Approved Amount", 'BOSA', LoanApps."Loan  No.",
        ...
        GenJournalLine."account type"::Vendor, Rec."Account No", Rec."Posting Date", LoanApps."Approved Amount" * -1, 'BOSA', LoanApps."Loan  No.",
        ...
        if LoanApps."Boost this Loan" then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
            GenJournalLine."account type"::Vendor, Rec."Account No", Rec."Posting Date", LoanApps."Boosted Amount" * -1, 'BOSA', BLoan,
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
            GenJournalLine."account type"::Vendor, Rec."Account No", Rec."Posting Date", LoanApps."Boosted Amount", 'BOSA', BLoan,
        ...
        if LoanApps."Boosting Commision" > 0 then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
            GenJournalLine."account type"::Vendor, Rec."Account No", Rec."Posting Date", LoanApps."Boosting Commision", 'BOSA', BLoan,
        ...
        if LoanApps."Boosting Commision" > 0 then begin
            ...
            LineNo := LineNo + 10000;
            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
            GenJournalLine."account type"::Vendor, Rec."Account No", Rec."Posting Date", LoanApps."Boosted Amount Interest", 'BOSA', BLoan,
