...
Page 50016 "ATM Applications Card Pend"
{
    ApplicationArea = All;
    PageType = Card;
    ...
    actions
    {
        area(navigation)
        {
                ...
                action("Link ATM Card")
                {
                    ...
                    begin
                        ...
                        if Vend.Get(Rec."Account No") then begin
                            ...
                            SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No", 'Dear Member, your Atm card is ready for collection. Kindly collect it at our offices.', Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                        end;
            ...
            group(Approvals)
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        if Vend.Get(Rec."Account No") then begin
                            ...
                            SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."No.", 'Dear Member, your Atm card application has been received and is under processing.', Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                ...
                action("Mark As Open")
                {
                    Enabled = not (Rec.Status = Rec.Status::Approved);
                    Image = Open;
                    Promoted = true;
                    PromotedCategory = Category4;
                    PromotedOnly = true;
