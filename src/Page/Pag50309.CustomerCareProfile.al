//************************************************************************
page 50309 "Loans & Customer Care II" // default role center change to comapny name
{
    ApplicationArea = All;
    PageType = RoleCenter;
    ...
    actions
    {
        area(sections)
        {
            ...
            group(Meetings)
            {
                action("Book Meetings")
                {
                    RunObject = page "Sacco Meetings";
                }
                action("Booked Meetings")
                {
                    RunObject = page "Sacco Meetings No Allowance";
                }
            }
...
{
    Caption = 'Customer Care Profile';
    RoleCenter = "Loans & Customer Care II";
    ProfileDescription = 'Role center tailored to the customer care user of the organization.';
}
