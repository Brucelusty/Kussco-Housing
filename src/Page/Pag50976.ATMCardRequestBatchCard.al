...
Page 50976 "ATM Card Request Batch Card"
{
    ApplicationArea = All;
    PageType = Card;
        ...
        area(creation)
        {
            action(OrderCards)
            {
                ...
                begin
                    ...
                    ObjRequestLine.SetRange(ObjRequestLine."Batch No.", Rec."Batch No.");
                    ...
                    if ObjRequestLine.FindSet then begin
                        ...
                        repeat
                            ...
                            // TxtStream.WriteText();
                            // TxtStream.WriteText('C.O. UNIVERSITYWAY BRANCH');
                            // TxtStream.WriteText();
                            // TxtStream.WriteText('42993344-' + ObjRequestLine."ATM Card Account No");
                            // TxtStream.WriteText();
                            // TxtStream.WriteText('31');
                            // TxtStream.WriteText();
                            // TxtStream.WriteText(ObjRequestLine."Phone No");
                            // TxtStream.WriteText();
                            // TxtStream.WriteText('000000');
                            // TxtStream.WriteText();
                            // TxtStream.WriteText('TELEPOST SACCO LIMITED');
                            // TxtStream.WriteText();
                        ...
                        Message('The ATM Cards Order File ' + Format(WorkDate, 0, '<Day,2><Month,2><Year4>') + '_TELEPOST SACCO LIMITED.sfu' +
                ...
                begin
                   ...
                   // ObjATMApplications.SetRange(ObjATMApplications."ATM Card Fee Charged", true);
                    if ObjATMApplications.FindSet then begin
                        repeat
                            ObjRequestLine.Init;
                            ObjRequestLine."Batch No." := Rec."Batch No.";
