...
Page 50434 "Store Requisition Header"
{
    ApplicationArea = All;
    PageType = Document;
            ...
            group("&Functions")
            {
                        ...
                        if InventorySetup.Get then begin
                            ...
                            if ReqLine.Find('-') then begin
                                ...
                                if ReqLine.Find('-') then begin
                                    repeat
                                        ReqLine."Request Status" := ReqLine."request status"::Closed;
                                        ReqLine."Posting Date" := Rec."Request date";
                                        ReqLine.Modify;
                ...
                action(Approvals)
                {
                    ...
                    begin
                        ...
                        ApprovalEntries.SetRecordFilters(Database::Transactions, DocumentType, Rec."No.");
                        ApprovalEntries.Run;
                    end;
                }
                ...
                action("Print/Preview")
                {
                    ...
                    begin
                        ...
                        Report.run(172103, true, true, Rec);
