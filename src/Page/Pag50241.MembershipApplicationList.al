...
Page 50241 "Membership Application List"
{
    ApplicationArea = All;
    ...
    SourceTableView = where("Incomplete Application" = filter(false), "Erroneous Application" = filter(false), "Account Category" = filter(Individual | Joint), "Others Details" = filter(<> 'Self'), "Online Application" = filter(false));
    ...
    layout
    {
        ...
        area(factboxes)
        {
            ...
            part(Control777; "Member FrontID-App")
            {
                Caption = 'Front ID';
                Editable = MobileEditable;
                Enabled = MobileEditable;
            ...
            part(Control778; "Member BackID-App")
            {
                Caption = 'Back ID';
                Editable = MobileEditable;
                Enabled = MobileEditable;
            ...
            group("Function")
            {
                ...
                action("Create Account ")
                {
                    ...
                    begin
                        ...
                        Audit.FnInsertAuditRecords(UserId, 'Member Creation', 0, Rec."No.", today, time, '', Rec."No.", ObjCust."No.", '');
