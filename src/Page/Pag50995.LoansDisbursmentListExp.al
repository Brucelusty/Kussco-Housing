...
Page 50995 "Loans Disbursment  List Exp"
{
    ApplicationArea = All;
    CardPageID = "Loan Disburesment Card Exp";
    DeleteAllowed = false;
    Editable = false;
    InsertAllowed = false;
    ModifyAllowed = false;
    ...
    SourceTableView = where(Posted = filter(false),"Disbursement Type"=const(Express));
                    ...
                    begin
                        ...
                        if (rec."Mode Of Disbursement" = rec."mode of disbursement"::Cheque) or
                         (rec."Mode Of Disbursement" = rec."mode of disbursement"::"Individual Cheques") then
                            Error('Option not active %1', rec."Mode Of Disbursement");
