...
Page 50874 "Posted Cashier Authorisations"
{
    ApplicationArea = All;
    DeleteAllowed = false;
    InsertAllowed = false;
                            ...
                            repeat
                                ...
                                if Transactions.Authorised <> Transactions.Authorised::No then begin
                                    ...
                                    if Transactions."Transaction Type" = 'Withdrawal' then
                                     ...
                                     if Transactions."Transaction Type" = 'MPESA Withdrawal' then
                                        SupervisorApprovals.SetRange(SupervisorApprovals."Transaction Type", SupervisorApprovals."transaction type"::"MPESA Withdrawal");
