page 50218 "Posted Recon Ledger Entries3"
{
    ApplicationArea = All;
    ...
    Editable = false;
    PageType = ListPart;
    SourceTable = "Bank Account Ledger Entry Rec";
    ...
    layout
    {
        area(content)
        {
            ...
            {
                ShowCaption = false;
                field(LineApplied; Rec.IsApplied)
                {
                    Caption = 'Applied';
                    Editable = false;
                    Visible = false;
                ...
                field("External DocumentNo."; Rec."External Document No.") { Caption = 'Cheque No'; }
