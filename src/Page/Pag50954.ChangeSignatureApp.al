...
Page 50954 "Change Signature-App"
{
    ApplicationArea = All;
    PageType = CardPart;
    ...
    layout
    {
        area(content)
        {
            field(Signature; Rec.signinature)
            {
                ShowCaption = false;
        ...
        area(processing)
        {
                        ...
                        action(ExportFile)
            {
                ...
                begin
                    ...
                    // ExportPath := TemporaryPath + Rec."No" + Format(Rec.signinature.MediaId);
                    // Rec.signinature.ExportFile(ExportPath);
   ...
   procedure ImportFromDevice()
    ...
    begin
        ...
        if UploadIntoStream('Import', '', 'All Files (*.*)|*.*', FileName, PictureStream) then begin
            ...
            Rec.signinature.ImportStream(PictureStream, FileName);
            Rec.Modify(true);
        end;
