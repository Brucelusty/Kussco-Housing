page 51103 "Bank Acc. Recon FOSA Card"
{
    ApplicationArea = All;
    ...
    layout
    {
        area(content)
        {
            ...
            group(Conv)
            {
                Caption = 'Reconciliation Analysis';
        ...
        area(processing)
        {
            group("F&unctions")
            {
                ...
                action(SuggestLines)
                {
                    ...
                    begin
                        ...
                        BankRecLines.SetFilter("Transaction Date", '>%1', Rec."Statement Date");
                        ...
                        IF BankEntry.FIND('-') THEN BEGIN
                            IF (BankEntry."Statement Status" = BankEntry."Statement Status"::"Bank Acc. Entry Applied") and (BankEntry."Statement No." <> currentStatement) THEN begin
                                REPEAT
            ...
            group("M&atching")
            {
                ...
                action(RemoveMatch)
                {
                    ...
                    trigger OnAction()
                    var
                        TempBankAccReconciliationLine: Record "Bank Acc. Statement Line Conv" temporary;
                        TempBankAccountLedgerEntry: Record 271 temporary;
                        MatchBankRecLines: Codeunit 1252;
                        bankAccStatementLine: Record "Bank Acc. Statement Line Conv";
                        TempBankAccReconciliationLine2: Record 274 temporary;
                        BankAccountLedgerEntry: Record 271;
                    begin
                ...
                action("Bank Recon Report")
                {
                    ...
                    begin
                        ...
                        if bank.Find('-') then begin
                            REPORT.RUN(175069, TRUE, FALSE, bank);
                        end;
                    end;
                }
            }
    ...
    var
        //SuggestBankAccStatement: Report 174090;
        ...
        VarBankRec: Record 273;
        TestingReport: Report "Bank Acc. Reconciliation Conv";
        ReconReport: Report "Bank Acc. Reconciliation Conv";
        UserSetup: Record 91;
        NewReport: Report "Bank Acc. Reconciliation Conv";
        RecAmt: Decimal;
        BankDiff: Decimal;
