...
Page 50413 "Task Order Card2"
{
            ...
            group("F&unctions")
            {
                ...
                action("Send A&pproval Request")
                {
                    ...
                    begin
                        ...
                        if WorkflowIntegration.CheckPurchaseRequisitionApprovalsWorkflowEnabled(Rec) then
                            WorkflowIntegration.OnSendPurchaseRequisitionForApproval(Rec);
                        Message('Appproval send successfully')
                    end;
                }
                action("Cancel Approval Re&quest")
                {
                    ...
                    begin
                        ...
                        if WorkflowIntegration.CheckPurchaseRequisitionApprovalsWorkflowEnabled(Rec) then
                            WorkflowIntegration.OnCancelPurchaseRequisitionApprovalRequest(Rec);
                    end;
                }
                separator(Action10)
                {
    ...
    begin
        ...
        Vendor.Reset;
        Vendor.SetRange(Vendor."No.", 'SUPP_0005');
        ...
        //"Shortcut Dimension 2 Code":='KIAMBU';
    end;
