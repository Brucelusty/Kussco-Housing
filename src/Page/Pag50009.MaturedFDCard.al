                ...
                begin
                    ...
                    IF CONFIRM('Are you sure you want to transfer this fixed deposit?', TRUE, FALSE) = TRUE THEN BEGIN
                        ...
                        IF AccP.FIND('-') THEN BEGIN
                            ...
                            GenJournalLine."Posting Date" := TODAY;
                            GenJournalLine."Document No." := rec."FD No";
                            GenJournalLine.Description := 'Withholding tax on Fixed deposit ';
                            GenJournalLine.VALIDATE(GenJournalLine."Currency Code");
                            GenJournalLine.Amount := rec."Interest Earned" * 0.15;
                            GenJournalLine.VALIDATE(GenJournalLine.Amount);
                            GenJournalLine."Shortcut Dimension 1 Code" := DActivity;
                            GenJournalLine."Shortcut Dimension 2 Code" := DBranch;
                            GenJournalLine.VALIDATE(GenJournalLine."Shortcut Dimension 1 Code");
                            ...
                            GenJournalLine.Description := 'Withholding tax on Fixed deposit ';
                            GenJournalLine.VALIDATE(GenJournalLine."Currency Code");
                            GenJournalLine.Amount := rec."Interest Earned" * -1 * 0.15;
                            GenJournalLine.VALIDATE(GenJournalLine.Amount);
                            GenJournalLine."Shortcut Dimension 1 Code" := DActivity;
                            GenJournalLine."Shortcut Dimension 2 Code" := DBranch;
                            GenJournalLine.VALIDATE(GenJournalLine."Shortcut Dimension 1 Code");
                            ...
                            END;
                            //Muia
                            AuditTrail.FnInsertAuditRecords(Format(EntryNo) + USERID, 'Fixed Deposit Amount Transfer', rec.Amount,
                            'CREDIT', TODAY, TIME, '', rec."FD No", rec."Account No", '');
