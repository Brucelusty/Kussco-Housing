...
Page 50143 "Posted Loan Batch - List"
{
    ApplicationArea = All;
            ...
            group(LoansB)
            {
                ...
                action("Loans Schedule")
                {
                    ...
                    begin
                        ...
                        if LoansBatch.Find('-') then begin
                            Report.run(172231, true, false, LoansBatch);
                        end;
                    end;
                }
                    ...
                    begin
                        ...
                        if LoanApp.Find('-') then begin
                            if CopyStr(LoanApp."Loan Product Type", 1, 2) = 'PL' then
                                Report.run(172244, true, false, LoanApp)
                            else
                                Report.run(172244, true, false, LoanApp);
                        end;
                    end;
                ...
                action(Approvals)
                {
                    ...
                    begin
                       ...
                       // ApprovalEntries.Setfilters(Database::"Salary Step/Notch Transactions", DocumentType, rec."Batch No.");
                       // ApprovalEntries.Run;
                    end;
                }
