...
Page 50026 "ATM Applications Card Charged"
{
    ApplicationArea = All;
    PageType = Card;
                      ...
                      //  if Rec.Status <> Rec.Status::Approved then
                        ...
                        if Confirm('Are you sure you want to charge this ATM Card Application?', true) = true then begin
                            ...
                            SFactory.FnCreateGnlJournalLine('GENERAL', 'DEFAULT', Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"Bank Account",
                                    ObjGensetup."ATM Card Co-op Bank Account", WorkDate, (VarBankAmount) * -1, 'FOSA', Rec."No.", 'ATM Card Application Fees - ' + Rec."Card No", '', GenJournalLine."application source"::" ");
                            ...
                            SFactory.FnCreateGnlJournalLine('GENERAL', 'DEFAULT', Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                    ObjGensetup."ATM Card Income Account", WorkDate, VarSaccoAmount * -1, 'FOSA', Rec."No.", 'ATM Card Application Fee - ' + Rec."Card No", '', GenJournalLine."application source"::" ");

                            //=======================================================================================Credit Tax:ATM Card Fee G/L Account
                            LineNo := LineNo + 10000;
                            SFactory.FnCreateGnlJournalLine('GENERAL', 'DEFAULT', Rec."No.", LineNo, GenJournalLine."transaction type"::" ", GenJournalLine."account type"::"G/L Account",
                                    ObjGensetup."Excise Duty Account", WorkDate, (VarSaccoAmount * ObjGensetup."Excise Duty(%)" / 100) * -1, 'FOSA', Rec."No.", 'Excise Duty: ATM Card Application Fees - ' + Rec."Card No", '', GenJournalLine."application source"::" ");
                        ...
                        if Confirm('Are you sure you want to link this ATM Card to the Account', false) = true then begin
                            if ObjAccount.Get(Rec."Account No") then begin
                                ...
                                /*                                 ObjATMCardsBuffer.Init;
                                                                ...
                                                                ObjATMCardsBuffer."Account Type" := Rec."Account Type C";Kitui
                ...
                action("Enable ATM Card")
                {
                    ...
                    begin
                        ...
                        if Confirm('Are you sure you want to Enable ATM no. for this account  ?', true) = true then
                            Vend."ATM No." := Rec."Card No";
                        Vend."Card Status" := Rec."Card Status"::Active;
                        Vend.Modify;
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        if Vend.Get(Rec."Account No") then begin
                           ...
                           SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No",'Dear Member, your Atm card application has been received and is under processing.',Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
