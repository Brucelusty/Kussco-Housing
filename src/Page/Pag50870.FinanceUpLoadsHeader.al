...
Page 50870 "Finance UpLoads Header"
{
    ApplicationArea = All;
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Account Balancing Type";Rec."Account Balancing Type")
                {
                ...
                field("Debit Account Validated";Rec."Debit Account Validated")
                {
                }
            }
            ...
            group(ActionGroup1102755021)
            {
                action("Clear Lines")
                {
                    ...
                    begin
                        ...
                        ObjUpLoadsLines.SetRange(ObjUpLoadsLines."Header No.", Rec.No);
                ...
                action("Validate Data")
                {
                    ...
                    begin
                        ...
                        ObjUpLoadsLines.Reset;
                        ObjUpLoadsLines.SetRange("Header No.", Rec.No);
                        ObjUpLoadsLines.SetRange(ObjUpLoadsLines."Debit Account Type", ObjUpLoadsLines."debit account type"::Debtor);
                        ...
                        ObjUpLoadsLines.Reset;
                        ObjUpLoadsLines.SetRange("Header No.", Rec.No);
                        ObjUpLoadsLines.SetRange(ObjUpLoadsLines."Credit Account Type", ObjUpLoadsLines."credit account type"::Debtor);
                        if ObjUpLoadsLines.Find('-') then begin
                            repeat
                        ...
                        Rec."Debit Account Validated" := true;
                ...
                action(ProcessUpLoad)
                {
                    ...
                    trigger OnAction()
                    begin
                        if Rec."Debit Account Validated" = false then
                        ...
                        EXTERNAL_DOC_NO := Rec."Cheque No.";


                        if Rec."Account Balancing Type" = Rec."account balancing type"::"Detailed Balancing" then begin
    ...
    begin
        ...
        if ObjUpLoadsLines.Find('-') then begin
            repeat
                ...
                //------------------------------------1.1. Credit A/C---------------------------------------------------------------------------------------------
                if ObjUpLoadsLines."Credit Account Type" = ObjUpLoadsLines."credit account type"::Debtor then begin
                ...
                VarAccountType, ObjUpLoadsLines."Credit Account No", Rec."Posting date", ObjUpLoadsLines.Amount * -1, 'FOSA', '',
    ...
    begin
        ...
        ObjUpLoadsLines.Reset;
        ObjUpLoadsLines.SetRange(ObjUpLoadsLines."Header No.",Rec.No);
        if Rec."Upload Type" = Rec."upload type"::"Dividend & Interest" then
            ObjUpLoadsLines.SetRange(ObjUpLoadsLines.Posted, false);
        if ObjUpLoadsLines.Find('-') then begin
            repeat

                if ObjUpLoadsLines."Debit Account Type" = ObjUpLoadsLines."debit account type"::Debtor then begin
                    VarAccountType := Varaccounttype::Vendor
                end else
                ...
                if Rec."Upload Type" = Rec."upload type"::"Dividend & Interest" then begin
                ...
                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLineBranch(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                VarAccountType, ObjUpLoadsLines."Debit Account No", Rec."Posting date", ObjUpLoadsLines.Amount, 'FOSA', '',
                ObjUpLoadsLines."Debit Narration", '', GenJournalLine."application source"::" ", '');

                LineNo := LineNo + 10000;
                SFactory.FnCreateGnlJournalLineBranch(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::" ",
                VarBalAccountType, ObjUpLoadsLines."Credit Account No", Rec."Posting date", ObjUpLoadsLines.Amount * -1, 'FOSA', '',
                ObjUpLoadsLines."Credit Narration", '', GenJournalLine."application source"::" ", '');
    ...
    begin
        ...
        if Rec."Account Balancing Type" = Rec."account balancing type"::"Detailed Balancing" then begin
            ...
            if Rec."Account Balancing Type" = Rec."account balancing type"::"LampSum Balancing" then begin
