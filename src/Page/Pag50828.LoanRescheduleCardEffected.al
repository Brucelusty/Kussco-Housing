...
Page 50828 "Loan Reschedule Card-Effected"
{
    ApplicationArea = All;
    PageType = Card;
                    ...
                    begin
                        if Confirm('Are you sure you want to reshedule the loan') then begin
                            ...
                            if LoanRegister.FindFirst then begin
                                ...
                                RepayDate := Rec."Repayment Start Date";//LoanRegister."Repayment Start Date";
                                ...
                                InsuranceContribution := Rec."Loan Insurance";
            ...
            group(Approvals)
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        // Rec.Modify;
                        // Rec.Message('Approved Automatically');
                    end;
                }
