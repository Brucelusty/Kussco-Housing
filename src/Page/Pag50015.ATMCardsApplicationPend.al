...
Page 50015 "ATM Cards Application Pend"
{
    ApplicationArea = All;
    CardPageID = "ATM Applications Card Pend";
    Editable = false;
    PageType = List;
    UsageCategory = Lists;
    DeleteAllowed=false;
    ...
    SourceTableView = where("ATM Card Fee Charged" = filter(false), Status=filter(Pending), "Request Type" = filter(New|Replacement|Renewal));
