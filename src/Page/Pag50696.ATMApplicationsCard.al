...
Page 50696 "ATM Applications Card"
{
    ApplicationArea = All;
    PageType = Card;
    SourceTable = "ATM Card Applications";
    PromotedActionCategories = 'New,Procees,Report,Approvals';
                ...
                action("Link ATM Card")
                {
                    ...
                    begin
                        ...
                        if Vend.Get(Rec."Account No") then begin
                            ...
                            SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No",'Dear Member, your Atm card is ready for collection. Kindly collect it at our offices.',Vend."No.",Vend."No.", TRUE, 210, TRUE, 'CBS', CreateGuid(), 'CBS');
            ...
            group(Approvals)
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        // Error('Member Account has insufficient Balance for this Application. Available Balance is %1', AvailableBal);
                        // if (Rec."Request Type" = Rec."Request Type"::Replacement) and (Rec."Previous Card No" = Rec."Card No") then begin
                        //     Error('A Replacement cannot have the same card number.');
                        // end;


                        ATMCardApplication.Reset;
                        ATMCardApplication.SetRange("Account No", Rec."Account No");
                        ATMCardApplication.SetFilter("No.", '<>%1', Rec."No.");
                        ATMCardApplication.SetRange("ID No", Rec."ID No");
                        ATMCardApplication.SetRange("Request Type", Rec."Request Type");
                        // ATMCardApplication.SetFilter(ATMCardApplication."Request Type", '<>%1', ATMCardApplication."Request Type"::"Pin Replacement");
                        if ATMCardApplication.Find('-') then begin
                            Error('This Account already has an ATM Card Application for the same ID Number that is pending to be ordered. %1', ATMCardApplication."No.");
                        end;
                        ...
                        if Vend.Get(Rec."Account No") then begin
                          ///  SmsCodeunit.SendSmsResponse(Vend."Mobile Phone No", 'Dear Member, your Atm card application has been received and is under processing.');
                            if rec."Request Type" = rec."Request Type"::"Pin Replacement" then begin
                                SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No",'Dear '+vend.name+', your ATM Pin Replacement application has been received and is under processing.',Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                            end else if rec."Request Type" = rec."Request Type"::Replacement then begin
                                SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No",'Dear '+vend.name+', your ATM Card Replacement application has been received and is under processing.',Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                            end else if rec."Request Type" = rec."Request Type"::Renewal then begin
                                SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No",'Dear '+vend.name+', your ATM Renewal application has been received and is under processing.',Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                            end else if rec."Request Type" = rec."Request Type"::New then begin
                                SmsCodeunit.SendSmsWithID(Source::ATM_COLLECTION, Vend."Mobile Phone No",'Dear '+vend.name+', your ATM Card application has been received and is under processing.',Vend."No.", Vend."No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                            end;
                        end;
                    end;
                }
