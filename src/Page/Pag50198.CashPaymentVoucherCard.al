//************************************************************************
page 50198 "Cash Payment Voucher"
{
    ApplicationArea = All;
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        IF UserSetup.GET(USERID) THEN BEGIN
                            ...
                            if Confirm('Do you wish to continue with posting this payment voucher?', true) = false then exit;
                            Banks.Reset();
                            Banks.SetRange(Banks."No.", Rec."Paying Bank Account");
                            Banks.SetRange(Banks."Account Type", Banks."Account Type"::Cashier);
                            Banks.SetAutoCalcFields(Banks.Balance);
                            Banks.SetFilter(Banks.Balance, '<=%1', 0);
                            if Banks.FindFirst() then begin
                                Error('Kindly replenish Bank Account %1', Rec."Paying Bank Account");
                            end;
                            //post pv
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        ...
                        */
                        ...
                        if PayLine.Find('-') then begin
                            PayLine.Validate(PayLine.Remarks);
                        end;
                        //Print PV
