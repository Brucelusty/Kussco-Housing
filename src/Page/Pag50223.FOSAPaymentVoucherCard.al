//************************************************************************
page 50223 "FOSA Payment Voucher Card"
{
    ApplicationArea = All;
            ...
            group("&Functions")
            {
                ...
                action(Approval)
                {
                    ...
                    begin
                        ...
                        //ApprovalEntries.Setfilters(51516112, DocumentType, rec."No.");
                        //ApprovalEntries.RUN;
                    end;
                }
                ...
                action(Print)
                {
                    ...
                    begin
                        ...
                        PHeader2.SETRANGE(PHeader2."No.", rec."No.");
                        IF PHeader2.FINDFIRST THEN
                            Report.run(50022, TRUE, TRUE, PHeader2);
                    end;
                }
    ...
    begin
        ...
        Rec."Paying Type" := rec."Paying Type"::GLAccount;
    ...
    begin
        ...
        Payments.CALCFIELDS(Payments."Total Net Amount", Payments."Total VAT Amount", Payments."Total Witholding Tax Amount");
        IF rec."Paying Type" = rec."Paying Type"::Bank THEN BEGIN
            GenJnlLine.Amount := -(Payments."Total Net Amount" + Payments."Total Witholding Tax Amount");
        end;
        IF rec."Paying Type" <> rec."Paying Type"::Bank THEN BEGIN
            GenJnlLine.Amount := (Payments."Total Net Amount" + Payments."Total Witholding Tax Amount");
            Message('GenJnlLine.Amount %1', GenJnlLine.Amount);
        end;
        ...
        GenJnlLine.Description := Rec."Payment Narration";
    ...
    begin
        ...
        JTemplate := 'PAYMENT';//Temp."Payment Journal Template";
            ...
            REPEAT
                ...
                if Payment."Paying Type" = Payment."Paying Type"::Bank then begin
                    IF PayLine."VAT Code" = '' THEN BEGIN
                        GenJnlLine.Amount := PayLine."Net Amount" + PayLine."Withholding Tax Amount";
                    END
                    ELSE BEGIN
                        GenJnlLine.Amount := PayLine."Net Amount" + PayLine."Withholding Tax Amount";
                    END;
                ...
                IF TarriffCodes.FIND('-') THEN BEGIN
                    ...
                    else if PayLine.Type = 'Customer' then
                        GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::Customer else
                        if PayLine.Type = 'G/L Account' then
                            GenJnlLine."Bal. Account Type" := GenJnlLine."Bal. Account Type"::"G/L Account";
                    ...
                    GenJnlLine.VALIDATE(GenJnlLine."Bal. Account No.");
                    GenJnlLine.Description := 'Tax-' + Payments."Payment Narration";
                    GenJnlLine."Shortcut Dimension 1 Code" := PayLine."Global Dimension 1 Code";
                    GenJnlLine."Shortcut Dimension 2 Code" := PayLine."Shortcut Dimension 2 Code";
                    GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 2 Code");
                    GenJnlLine.VALIDATE(GenJnlLine."Shortcut Dimension 1 Code");
