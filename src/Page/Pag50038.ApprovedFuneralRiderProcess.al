page 50038 "Approved Funeral Rider Process"
{
    ApplicationArea = All;
    PageType = List;
    UsageCategory = Lists;
    SourceTable = "Funeral Rider Processing";
    CardPageId = "Approved Funeral Rider Card";
    SourceTableView = where("Approval Status" = filter(Approved), "Processing Status" = filter(Approved), "FR Fee Paid" = const(false));
    Editable = false;
    DeleteAllowed = false;
    ModifyAllowed = false;
    InsertAllowed = false;
