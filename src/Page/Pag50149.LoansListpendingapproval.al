...
Page 50149 "Loans  List- pending approval"
{
    ApplicationArea = All;
    ...
    SourceTableView = where(Posted = filter(false), "Approval Status" = filter(Pending)/*,"Requires Guarantors Mobile"=filter(false)*/,"Archive Loan"=filter(false));
