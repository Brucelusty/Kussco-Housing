...
Page 50056 "Posted Membership Exit List"
{
    ApplicationArea = All;
    ...
    SourceTableView = where("Fully Paid" = filter(true));
    ...
    layout
    {
        area(content)
        {
            repeater(Control1102755000)
            {
                ...
                field("Closing Date"; Rec."Application Date")
                {
                }
        ...
        area(navigation)
        {
            group("Function")
            {
                ...
                action("Send Approval Request")
                {
                    ...
                    begin
                        if (rec."Closure Type" = rec."closure type"::Voluntary) and (rec."Member Liability" > 0) then
        ...
        if ObjMember.Get(rec."Member No.") then begin
            ...
            if ObjShareCapSell.FindSet then begin
                repeat
                    ...
                    GenJournalLine."account type"::Vendor, ObjShareCapSell."Buyer Share Capital Account", rec."Maturity Date",
            ...
            SurestepFactory.FnCreateGnlJournalLine(TemplateName, BatchName, rec."No.", LineNo, GenJournalLine."transaction type"::"Share Capital",
            GenJournalLine."account type"::Vendor, rec."Seller Share Capital Account", rec."Maturity Date",
            ...
            if ObjShareCapSell.FindSet then begin
                repeat
                    ...
                    GenJournalLine."account type"::Vendor, ObjShareCapSell."Buyer FOSA Account", rec."Maturity Date",
            ...
            rec.CalcFields("Share Capital to Sell");
            SurestepFactory.FnCreateGnlJournalLine(TemplateName, BatchName, rec."No.", LineNo, GenJournalLine."transaction type"::" ",
            GenJournalLine."account type"::Vendor, rec."FOSA Account No.", rec."Maturity Date",
                (rec."Share Capital to Sell" * -1), 'FOSA', rec."No.", 'Share Capital Sell to ' + VarBuyerMemberNos, '', GenJournalLine."application source"::" ");

            LineNo := LineNo + 10000;
            //========================================================================================================Post Transfer Fee
            Generalsetup.Get();
            SurestepFactory.FnCreateGnlJournalLineBalanced(TemplateName, BatchName, rec."No.", LineNo, GenJournalLine."transaction type"::"Deposit Contribution", GenJournalLine."account type"::Vendor, ObjMember."Deposits Account No", rec."Maturity Date"
