...
Page 50541 "Membership Appl. - Created"
{
    ApplicationArea = All;
    ...
    SourceTableView = where("Incomplete Application" = filter(false),
                            "Account Category" = filter(Individual | Joint),
    ...
    begin
        ...
        // SurestepFactory.FnSendStatementViaMail(VarMemberName, VarEmailSubject, VarEmailBody,Rec."E-Mail (Personal)", '', '');
    end;
