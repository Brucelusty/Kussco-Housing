report 50660 "Withdrawals Above 100k Report"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Layouts/Withdrawals Above 100k.rdlc';
    ...
    dataset
    {
        dataitem(Transactions;Transactions)
        {
            ...
            DataItemTableView = sorting(No, "Member No") where(Posted = filter(true), "Type _Transactions" = const("Withdrawal"), Amount = filter(>100000));
            column(No;No)
            {
