...
//51516021_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50498 "ATM Bank Report"															
{															
    ApplicationArea = All;
    Caption = 'Bank Acc. - Detail Trial Bal.';															
    RDLCLayout = 'Layouts/ATMBankReport.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = sorting("No.") where("No." = filter('BANK_0007'));															
            ...
            {															
                ...
                DataItemTableView = sorting("Bank Account No.", "Posting Date") where("Bank Account No." = const('BANK_0007'));															
