...
//51516205_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50262 "Accounts With Debt Collectors"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/AccountsWithDebtCollectors.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = where(Posted = const(true), "Loan Under Debt Collection" = const(true), "Outstanding Balance" = filter(> 0));															
            RequestFilterFields = "Debt Collector Name", "Loan Debt Collector", "Loan  No.", "Client Code";															
