...
//51516055_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50147 "Insider Lending & Saving List"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/InsiderLending&SavingList.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Client Code") where("Insider Status" = filter(<> " "), "Outstanding Balance" = filter(> 1));
