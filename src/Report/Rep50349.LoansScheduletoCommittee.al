...
//51516394_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50349 "Loans Schedule to Committee"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/LoansScheduletoCommittee.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("Loan  No.") where("Loan Status" = filter(Appraisal));
            ...
            column(Client_Name; LAppl."Client Name")
            {
            }
            column(Loan_Product_Type; LAppl."Loan Product Type")
            {
            }
            column(Application_Date; LAppl."Application Date")
            {
            }
            column(Installments; LAppl.Installments)
            {
            }
            column(Req_Amount; LAppl."Requested Amount")
            {
            }
            column(Recommended_Amount; LAppl."Recommended Amount")
            {
            }
            column(Net_Amount; LAppl."Net Amount")
            {
            }
