...
Report 50061 "Form2F Statement of CompIncome"
{
    ApplicationArea = All;
    // RDLCLayout = 'Layouts/Form2FStatementofCompIncome.rdlc';															
    // DefaultLayout = RDLC;		
    ExcelLayout = 'Layouts/Form2FStatementofCompIncome.xlsx';
    DefaultLayout = Excel;
    ...
    dataset
    {
        dataitem(Company; "Company Information")
        {
            ...
            begin
                ...
                //Message('%1|%2',FeesCommissionExpense,GLAccount.Next);
                ...
                Taxes := 0;
                GLAccount.Reset;
                GLAccount.SetFilter(GLAccount."Form2F(Statement of C Income)", '%1', GLAccount."Form2F(Statement of C Income)"::Derivatives);
                if GLAccount.FindSet then begin
                    repeat
                        GLEntry.Reset;
                        GLEntry.SetRange(GLEntry."G/L Account No.", GLAccount."No.");
