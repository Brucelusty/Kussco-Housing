...
//51516024_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50117 "Cashier Report-ABC"															
{															
    ApplicationArea = All;
    Caption = 'Bank Acc. - Detail Trial Bal.';															
    RDLCLayout = 'Layouts/CashierReport-ABC.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            {															
                ...
                DataItemTableView = sorting(No) where(Type = const('ABC Deposit'), Posted = const(true));															
