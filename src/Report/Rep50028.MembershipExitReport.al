report 50028 "Membership Exit Report"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Membership Exit"; "Membership Exist")
        {
            ...
            RequestFilterFields = "No.", "Member No.", "Application Date", Status, "Closure Type", "Maturity Date";
            ...
            column(ClosingDate_MembershipWithdrawals; Format("Membership Exit"."Application Date"))
            {
            }
