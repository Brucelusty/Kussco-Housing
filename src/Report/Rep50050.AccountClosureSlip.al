...
Report 50050 "Account Closure Slip"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            begin
                ...
                Closure.SetRange(Closure."Member No.", "No.");
                if Closure.FindLast then begin
                    if (Closure."Sell Share Capital" = true) and (Closure."Closure Type" <> Closure."closure type"::Death) then begin
                        Closure.CalcFields(Closure."Share Capital to Sell");
                ...
                if (Closure."Member Deposits" > 1) and (Closure."Closure Type" <> Closure."closure type"::Death) then begin
                ...
                if Closure."Closure Type" = Closure."closure type"::Death then begin
                    NetPayable := NetLiability
                end else
                    if (Closure."Closure Type" = Closure."closure type"::Voluntary) then begin
