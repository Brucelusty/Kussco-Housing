...
Report 50418 "Generate Over Draft"															
{															
    ApplicationArea = All;
    ...
    {															
        ...
        {															
            DataItemTableView = sorting("No.") where("Creditor Type" = const("FOSA Account"), "Account Type" = filter('SAVINGS' | 'SAVINGSREL'), "Balance (LCY)" = filter(< 1.000), Status = filter(<> Dormant | Deceased), Blocked = const(" "));															
