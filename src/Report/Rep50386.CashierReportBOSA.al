...
//51516433_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50386 "Cashier Report BOSA"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/CashierReportBOSA.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            // column(Transaction_No; "Receipt Header"."Document No")															
            // {															
            // }															
            // column(Payment_Date; "Receipt Header"."Transaction Date")															
            // {															
            // }															
            // column(Account_No; "Receipt Header"."Account No.")															
            // {															
            // }															
            // column(Name; "Receipt Header".Name)															
            // {															
            // }															
            // column(Bank_Name; "Receipt Header"."Bank Name")															
            // {															
            // }															
