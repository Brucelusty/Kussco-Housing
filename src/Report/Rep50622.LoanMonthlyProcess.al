...
Report 50622 "Loan Monthly Process"
{
    ApplicationArea = All;
    ProcessingOnly = true;
                        ...
                        if RunningBal > 0 then begin
                            ...
                            if VarExcessRuleType = Varexcessruletype::"Oldest Loan" then begin
                                ...
                                if ObjLoans.FindFirst then begin
                                    ...
                                    GenJournalLine."account type"::Customer, VarMemberNo, WorkDate, VarAmounttoRepay * -1, 'FOSA', '',
    ...
    begin
        ...
        GenJournalLine."account type"::Customer, ObjLoans."Client Code", WorkDate, 'Remaining Loan Insurance Charged ' + VarLoanNoRecovered, GenJournalLine."bal. account type"::"G/L Account",
    ...
    begin
        ...
        if VarRemainingLSABal > 0 then begin
            ...
            GenJournalLine."account type"::Customer, VarMemberNo, WorkDate, VarAmounttoDeduct * -1, 'FOSA', '',
