...
Report 50052 "Members Loans Guarantors"
{
    ApplicationArea = All;
            ...
            dataitem("Loans Guarantee Details"; "Loans Guarantee Details")
            {
                ...
                begin
                    ...
                    if Loansr.Find('-') then BEGIN
                        ...
                        Outstandinglanace := Loansr."Outstanding Balance";
                    ...
                    ObjLoanGuar.SETRANGE(ObjLoanGuar."Member No", "Loans Guarantee Details"."Member No");
                    IF ObjLoanGuar.FINDSET THEN BEGIN
                        ...
                        //     ObjLoanGuar.RESET;
                        //     ObjLoanGuar.SETRANGE(ObjLoanGuar."Loan No", GuaranteedLoan);
                        //     ObjLoanGuar.SETRANGE(ObjLoanGuar."Member No", DOCUMENT_NO);
