...
Report 50163 "Send Account Statement"
{
    ApplicationArea = All;
        ...
        dataitem(Vendor; Vendor)
        {
            ...
            begin
                ...
                if ObjVendor.FindSet then begin
                    ...
                    //Report.SaveAs(Report::"Customer - Order Summary", '', ReportFormat::Pdf, OutStr, ObjVendor);														
                    Report.SaveAs(Report::"FOSA Account Statement Ver.1.0",'' ,ReportFormat::Pdf, OutStr, recRef);
                    ObjMember.Reset;
