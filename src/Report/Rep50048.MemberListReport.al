//<---------------------------------------------------------------------->															
Report 50048 "Member List Report"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Customer; Customer)
        {
            ...
            RequestFilterFields = "No.", Status, "Membership Status", "Registration Date", "Employer Code", Workstation, "Member Type", Designation;
            ...
            column(Occupation_Details; "Occupation Details") { }
            ...
            column(FOSA__Account_Bal; "FOSA  Account Bal") { }
            ...
            column(GroupCode_MembersRegister; Customer."Group Code")
            {
            }
