...
//51516131_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50200 "Cash Voucher Report"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/CashVoucherReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Payment Header."; "Payment Header.")
        {
            ...
            column(PMODE; "Payment Header."."Payment Mode")
            {
            }
            ...
            column(PayMode; "Payment Header."."Pay Mode")
            {
                IncludeCaption = true;
            }
            ...
            column(narrations; "Payment Header."."Payment Description")
            {
            }
            ...
            begin
                /*VendEnrty.RESET;															
				VendEnrty.SETRANGE(VendEnrty."Applies-to ID","Payments Header."."No."); //Dimkes											
