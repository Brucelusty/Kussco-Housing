...
//51516449_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50401 "Accounts in Debit Report"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/AccountsinDebitReport.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = sorting("No.") where("Creditor Type" = filter("FOSA Account"), Balance = filter(< 0));															
