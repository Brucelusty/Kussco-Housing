...
Report 50145 "Collateral & Statement Process"
{
    ApplicationArea = All;
    ProcessingOnly = true;
    ...
    begin
        ...
        if ObjCollateralRegister.FindSet then begin
            repeat
                ...
                ObjLoanCollateralDetails.SetRange(ObjLoanCollateralDetails."Collateral Register Doc", ObjCollateralRegister."Document No");
