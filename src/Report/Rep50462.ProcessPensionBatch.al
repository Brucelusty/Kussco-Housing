//<---------------------------------------------------------------------->															
Report 50462 "Process Pension Batch"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/ProcessPensionBatch.rdlc';															
    DefaultLayout = RDLC;															
        ...
        {															
                                            ...
                                            if AmountDed > 0 then begin															
                                                ...
                                                if ReceiptAllocations.Find('-') then begin															
                                                    repeat															
                                                        ...
                                                        GenJournalLine."Journal Batch Name" := 'PENSIONS';															
                                                        ...
                                                        // else if ReceiptAllocations."Transaction Type" = ReceiptAllocations."transaction type"::pe then															
            ...
            begin															
				...
				*/											
                ...
                GenJournalLine.SetRange(GenJournalLine."Journal Batch Name", 'PENSIONS');															
            ...
            begin															
                if SalaryHeader.Get("Salary Header No.") then begin															
                    ...
                    SMSCharge := 0;															
                    LineNo := LineNo + 10000;															
                    if "Pension Processing Lines"."Account No." = '3172010' then begin															
                        LineNo := LineNo + 1000;															
                        GenJournalLine.Init;															
                        GenJournalLine."Journal Template Name" := 'GENERAL';															
                        GenJournalLine."Journal Batch Name" := 'PENSIONS';															
                        GenJournalLine."Line No." := LineNo;															
                        GenJournalLine."Document No." := SalaryHeader."Document No";															
                        GenJournalLine."External Document No." := "Pension Processing Lines"."Branch Reff.";															
                        GenJournalLine."Posting Date" := SalaryHeader."Posting date";															
                        GenJournalLine."Account Type" := GenJournalLine."account type"::"G/L Account";															
                        GenJournalLine.Validate(GenJournalLine."Account No.", "Pension Processing Lines"."Account No.");															
                        GenJournalLine.Description := "Pension Processing Lines".Name;															
                        GenJournalLine.Validate(GenJournalLine.Amount, -"Pension Processing Lines".Amount);															
                    ...
                    if Account.Get("Pension Processing Lines"."Account No.") then begin															
                        ...
                        GenJournalLine."External Document No." := "Pension Processing Lines"."Branch Reff.";															
                        GenJournalLine."Posting Date" := SalaryHeader."Posting date";															
                        if "Pension Processing Lines"."Account No." = '3172010' then															
                            GenJournalLine."Account Type" := GenJournalLine."account type"::"G/L Account"															
                        else															
                            GenJournalLine."Account Type" := GenJournalLine."account type"::Vendor;															
                        GenJournalLine.Validate(GenJournalLine."Account No.", "Pension Processing Lines"."Account No.");															
                        ...
                        // or ("Pension Processing Lines"."Account No." = '3172010') then															
                        //     GenJournalLine.Description := "Pension Processing Lines".Name															
                        // else															
                        //     GenJournalLine.Description := 'Pension';															
                        ...
                        if GenJournalLine.Amount <> 0 then begin															
                            GenJournalLine.Insert;															
                            //send SMS															
                            FnSendSMS("Pension Processing Lines"."Account No.", Account."Mobile Phone No");															
                        end;															
                        //Salary Processing Fee															
                        // if (Account."Account Category" <> Account."account category"::Branch) and															
                        //    ("Pension Processing Lines"."Account No." <> '3172010') then begin															
                        //     LineNo := LineNo + 1000;															
                        //     GenJournalLine.Init;															
                        //     GenJournalLine."Journal Template Name" := 'GENERAL';															
                        //     GenJournalLine."Journal Batch Name" := 'PENSIONS';															
                        ...
                        //     else															
                        //         GenJournalLine.Description := 'Pension Processing Fee';															
                        ...
                        GenJournalLine.Validate(GenJournalLine."Account No.", SalGLAccount);   //"Pension Processing Lines"."Account No.");															
                        GenJournalLine.Description := 'Pension Processing Fee';															
                        ...
                        if SittingAll = true then															
                            ...
                            GenJournalLine.Description := '10% Excise Duty on Pension Processing Fee';															
                        ...
                        Vend1.RESET;															
                        Vend1.SETRANGE(Vend1."No.","Pension Processing Lines"."Account No.");															
                        ...
                        if SittingAll = false then begin															
                            ...
                            //Interest															
                            Loans.Reset;															
                            Loans.SetCurrentkey(Source, "Client Code", "Loan Product Type", "Issued Date", "BOSA No");															
    ...
    begin															
        ...
        SMSMessage.Source := 'PENSION';															
        SMSMessage."Entered By" := UserId;															
        SMSMessage."Sent To Server" := SMSMessage."sent to server"::No;															
        SMSMessage."SMS Message" := 'Dear client, your pension has been credited to your account on ' + Format(Today) + ' ' + Format(Time) + '  From OLLIN SACCO LTD';															
