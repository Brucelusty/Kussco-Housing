...
Report 50430 "Closed Accounts Report"															
{															
    ApplicationArea = All;
    ...
    {															
        ...
        {															
            ...
            RequestFilterFields = "Application Date","Maturity Date", "Member No.";															
            ...
            column(PostingDate_MembershipExist; "Membership Exist"."Maturity Date")															
            {															
            }															
