...
//51516880_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50546 "Member Silver Savings Report"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/MemberSilverSavingsReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("Silver Savings" = filter(<> 0));
            PrintOnlyIfDetail = false;
            RequestFilterFields = "No.", Status, "Employer Code", "Payroll No", "Silver Savings", "Date Filter";
