...
//51516935_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50597 "Staff Claims Report"															
{															
    ApplicationArea = All;
    PreviewMode = PrintLayout;															
    RDLCLayout = 'Layouts/StaffClaimsReport.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            column(PMODE; "Staff Claims Header"."Pay Mode")															
            {															
            }															
            ...
            column(DatePosted_StaffClaimsHeader; "Staff Claims Header"."Date Posted")															
            {															
            }															
            ...
            {															
                ...
                DataItemTableView = sorting("Line No.", No, "Type of Surrender") order(ascending);															
            ...
            {															
                DataItemLink = "Document No." = field("No.");															
                DataItemTableView = where("Document Type" = const("Payment Voucher"), Status = filter(Open | Approved | Created));															
                ...
                trigger OnAfterGetRecord();															
                begin															
                    EmployeeTitle := FnEmployeeTitle("Approval Entry"."Approver ID");															
                end;															
            ...
            begin															
                VendEnrty.Reset;															
                VendEnrty.SetRange(VendEnrty."Applies-to ID", "Staff Claims Header"."No.");															
				...
				ELSE											
				CreationDoc:=TRUE;											
				EmployeeTitle:=FnEmployeeTitle("Payments Header".Cashier);*/											
    ...
    local procedure FnEmployeeTitle(EmployeeNo: Code[200]) EmpTitle: Text															
    begin															
        ObjHREmployee.Reset;															
        ObjHREmployee.SetRange(ObjHREmployee."User ID", EmployeeNo);															
        if ObjHREmployee.Find('-') then															
            EmpTitle := ObjHREmployee."Job Title";															
        exit(EmpTitle);															
    end;															
