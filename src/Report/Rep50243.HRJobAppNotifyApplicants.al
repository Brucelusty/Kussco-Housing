...
Report 50243 "HR Job App. Notify Applicants"
{
    ApplicationArea = All;
    ProcessingOnly = true;
                ...
                if "HR Job Applications".Find('-') then begin
                    ...
                    if HREmailParameters.Find('-') then begin
                        ...
                        repeat
                            ...
                            Body := 'Dear';
                            Body += '<p>' + "First Name" + '</p>';
                            Body += '<p>' + HREmailParameters.Body + '</p>';
                            Body += '<p>' + "Job Applied For" + '</p>';
                            Body += '<p>' + HREmailParameters."Body 2" + '</p>';
                            Body += '<p>' + HREmailParameters."Body 3" + '</p>';
                            EmailMessage.Create("E-Mail", HREmailParameters.Subject, Body);
