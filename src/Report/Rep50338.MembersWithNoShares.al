...
//51516382_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50338 "Members With No Shares"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/MembersWithNoShares.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("No.") where("Outstanding Balance" = filter(> 0), "Current Shares" = filter(0));
