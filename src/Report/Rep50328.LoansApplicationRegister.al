...
Report 50328 "Loans Application Register"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/LoansApplicationRegister.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            column(LoansRegister_OutstandingBal; "Loans Register"."Outstanding Balance")															
            {															
            }															
