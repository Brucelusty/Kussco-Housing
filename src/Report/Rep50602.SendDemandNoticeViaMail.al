...
Report 50602 "Send Demand Notice Via Mail"
{
    ApplicationArea = All;
                    ...
                    if Emps."Employee Email" <> '' then
                        repeat
                            ...
                            if SalCard.Find('-') then begin
                                ...
                                EmailMessage.AddAttachment('Payslips.pdf', 'Payslip', base64Convert.ToBase64('Payslip'));
                               // ServerTempFileName := FileMgt.ServerTempFileName('pdf');
                               // Report.SaveAsPdf(Report::"Payroll Payslip.", ServerTempFileName, SalCard);
                                //FileMgt.BLOBImportFromServerFile(tempblob, ServerTempFileName);
                                tempblob.CreateInStream(instreamvar);
                                // instreamvar.Read(pays)
    ...
    var
        ...
        EmailAccounts: Codeunit "Email Message";
