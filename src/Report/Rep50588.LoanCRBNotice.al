//<---------------------------------------------------------------------->															
Report 50588 "Loan CRB Notice"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/LoanCRBNotice.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Default Notices Register"; "Default Notices Register")
        {
            ...
            column(ApproverUserII_DefaultNoticesRegister; "Default Notices Register"."Approver User II")
            {
            }
            column(ApproverDesignationII_DefaultNoticesRegister; "Default Notices Register"."Approver Designation II")
            {
            }
            column(ApproverSignatureII_DefaultNoticesRegister; "Default Notices Register"."Approver Signature II")
            {
            }
