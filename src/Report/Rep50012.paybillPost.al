report 50012 "paybillPost"
{
    ...
    dataset
    {
        dataitem(Customers; "Paybill Transactions")
        {
           ...
           // DataItemTableView = where(ISNormalMember = const(true));
            ...
            begin
                ...
                AuPay.FnPostPaybillTransaction();
            end;
    ...
    var
        ...
        AuPay: Codeunit "AU Paybill Automations Copy";
