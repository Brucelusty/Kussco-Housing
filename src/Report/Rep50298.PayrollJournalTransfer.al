...
Report 50298 "Payroll Journal Transfer.."
{
    ApplicationArea = All;
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("Payroll Employee."; "Payroll Employee.")
        {
            ...
            begin
                ...
                //PKK		
                PostingGroup.Reset();
                PostingGroup.SetRange("Posting Code", 'PAYROLL');
                ...
                if objEmp.Find('-') then begin
                    strEmpName := '[' + "No." + '] ' + objEmp."Last Name" + ' ' + objEmp."First Name" + ' ' + objEmp."Middle Name";
                ...
                //Message('arrived not yet home %1', "No.", PeriodTrans."Employee Code");
                PeriodTrans.Reset;
                PeriodTrans.SetRange(PeriodTrans."Employee Code", "No.");
                PeriodTrans.SetRange(PeriodTrans."Payroll Period", SelectedPeriod);
                if PeriodTrans.Find('-') then begin
                    repeat
                        // Message('arrived home %1', PeriodTrans."Employee Code");
                        if PeriodTrans."Journal Account Code" <> '' then begin
                            ...
                            if PeriodTrans."coop parameters" = PeriodTrans."coop parameters"::NSSF then begin
                                //Credit Payables															
                                //Credit Payables															
                                CreateJnlEntry(IntegerPostAs::"G/L Account", PostingGroup."SSF Employee Account",
                                ...
                                //Debit Staff Expense															
                                CreateJnlEntry(IntegerPostAs::"G/L Account", PostingGroup."SSF Employer Account",
    ...
    begin
        ...
        GeneraljnlLine."Shortcut Dimension 1 Code" := 'BOSA';
