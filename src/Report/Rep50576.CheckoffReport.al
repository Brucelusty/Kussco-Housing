...
Report 50576 "Checkoff Report"
{
    ...
    dataset
    {
        dataitem("Checkoff Header-Distributed"; "Checkoff Header-Distributed")
        {
            ...
            dataitem("Checkoff Lines-Distributed"; "Checkoff Lines-Distributed-NT")

            {
                ...
                column(Generated_CheckoffLinesDistributed; "Checkoff Lines-Distributed".NL_P)
                {
                }
                column(PaymentNo_CheckoffLinesDistributed; "Checkoff Lines-Distributed".NL_I)
                {
                }
                ...
                column(Name_CheckoffLinesDistributed; "Checkoff Lines-Distributed".DeFL_P)
                {
                }
                column(EarlyRemitances_CheckoffLinesDistributed; "Checkoff Lines-Distributed".DeFL_I)
                {
                }
                column(EarlyRemitanceAmount_CheckoffLinesDistributed; "Checkoff Lines-Distributed".MVL_P)
                {
                }
                column(LoanNo_CheckoffLinesDistributed; "Checkoff Lines-Distributed".MVL_I)
                {
                }
                column(MemberNo_CheckoffLinesDistributed; "Checkoff Lines-Distributed".INSURANCE)
                {
                }
                column(DependandSavings3_CheckoffLinesDistributed; "Checkoff Lines-Distributed"."Dependand Savings 3")
                {
                }
                column(DependandSavings1_CheckoffLinesDistributed; "Checkoff Lines-Distributed"."Dependand Savings 1")
                {
                }
                column(DEPT_CheckoffLinesDistributed; "Checkoff Lines-Distributed".BENEVOLENT)
                {
                }
                column(ExpectedAmount_CheckoffLinesDistributed; "Checkoff Lines-Distributed".SAdvanceL_P)
                {
                }
                column(FOSAAccount_CheckoffLinesDistributed; "Checkoff Lines-Distributed".SAdvanceL_I)
                {
                }
                column(UtilityType_CheckoffLinesDistributed; "Checkoff Lines-Distributed".DhamanaL_P)
                {
                }
                column(TransactionType_CheckoffLinesDistributed; "Checkoff Lines-Distributed".DhamanaL_I)
                {
                }
                column(Reference_CheckoffLinesDistributed; "Checkoff Lines-Distributed".HarakaL_P)
                {
                }
                column(Accounttype_CheckoffLinesDistributed; "Checkoff Lines-Distributed".HarakaL_I)
                {
                }
                ...
                column(Gnames_CheckoffLinesDistributed; "Checkoff Lines-Distributed".HouseHL_P)
                {
                }
                column(Gnumber_CheckoffLinesDistributed; "Checkoff Lines-Distributed".HouseHL_I)
                {
                }
                column(Userid1_CheckoffLinesDistributed; "Checkoff Lines-Distributed".JumboL_P)
                {
                }
                column(LoansNotfound_CheckoffLinesDistributed; "Checkoff Lines-Distributed".JumboL_I)
                {
                }
