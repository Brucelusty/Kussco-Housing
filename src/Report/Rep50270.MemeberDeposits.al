...
Report 50270 "Memeber Deposits"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/MemeberDeposits.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            {															
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");															
                DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date", "Customer No.") where("Transaction Type" = const(Loan));															
            ...
            {															
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");															
                DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date") where("Transaction Type" = filter("Dividend"));															
