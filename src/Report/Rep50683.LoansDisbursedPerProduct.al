report 50683 "Loans Disbursed Per Product"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts\loansdisbursedbyproduct.rdlc';
    ...
    dataset
    {
        dataitem("Loans Register";"Loans Register")
        {
            ...
            RequestFilterFields = "Posting Date","Issued Date","Last Pay Date","Loan  No.","Client Code","Loan Product Type","Loan Disbursement Date", "Date filter", "Loan Application Mode";
            ...
            // column(EmpLoanCodes_LoansRegister;"Loans Register"."Emp Loan Codes")
            // {
            // }
            ...
            {}
            column(Manin_Sector_Name;"Manin Sector Name")
            {}
            column(Sector_Specific_Name;"Sector Specific Name")
            {}
            column(SubSector_Name;"SubSector Name")
            {}
            column(New_Repayment_Period;Installments)
            {}
            column(Max__Installments;"Installments")
            {}
