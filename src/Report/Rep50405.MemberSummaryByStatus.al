...
Report 50405 "Member Summary By Status"
{
    ApplicationArea = All;
    ...
    begin
        ...
        //========================================================Awaiting Exit															
        ObjMembers.Reset;
        ObjMembers.SetRange(ObjMembers."Membership Status", ObjMembers."Membership Status"::"Awaiting Exit");
        ObjMembers.SetFilter(ObjMembers."Registration Date", Customer.GetFilter(Customer."Date Filter"));
        if ObjMembers.FindSet then begin
            ObjGensetup.CalcFields("Total Membership");
        ...
        //========================================================Exited															
        ObjMembers.Reset;
        ObjMembers.SetRange(ObjMembers."Membership Status", ObjMembers."Membership Status"::Exited);
        ObjMembers.SetFilter(ObjMembers."Registration Date", Customer.GetFilter(Customer."Date Filter"));
        if ObjMembers.FindSet then begin
            ObjGensetup.CalcFields("Total Membership");
        ...
        //========================================================Deceased															
        ObjMembers.Reset;
        ObjMembers.SetRange(ObjMembers."Membership Status", ObjMembers."Membership Status"::Deceased);
        ObjMembers.SetFilter(ObjMembers."Registration Date", Customer.GetFilter(Customer."Date Filter"));
        if ObjMembers.FindSet then begin
            ObjGensetup.CalcFields("Total Membership");
