...
//51516411_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50365 "Data Sheet ADJ Loan"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/DataSheetADJLoan.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = sorting("Sort Code") order(ascending) where(Source = filter(BOSA));															
            ...
            begin															
                ...
                No := No + 1;															
                if "Data Sheet Main"."Transaction Type" = "Data Sheet Main"."transaction type"::EFFECT then begin															
