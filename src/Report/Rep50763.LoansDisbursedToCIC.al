report 50763 "Loans Disbursed To CIC"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    DefaultLayout = RDLC;
    RDLCLayout = 'Layouts\loansdisbursedtoCIC.rdlc';
        ...
        dataitem("Loans Register";"Loans Register")
        {
            ...
            begin
                ...
                if cust.Find('-') then begin
                    ...
                    memberGender:= Format(cust.Gender)
                end;	
    ...
    Customer: Record "Membership Applications";
    FetchedCustomerID: Text[100];
    FetchedCustomerBirthDate: Text[100];
    "IDNo.": Code[30];
    DOB: Date;	
