...
Report 50787 "Loans Defaulter Aging Update"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            begin
                ...
                //  Message('LoanBal%1ExpectedBal%2',LBal,ExpectedBalance);
                ...
                //   Message('Arrears%1NoOFMonths%2', Arrears, "No.ofMonthsinArrears");
                ...
                if LSchedule.FindFirst() then begin
                    ScheduleStart := LSchedule."Repayment Date";
                end;

                //Message();
                //Classify The Loan According to Arrears and Days in Arrears
                IF ScheduleStart > AsAt THEN begin
                ...
                //  Message('ScheduleSart%1', ScheduleStart);
