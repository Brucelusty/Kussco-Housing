...
//51516020_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50113 "ATM Report"															
{															
    ApplicationArea = All;
    Caption = 'Bank Acc. - Detail Trial Bal.';															
    RDLCLayout = 'Layouts/ATMReport.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = sorting("No.") where("No." = const('BANK_0011'));															
            ...
            {															
                ...
                begin															
                    ...
                    SN := SN + 1;															
                    ATMS.Reset;															
                    ATMS.SetRange(ATMS."Reference No", "Bank Account Ledger Entry"."Document No.");															
                    if ATMS.Find('-') then begin															
                        //TransactionTime:=SMobile."Transaction Time";															
                        //PhoneNo:=SMobile."Telephone Number";															
                        AtmCardNo := ATMS."ATM Card No";															
                    end;															
                end;															
