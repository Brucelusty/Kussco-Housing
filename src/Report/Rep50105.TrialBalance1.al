...
//51516012_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50105 "Trial Balance.1"
{
    ApplicationArea = All;
    Caption = 'Trial Balance';
    RDLCLayout = 'Layouts/TrialBalance.1.rdlc';
    DefaultLayout = RDLC;
    ...
    begin
		...
		ExcelBuf.AddInfoColumn(REPORT::Report10022,FALSE,'',FALSE,FALSE,FALSE,'',ExcelBuf."Cell Type"::Number);													
		ExcelBuf.NewRow;													
