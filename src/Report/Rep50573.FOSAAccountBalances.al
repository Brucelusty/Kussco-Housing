...
//51516911_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50573 "FOSA Account Balances"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/FOSAAccountBalances.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            RequestFilterFields = "No.", "Account Type", "Employer Code";
            ...
            column(AccountBookBalance_Vendor; Vendor."Account Book Balance")
            {
            }
            column(EmployerCode_Vendor; Vendor."Employer Code")
            {
            }
            column(PersonalNo_Vendor; Vendor."Personal No.")
            {
            }
