...
//51516341_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50304 "Deductions Summary P.."															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/DeductionsSummaryP...rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            begin															
                ...
                prtransCodes.Reset;															
                //    prtransCodes.SetFilter(prtransCodes."Transaction Type",'=%1',prtransCodes."transaction type"::"1");															
                //    if prtransCodes.Find('-') then begin															
                //    repeat															
                //    begin															
                // 	 prPeriodTransactions.Reset;														
