...
Report 50019 "FDcontract"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/FDcontract.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Vendor; Vendor)
        {
            ...
            column(Fixed_Deposit_Certificate_No_;"Fixed Deposit Certificate No."){}
            column(Jipange_Balance;"Account Balance."){}
            column(Upon_Maturity;"Upon Maturity"){}
            column(FD_Interest_Rate;"FD Interest Rate"){}
            column(Fixed_Amount;"Fixed Amount"){}
            column(Tax;Tax){}
            column(Tax_Rate__;"Tax Rate %"){}
            column(Computed_Interest;"Computed Interest"){}
            column(Net_Interest;"Net Interest"){}
            column(Withdrawal_Before_Maturity_Charges;"Withdrawal Before Maturity Charges"){}
