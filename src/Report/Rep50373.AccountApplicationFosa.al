...
Report 50373 "Account Application Fosa"															
{															
    ApplicationArea = All;
    ...
    {															
        ...
        {															
            ...
            RequestFilterFields = "Global Dimension 1 Code", "Membership Approval Status";															
            ...
            column(Application_Date; "Membership Applications"."Membership Approval Status")															
            {															
            }															
