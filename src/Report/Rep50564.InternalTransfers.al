...
Report 50564 "Internal Transfers"															
{															
    ApplicationArea = All;
    ...
    {															
        ...
        {															
            ...
            begin															
                ...
                if "Sacco Transfers"."Source Account Type" = "Sacco Transfers"."Source Account Type"::"FOSA Account" then begin
                    vend.Reset();
                    vend.SetRange("No.", "Sacco Transfers"."Source Account No.");
                    if vend.Find('-') then begin
                        memberNo := vend."BOSA Account No";
                        memberName := vend.Name;
                    end;
                end else if "Sacco Transfers"."Source Account Type" = "Sacco Transfers"."Source Account Type"::"BOSA Account" then begin
                    cust.Reset();
                    cust.SetRange("No.", "Sacco Transfers"."Source Account No.");
