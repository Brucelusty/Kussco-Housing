...
Report 50294 "Sacco Link Report"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/SaccoLinkReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("ATM Card Applications"; "ATM Card Applications")
        {
            ...
            DataItemTableView = where(Status = filter(Approved), "ATM Card Fee Charged" = const(false), "Order ATM Card" = const(false), "Request Type" = filter(New|Replacement|Renewal));
            ...
            dataitem(Vendor; Vendor)
            {
                ...
                column(ID_No_; Vendor."ID No.")
                {
                }
                column(Surname; Vendor."First Name")
                {
                }
                column(OtherNames; Vendor."Last Name")
                {
                }
            ...
            begin
                ...
                if Members.Find('-') then begin
                    ...
                    OtherNames := Members."First Name" + ' ' + Members."Middle Name";
                    PhoneNumber:=Members."Mobile Phone No";
                end
