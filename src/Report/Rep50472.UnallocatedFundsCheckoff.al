...
Report 50472 "Unallocated Funds Checkoff"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Checkoff Header-Distributed"; "Checkoff Header-Distributed")
        {
            ...
            dataitem(ChecKoffLines; "Checkoff Lines-Distributed-NT")
            {
                ...
                column(Reference_ChecKoffLines; ChecKoffLines.HarakaL_P)
                {
                }
                column(DependandSavings1_ChecKoffLines; ChecKoffLines."Dependand Savings 1")
                {
                }
                column(LoanNo_ChecKoffLines; ChecKoffLines.MVL_I)
                {
                }
                column(StaffPayrollNo_ChecKoffLines; ChecKoffLines."Payroll No")
                {
                }
                column(Name_ChecKoffLines; ChecKoffLines.NL_P)
                {
                }
