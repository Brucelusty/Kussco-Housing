...
//51516359_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50317 "Member Account Statement-old"															
{															
    ApplicationArea = All;
    ...
    {															
        ...
        {															
            ...
            dataitem(Sharess; "Member Ledger Entry")															
            {															
                ...
                column(Description_Sharess; Sharess.Description)															
                {															
                }															
                column(DocumentNo_Sharess; Sharess."Document No.")															
                {															
                }															
                column(PostingDate_Sharess; Sharess."Posting Date")															
                {															
                }															
                column(CreditAmount_Sharess; Sharess."Credit Amount")															
                {															
                }															
                column(DebitAmount_Sharess; Sharess."Debit Amount")															
                {															
                }															
                column(Amount_Sharess; Sharess.Amount)															
                {															
                }															
                column(TransactionType_Sharess; Sharess."Transaction Type")															
                {															
                }															
                column(Sharess_Description; Sharess.Description)															
                {															
                }															
                column(USER1; Sharess."User ID")															
                {															
                }															
                ...
                begin															
                    CLosingBalance := CLosingBalance - Sharess.Amount;															
                end;															
            ...
            {															
                ...
                trigger OnPreDataItem();															
                begin															
                    ClosingBal := SharessBF;															
                    OpeningBal := SharessBF * -1;															
                end;															
            ...
            {															
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");															
                DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date") where("Transaction Type" = const(" "), Reversed = filter(false));															
            ...
            {															
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");															
                DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date") where("Transaction Type" = filter(" "), Reversed = filter(false));															
            ...
            {															
                ...
                column(LoanInterest; Loans.Interest)															
                {															
                }															
                ...
                {															
                    DataItemLink = "Customer No." = field("Client Code"), "Loan No" = field("Loan  No."), "Posting Date" = field("Date filter");															
                    DataItemTableView = sorting("Transaction Type", "Loan No", "Posting Date") where("Transaction Type" = filter("Deposit Contribution" | "Dividend"), Reversed = filter(false), "Loan No" = filter(<> ''), Description = filter(<> 'Interest on salary advance'));															
            ...
            {															
                ...
                column(GuaranteeSharess; "Loans Guarantee Details".Shares)															
                {															
                }															
