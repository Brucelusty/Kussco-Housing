...
//51516319_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50286 "payroll Allowances Report."															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/payrollAllowancesReport..rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = sorting("Group Order", "Transaction Code", "Period Month", "Period Year", Membership, "Reference No", "Department Code") where("Group Order" = filter(1 | 3));															
            ...
            begin															
                ...
                if HR.Find('-') then begin															
                    EmployeeName := HR.Firstname + ' ' + HR.Surname + ' ' + HR.Lastname;															
                end;															
