...
Report 50031 "CRB Report(Processed)"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("CRBA Datas"; "CRBA Datas")
        {
            ...
            column(Secondary_Identification_code; "CRBA Datas"."Secondary Identification 1") { }
            ...
            column(AmonutinKenyashillings; "CRBA Datas"."Amount in Kenya shillings")
            {
            }
