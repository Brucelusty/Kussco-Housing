...
Report 50629 "Daily Loan Porfolio Process"
{
    ApplicationArea = All;
    ProcessingOnly = true;
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            RequestFilterFields = "Recovery Mode", "Loan  No.", "Client Code", "Employer Code";
    ...
    var
        ...
        ObjNoSeriesMgt: Codeunit "No. Series";
        ObjLSchedule: Record "Loan Repayment Schedule";
        VarScheduleDate: Date;
        SurestpFactory: Codeunit "Au Factory";
        VarMobileNo: Code[30];
        VarSmsBody: Text[250];
        ...
        if ObjLoanPortfolio.FindSet then begin
            repeat
                ...
                if ObjLoan.FindSet then begin
                    ...
                    ObjCust.SetFilter(ObjCust."Membership Status", '<>%1', ObjCust."Membership Status"::Deceased);//Do not Alert or Accrue Penalty for Deceased Member															
