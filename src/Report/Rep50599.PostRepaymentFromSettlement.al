...
Report 50599 "Post Repayment From Settlement"
{
    ApplicationArea = All;
    ProcessingOnly = true;
                ...
                if ObjRepamentSchedule.FindSet then begin
                    ...
                    if ObjAccounts.FindSet then begin
                        ...
                        if AvailableBal >= VarTotalRepaymentDue then begin
                            ...
                            GenJournalLine."account type"::Customer, "Client Code", Today, "Outstanding Insurance" * -1, 'BOSA', "Loan  No.",
                            ...
                            GenJournalLine."account type"::Customer, "Client Code", Today, "Outstanding Interest" * -1, 'BOSA', "Loan  No.",
                            ...
                            LineNo := LineNo + 10000;
                            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
                            GenJournalLine."account type"::Customer, "Client Code", Today, VarPrincipalRepayment * -1, 'BOSA', "Loan  No.",
                    ...
                    if AvailableBal < VarTotalRepaymentDue then begin
                        ...
                        if AvailableBal > 0 then begin
                            ...
                            LineNo := LineNo + 10000;
                            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Loan Insurance Paid",
                            GenJournalLine."account type"::Customer, "Client Code", Today, VarInsuranceAmountDed * -1, 'BOSA', "Loan  No.",
                            'Insurance Paid from Settlement', "Loan  No.", GenJournalLine."application source"::CBS);
                        ...
                        if AvailableBal > 0 then begin
                            LineNo := LineNo + 10000;
                            SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
                            GenJournalLine."account type"::Customer, "Client Code", Today, VarInterestAmountDed * -1, 'BOSA', "Loan  No.",
                            'Interest Paid from Settlement', "Loan  No.", GenJournalLine."application source"::CBS);
        ...
        if VarLoansCount = 1 then begin
            ...
            if ObjRepamentSchedule.FindSet then begin
                ...
                if ObjAccounts.FindSet then begin
                    ...
                    GenJournalLine."account type"::Customer, VarMemberNo, Today, 'Excess_Principle Paid from Settlement', GenJournalLine."bal. account type"::Vendor, ObjAccounts."No.",
                    AvailableBal * -1, 'BOSA', VarLoanNo);

                    LineNo := LineNo + 10000;
                    SFactory.FnCreateGnlJournalLine(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"Interest Paid",
                    GenJournalLine."account type"::Customer, VarMemberNo, Today, AvailableBal * -1, 'BOSA', VarLoanNo,
