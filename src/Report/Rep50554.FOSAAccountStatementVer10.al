...
//51516890_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50554 "FOSA Account Statement Ver.1.0"
{
    ApplicationArea = All;
    Caption = 'Account Statement';
    RDLCLayout = 'Layouts/FOSAAccountStatementVer.1.0.rdlc';
    DefaultLayout = RDLC;
    ...
    begin
        ...
        FromDate := SFactory.FnRunGetStatementFromDate(VendDateFilter);
        ToDate := SFactory.FnRunGetStatementToDate(VendDateFilter);
