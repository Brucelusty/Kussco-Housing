...
//51516209_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50266 "Portfolio at Risk Report"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/PortfolioatRiskReport.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            RequestFilterFields = "Loan  No.", "Client Code", "Amount in Arrears";															
            ...
            begin															
                SN := SN + 1;															
                RecoveryLogs.Reset;															
                RecoveryLogs.SetRange(RecoveryLogs."Loan No", "Loans Register"."Loan  No.");															
                // RecoveryLogs.SETRANGE(RecoveryLogs."Member No","Loans Register"."Client Code");															
                if RecoveryLogs.FindLast then begin															
                    FollowUp := RecoveryLogs."Log Description";															
                end else															
                    FollowUp := '';															
            end;															
    ...
    var															
        ...
        SN: Integer;															
        FollowUp: Text;															
        RecoveryLogs: Record "Loan Recovery Logs";															
