...
//51516970_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50631 "Bank Advise Schedule"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/BankAdviseSchedule.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            begin															
                if BankAccount.Get("Loans Register"."Paying Bank Account No") then;															
                cust.Reset;															
                ...
                if "Loans Register"."Bank code" <> '' then															
                    BankCode := "Loans Register"."Bank code";															
                if "Loans Register"."Bank Branch" <> '' then															
                    Branchcode := "Loans Register"."Bank Branch";															
                if "Loans Register"."Bank Account No" <> '' then															
                    MemAccNo := "Loans Register"."Bank Account No";															
