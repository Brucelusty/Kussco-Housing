...
//51516128_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50197 "Imprest Voucher"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/ImprestVoucher.rdlc';
    DefaultLayout = RDLC;
        ...
        dataitem("Payments Header"; "Payments Header")
        {
            ...
            begin
                ...
                if VendEnrty.Find('-') then begin
                    repeat
                        //CODF VendEnrty.DocNo:= VendEnrty."Document No.";															
                ...
                TTotal := 0;
                if "Payment Type" <> "payment type"::FOSA then
                ...
                //CODF CheckReport.InitTextVariable();															
