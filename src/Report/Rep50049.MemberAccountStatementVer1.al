//<---------------------------------------------------------------------->															
Report 50049 "Member Account Statement(Ver1)"
{
    ApplicationArea = All;
...
//
            ...
            {
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");
               // DataItemTableView = sorting("Posting Date") where("Transaction Type" = filter("Utafiti Housing"), "Entry Type" = filter(<> 'Application'), Reversed = filter(false));
            ...
            {
                DataItemLink = "Customer No." = field("No."), "Posting Date" = field("Date Filter");
                //DataItemTableView = sorting("Posting Date") where("Transaction Type" = filter("Coop Shares"), "Entry Type" = filter(<> 'Application'), Reversed = filter(false));
            ...
            dataitem(Loans; "Loans Register")
            {
                ...
                DataItemTableView = sorting("Issued Date", "Loan Disbursement Date","Loan Product Type") order(descending) where(Posted = const(true));
