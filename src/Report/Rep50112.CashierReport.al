    ...
    {															
        ...
        {															
                ...
                begin															
                    ...
                    if "Bank Account Ledger Entry"."Bal. Account Type" = "Bank Account Ledger Entry"."bal. account type"::Customer then begin															
                        if Cust.Get("Bank Account Ledger Entry"."Bal. Account No.") then															
                            Names := Cust.Name;															
                    end else if "Bank Account Ledger Entry"."Bal. Account Type" = "Bank Account Ledger Entry"."bal. account type"::Vendor then begin
                            if Vend.Get("Bank Account Ledger Entry"."Bal. Account No.") then
                                Names := Vend.Name;															
                        end	else if "Bank Account Ledger Entry"."Bal. Account Type" = "Bank Account Ledger Entry"."bal. account type"::"Bank Account" then begin															
                                if Bank.Get("Bank Account Ledger Entry"."Bal. Account No.") then
                                    Names := Bank.Name;
                            end else if "Bank Account Ledger Entry"."Bal. Account Type" = "Bank Account Ledger Entry"."Bal. Account Type"::"G/L Account" then begin
                                if gl.Get("Bank Account Ledger Entry"."Bal. Account No.") then begin
                                    Names := gl.Name;
                                end;
                            end;
            ...
            {															
                ...
                DataItemTableView = sorting(No) where("Type _Transactions" = Filter("Cheque Deposit"|"Mpesa Withdrawal"), Posted = const(true), Reversed = filter(false));															
                ...
                column(Type__Transactions;Transactions."Type _Transactions")
                {
                }															
