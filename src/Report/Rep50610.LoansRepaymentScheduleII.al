...
//51516949_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50610 "Loans Repayment Schedule II"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/LoansRepaymentScheduleII.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            {															
                ...
                column(PrincipleAmountPaid_LoanRepaymentSchedule; "Loan Repayment Schedule"."Principle Amount Paid")															
                {															
                }															
                column(InterestPaid_LoanRepaymentSchedule; "Loan Repayment Schedule"."Interest Paid")															
                {															
                }															
                column(InsurancePaid_LoanRepaymentSchedule; "Loan Repayment Schedule"."Insurance Paid")															
                {															
                }															
