...
Report 50329 "Loans Guard Report"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem("Loans Register"; "Loans Register")
        {
            ...
            column(MemberGender; memberGender)
            {
            }
            ...
            column(Loans__Days_In_Arrears_; "Loans Register"."Days In Arrears")
            {
            }
            ...
            column(schemeName; "hr set-up"."Scheme Name")
            { }
            column(scheme; scheme)
            { }
            column(currentDate; currentDate)
            { }
            column(daysToCompletion; daysToCompletion)
            { }
            ...
            begin
                ...
                if "Loans Register"."Expected Date of Completion" <> 0D then begin
                    daysToCompletion := "Loans Register"."Expected Date of Completion" - Today;
                end;
