Report 50069 "Loan Statement BOSA"
    ...
    dataset
    {
        dataitem("Member Register"; Customer)
        {
            ...
            dataitem(Loans; "Loans Register")
            {
                ...
                DataItemTableView = sorting("Issued Date", "Loan Disbursement Date","Loan Product Type") order(descending) where(Posted = const(true), "Outstanding Balance" = filter(>0));
                ...
                column(Repayment_Loans; Loans."Schedule Repayment")
                {
                }
                ...
                dataitem(loan; "Detailed Cust. Ledg. Entry")
                {
                   ...
                   DataItemTableView = sorting("Posting Date") where("Transaction Type" = filter(Loan | repayment | "Interest Paid" | "Interest Due"| "Loan Penalty Charged" | "Loan Penalty Paid"), "Entry Type" = filter(<> 'Application'), Reversed = filter(false));
