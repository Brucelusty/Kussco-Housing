...
//51516871_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															

Report 50538 "Member Safari Savings Report"
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/MemberSafariSavingsReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        ...
        {
            DataItemTableView = where("Safari Savings" = filter(<> 0));
            PrintOnlyIfDetail = false;
            RequestFilterFields = "No.", Status, "Employer Code", "Payroll No", "Junior Savings", "Date Filter";
