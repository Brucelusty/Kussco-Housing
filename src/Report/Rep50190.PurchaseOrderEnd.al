...
Report 50190 "Purchase Order End"
{
    ApplicationArea = All;
    Caption = 'Order';
    ...
    dataset
    {
        dataitem("Purchase Header"; "Purchase Header")
        {
            ...
            column(ExpiryDate_PurchaseHeader; "Purchase Header"."Currency Code")
            {
                IncludeCaption = true;
            }
            ...
            column(SpecialRemark_PurchaseHeader; "Purchase Header"."Currency Code")
            {
            }
            ...
            column(Pterms2017; "Purchase Header"."Currency Code")
            {
            }
