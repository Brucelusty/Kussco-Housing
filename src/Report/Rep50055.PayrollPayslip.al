...
Report 50055 "Payroll Payslip."
{
    ApplicationArea = All;
    RDLCLayout = 'Layouts/Payroll Payslip Sacco.rdlc';
    DefaultLayout = RDLC;
        ...
        dataitem("Payroll Employee."; "Payroll Employee.")
        {
            ...
            dataitem("prPeriod Transactions."; "prPeriod Transactions.")
            {
                ...
                begin
                    ...
                    PayrollCalender.SetRange(PayrollCalender."Date Opened", "prPeriod Transactions."."Payroll Period");
