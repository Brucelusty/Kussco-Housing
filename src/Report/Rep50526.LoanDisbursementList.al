...
//51516858_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50526 "Loan Disbursement List"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/LoanDisbursementList.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            RequestFilterFields = "Loan  No.", Source, "Loan Product Type", "Date filter", "Application Date", "Loan Status", "Issued Date", Posted, "Batch No.", "Captured By", "Branch Code", "Outstanding Balance", "Date Approved", "Employer Code", "Loans Category", Rescheduled;															
