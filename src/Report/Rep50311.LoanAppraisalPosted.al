...
//51516352_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50311 "Loan Appraisal-Posted"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/LoanAppraisal-Posted.rdlc';															
    DefaultLayout = RDLC;															
        ...
        {															
            ...
            begin															
                ...
                if Cust.Get("Loans Register"."Client Code") then begin															
                    ...
                    if "Loans Register".Source <> "Loans Register".Source::" " then begin															
                    ...
                    if LoanType.Get("Loan Product Type") then begin															
                        ...
                        if "Member Account Category" <> "member account category"::Group then begin															
                            ...
                            if ProductCharges.Find('-') then begin															
                                if ProductCharges."Use Perc" = true then begin															
                                    LoanInsurance := "Approved Amount" * (ProductCharges.Percentage); //*Installments;															
                                end else															
                        ...
                        if "Member Account Category" <> "member account category"::Group then begin															
                            ...
                            if ProductCharges.Find('-') then begin															
                                if ProductCharges."Use Perc" = true then begin															
                                    LPFcharge := "Approved Amount" * (ProductCharges.Percentage); //*Installments;															
                                end else															
                        ...
                        if "Mode of Disbursement" = "mode of disbursement"::Cheque then															
                            ...
                            "Loan SMS Fee" + "Share Capital Due"															
                        else															
                            if "Mode of Disbursement" = "mode of disbursement"::EFT then															
                                ...
                                if "Mode of Disbursement" = "mode of disbursement"::"FOSA Account" then															
                                    Upfronts := TotalBridgeAmount + LoanInsurance + LPFcharge															
                                else															
