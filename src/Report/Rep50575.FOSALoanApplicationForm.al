...
//51516913_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50575 "FOSA Loan Application Form"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/FOSALoanApplicationForm.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            column(MemberDivision; MemberDivision)															
            {															
            }															
            column(MemberZone; MemberZone)															
            {															
            }															
            column(MemberBranch; MemberBranch)															
            {															
            }															
            column(MemberPhoneNo; MemberPhoneNo)															
            {															
            }															
            column(Age; Age)															
            {															
            ...
            column(CurrentDeposits; Cshares)															
            {															
            }															
            column(PlazaShares; PlazaShares)															
            {															
            }															
            column(DepositMult; DEpMultiplier)															
            {															
            }															
            column(TotalLBal; TotalLoanBal)															
            {															
            }															
            column(BasicPayForm; "Loans Register"."Basic Pay H")															
            {															
            }															
            column(RepaymentStartDate; Format("Loans Register"."Repayment Start Date"))															
            {															
            }															
            column(MemberNo; "Loans Register"."Client Code")															
            {															
            }															
            column(FOSAAccountNo; "Loans Register"."Account No")															
            {															
            }															
            ...
            begin															
                ...
                if Cust.Get("Loans Register"."Client Code") then begin															
                    Cust.CalcFields(Cust."Current Shares", Cust."Shares Retained", Cust."Pending Loan Application Amt");															
                    Cshares := Cust."Current Shares";															
                    ShareCap := Cust."Shares Retained";															
                    PlazaShares := Cust."Pending Loan Application Amt";															
                    MemberID := Cust."ID No.";															
                    MemberAddress := Cust.Address;															
                    MemberBranch := Cust."Global Dimension 2 Code";															
                    MemberPhoneNo := Cust."Mobile Phone No";															
                    MemberDivision := Cust."Division/Department";															
                    Age := Dates.DetermineAge(Cust."Date of Birth", Today);															
                    if LoanType.Get("Loans Register"."Loan Product Type") then begin															
                    ...
                    if ("Loans Register".Source = "Loans Register".Source::BOSA) then begin															
                        if ("Loans Register"."Loan Product Type" <> 'IMPORTED') then begin															
    ...
    var															
        ...
        Comment________________________________________________________________________Caption_Control1102755070Lbl: label 'Comment :____________________________________________________________________________________';															
        ...
        MemberAddress: Code[30];															
        MemberID: Code[30];															
        MemberDivision: Code[30];															
        MemberZone: Code[30];															
        MemberBranch: Code[30];															
        MemberPhoneNo: Code[30];															
