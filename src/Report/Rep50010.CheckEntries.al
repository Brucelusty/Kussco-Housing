report 50010 "Check Entries"
{
    ...
    dataset
    {
        dataitem(DataItemName; "FOSA Account Applicat. Details")
        {
            RequestFilterFields = "No.";

            //DataItemTableView = where("Flagged Transactions" = filter(> 0));
            ...
            begin
                ...
                DataItemName.Status := DataItemName.Status::Approved;
                DataItemName.Modify();
                /*   
                ...
                //BATCH_TEMPLATE := 'GENERAL';
                // BATCH_NAME := 'RECOVERY';
                //DOCUMENT_NO := 'MOBILEWITH14/06/2024';
                ...
                //Paybill(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."Transaction Type"::" ",
                // GenJournalLine."Account Type"::Vendor, VendorCommAccount, Today, VendorComm * -1, 'FOSA', DOCUMENT_NO,
                //  'Mobile Trans Mpesa Comm' + ' ' + DataItemName."No.", '');
            ...
            begin
                ...
                /*                 DataItemName.Reset();
                                DataItemName.SetRange(DataItemName."Document No.",'MOBILEWITH14/06/2024');
                                if DataItemName.FindSet() then begin
                                    DataItemName.DeleteAll();
                                end; */
                Paybill.FnPostPaybillTransaction();
            end;
