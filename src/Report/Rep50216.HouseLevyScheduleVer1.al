...
//51516148_v6_3_0_2259) { }															
// Autogenerated code - do not delete or modify -->															
															
Report 50216 "House Levy Schedule Ver1"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/HouseLevyScheduleVer1.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            ...
            begin															
                ...
                PeriodTrans.SetFilter(PeriodTrans."Transaction Code", 'D_0017');															
                if PeriodTrans.Find('-') then begin															
                    VarHouseLevy := PeriodTrans.Amount;															
                end;															
                if VarHouseLevy <= 0 then															
                    CurrReport.Skip;															
