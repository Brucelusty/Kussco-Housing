    ...
    dataset
    {
        dataitem(Cust; Customer)
        {
            ...
            begin
                ...
                Loans.SetFilter(Loans."Loans Category", '%1|%2|%3', Loans."Loans Category"::Substandard,Loans."Loans Category"::Doubtful,Loans."Loans Category"::Loss);
                ...
                if Loans.FindSet then begin
                    repeat
                        ...
                        if Member.Get(Loans."Client Code") then begin
                            ...
                            if CRBA."Marital Status" = CRBA."Marital Status"::Divorced then
                            ...
                            CRBA."Secondary Identification 1" := Member."Passport No.";
                            ...
                            if Member."Employer Code" = Member."Employer Code" then
                            ...
                            CRBA."Amount in Kenya shillings" := Format(Round(Loans."Approved Amount", 1, '='));
                            Loans.CalcFields("Outstanding Balance");
                            // CRBA."Current Balance" := Loans."Outstanding Balance";

                            CRBA."Lenders Registered Name" := 'TELEPOST DT SACCO SOCIETY LTD';;
                            CRBA."Lenders Trading Name" := 'TELEPOST DT SACCO SOCIETY LTD';
                            CRBA."Lenders Branch Name" := 'HEAD OFFICE';
                            CRBA."Lenders Branch Code" := '001';
