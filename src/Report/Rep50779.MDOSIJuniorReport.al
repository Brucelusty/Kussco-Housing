report 50779 "MDOSI Junior Report"
{
    ApplicationArea = All;
    UsageCategory = ReportsAndAnalysis;
    RDLCLayout = 'Layouts/MDOSI Accounts Listing.RDLC';

    dataset
    {
        dataitem(Vendor; Vendor)
        {
            DataItemTableView = sorting("No.") WHERE("Account Type" = filter(109));
            ...
            { }
            column(Childs_Gender; "Childs Gender")
            { }
            column(Child_DOB; "Child DOB")
            { }
