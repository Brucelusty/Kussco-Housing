...
Report 50353 "Monthly Variance Report1"
{
    ApplicationArea = All;
    ...
    dataset
    {
        dataitem(Monthly_Remittance; "Checkoff Lines-Distributed-NT")
        {
            PrintOnlyIfDetail = false;
            RequestFilterFields = MVL_I, TOTAL_DISTRIBUTED, SAdvanceL_I, EMER_P;
            ...
            column(Name; Monthly_Remittance.NL_P)
            {
            }
            column(Expected_Amount; Monthly_Remittance.SAdvanceL_P)
            {
            }
            ...
            column(DependandSavings1; Monthly_Remittance."Dependand Savings 1")
            {
            }
