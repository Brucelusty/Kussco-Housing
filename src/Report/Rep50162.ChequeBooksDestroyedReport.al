...
Report 50162 "Cheque Books Destroyed Report"															
{															
    ApplicationArea = All;
    RDLCLayout = 'Layouts/ChequeBooksDestroyedReport.rdlc';															
    DefaultLayout = RDLC;															
    ...
    {															
        ...
        {															
            DataItemTableView = where("Cheque Book Received" = const(true), "Destruction Approval" = const(true));															
            ...
            column(DestructionApproval_ChequeBookApplications; "Cheque Book Application"."Destruction Approval")															
            {															
            }															
