...
Table 50561 "Payment Header."
{
    ...
    fields
    {
        ...
        field(28; "Bank Account Name"; Text[1000])
        {
            Editable = false;
        }
        ...
        field(32; "Payment Description"; Text[1000])
        {
        }
        ...
        field(71; "Payment Purpose"; Code[20])
        {
            TableRelation = "Petty Cash Transaction Types".Code;
        }
        field(72; "Staff Payment"; Boolean)
        {
            trigger OnValidate()
            begin
                if "Staff Payment" = true then begin
                    employees.Reset();
