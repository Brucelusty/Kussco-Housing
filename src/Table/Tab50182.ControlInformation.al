...
Table 50182 "Control-Information"
{
    ...
    fields
    {
        ...
        field(172000; "Company P.I.N"; Code[30])
        {
        }
        field(172001; "N.S.S.F No."; Code[30])
        {
        }
        field(172002; "Company code"; Code[10])
        {
        }
        field(172003; "Working Days Per Year"; Integer)
        {
        }
        field(172004; "Working Hours Per Week"; Integer)
        {
        }
        field(172005; "Working Hours Per Day"; Integer)
        {
        }
        field(172006; Mission; Text[250])
        {
        }
        field(172007; "Mission/Vision Link"; Text[50])
        {
        }
        field(172008; Vision; Text[250])
        {
        }
        field(172009; "N.H.I.F No"; Text[100])
        {
        }
        field(172010; "Payslip Message"; Text[250])
        {
            Description = 'Dennis Added';
        }
        field(172011; "Multiple Payroll"; Boolean)
        {
        }
        field(172012; "Picture USAID"; Blob)
        {
            SubType = Bitmap;
        }
        field(172013; "Board Tax Percent"; Decimal)
        {
        }
        field(172014; "Committee Tax Per"; Decimal)
        {
        }
    }
