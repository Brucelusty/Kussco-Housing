...
Table 50332 "Payroll General Setup."
{
    ...
    fields
    {
        ...
        field(42; "Zakayo Levy"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(43; "SHIF"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(44; "Min SHIF"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(45; "SHIF Relief"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(46; "Max SHIF Relief"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
    }
