...
Table 50449 "Salary Processing Headerr"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Salary Processing Lines".Amount where("Salary Header No." = field(No), "Already Posted" = filter(false)));
            Editable = false;
            FieldClass = FlowField;
        }
        field(27; "Total Count"; Integer)
        {
            CalcFormula = count("Salary Processing Lines" where("Salary Header No." = field(No), "Already Posted" = filter(false)));
            FieldClass = FlowField;
        }
        ...
        field(29; "Employer Code"; Code[30])
        {
            ...
            begin
                employers.Get("Employer Code");
                "Employer Receiveable Acc" := employers."Customer Account";
            end;
        }
        ...
        {
            OptionCaption = 'Normal Salary,Delayed Salary,Mdosi';
            OptionMembers = "Normal Salary","Delayed Salary",Mdosi;
            Caption = 'Salary Type';
            trigger OnValidate()
            begin
        ...
        field(40; "Loan Cutoff"; date)
        {

        }
        field(41; Type; Option)
        {
            OptionMembers = ,,Milk,Tea,Bonus,Dividends,Pension,Salary,Allowance;
            OptionCaption = ',,Milk,Tea,Bonus,Dividends,Pension,Salary,Allowance';
            DataClassification = ToBeClassified;
        }

        field(42; "Employer Receiveable Acc"; Code[20])
        {

        }

        field(43; "Member Bonus?"; boolean)
        {
    ...
    begin
        ...
        if No = '' then begin
            ...
            NoSeriesMgt.GetNextNo(NoSetup."Salary Processing Nos");
        end;
