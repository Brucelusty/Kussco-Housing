...
Table 50654 "House Groups Registration"
{
    //nownPage51516961;
    //nownPage51516961;
    ...
    fields
    {
        ...
        {
            CalcFormula = count("Members Register" where("Member House Group" = field("House Group Code")));
    ...
    begin
        if "House Group Code" = '' then begin
            ...
            NoSeriesMgt.GetNextNo(SalesSetup."House Group Application");
        end;
