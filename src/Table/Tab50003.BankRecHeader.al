table 50003 "Bank Rec. Header"
{
    ...
    fields
    {
        ...
        {
            // CalcFormula = Sum("Bank Acc. Reconciliation Line"
            // .Amount WHERE("Bank Account No." = FIELD("Bank Account No."),
            //                                                  "Statement No." = FIELD("Statement No."),
            //                                                  "Record Type" = CONST(Adjustment),
            //                                                  Positive = CONST(false),
            //                                                  "Bal. Account No." = FIELD("Bank Account No."),
    ...
    [IntegrationEvent(false, false)]
    local procedure OnUpdateAllLineDimOnBeforeBankRecLineModify(var BankRecLine: Record "Bank Acc. Reconciliation Line")
    begin
    end;
}
