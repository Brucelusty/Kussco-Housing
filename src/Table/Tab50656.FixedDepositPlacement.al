...
Table 50656 "Fixed Deposit Placement"
{
    ...
    fields
    {
        field(1; "Document No"; Code[20])
        {
            ...
            begin
                if "Document No" <> xRec."Document No" then begin
                    SalesSetup.Get;
                    NoSeriesMgt.TestManual(SalesSetup."New Fixed Deposits");
                    "No. Series" := '';
                end;
            end;
        }
        ...
        {
            TableRelation = Customer."ID No.";

            trigger OnValidate()
            begin
                objCust.Reset;
                objCust.SetRange("ID No.", "Member No");
        ...
        {
            TableRelation = Vendor."No." where("BOSA Account No" = field("Member No"),
                                                "Account Type" = filter('103'));
        }
        field(24; "FD Closed On"; Date)
        {
        }
        field(25; "FD Closed By"; Code[40])
        {
        }
        ...
        field(32; "Fixed Deposit No."; Code[20])
        {
        }
        field(33; Posted; Boolean)
        {
        }
        field(34; "Posted By"; Code[20])
        {
        }
        field(35; "Posted On"; Date)
        {
        }
    }
    ...
    begin
        if "Document No" = '' then begin
            SalesSetup.Get;
            SalesSetup.TestField(SalesSetup."New Fixed Deposits");
            NoSeriesMgt.GetNextNo(SalesSetup."New Fixed Deposits");
        end;
