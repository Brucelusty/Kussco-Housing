...
Table 50421 "FOSA Account Applicat. Details"
{
    ...
    fields
    {
        ...
        field(67998; "Child Photo"; MediaSet)
        {
        }
        ...
        field(68012; "BOSA Account No"; Code[20])
        {
            ...
            begin
                ...
                if Cust.Get("BOSA Account No") then begin
                    Cust.CALCFIELDS(Cust."Jipange Balance");
                    Name := Cust.Name;
                    "Account Balance" := cust."Jipange Balance";
                    "Vendor Account No" := Cust."FOSA Account No.";
                    ...
                    "KRA No." := Cust.Pin;
                    "ID No." := Cust."ID No.";
                    "ID Front" := Cust."ID Front";
                    "ID Back" := Cust."ID Back";
        ...
        {
            TableRelation = "Account Types-Saving Products".Code where("Activity Code" = filter(FOSA));
        ...
        field(68018; "Account Category"; Enum AccountCategoryEnum)
        {
        ...
        {
            OptionCaption = 'Pending,Approved,Created,Rejected,Incomplete';
        ...
        field(68031; "Application Date"; Date)
        {
            ...
            begin
                ...
                "FD Maturity Date" := CalcDate("Duration", "Application Date");
            end;
        }
        ...
        field(68127; "Recruited By"; Code[500])
        {
            TableRelation = Vendor."No.";
        }
        ...
        field(68129; "Created By"; Code[200])
        {
        }
        field(68130; "Captured By"; Code[200])
        {
        }
        ...
        field(69256; "Name of the Child"; Text[2048])
        {
        }
        field(69257; "Birth Certificate-Child"; Code[2048])
        {
        }
        field(69258; "Date of Birth-Child"; Date)
        {
            trigger OnValidate()
            begin
                if "Date of Birth" > Today then
                    Error('Kindly, date of birth cannot be in the future.');
            end;
        }
        field(69259; "Vendor Account No"; Code[20])
        {
        }
        field(69260; "Fixed Amount"; Decimal)
        {
            trigger OnValidate()
            var
            ...
            begin
                ...
                "Withdrawal Before Maturity Charges" := SaccoGeneralSetUp."Withdrawal Before Maturity Charges";
                "Tax Rate %" := SaccoGeneralSetUp."Withholding Tax (%)";
                "Computed Interest" := ("FD Interest Rate" * "Fixed Amount" * ("FD Duration") / 12) / 100;
                Tax := ("Computed Interest" * "Tax Rate %") / 100;
                "Net Interest" := "Computed Interest" - Tax;


            end;
        }
        field(69261; "FD Duration"; Integer)
        {
        }
        field(69262; "FD Interest Rate"; Decimal)
        {
        }
        field(69263; "Account Balance"; Decimal)
        {

            Editable = false;

        }
        field(69264; "FD Type Speedkey"; Code[30])
        {

            TableRelation = "FD Interest Calculation Crite"."FD Rates Speedkey";
            trigger OnValidate()
            var
                criteria: Record "FD Interest Calculation Crite";
                SaccoGeneralSetUp: Record "Sacco General Set-Up";
            begin
                criteria.Reset();
                criteria.SetFilter(criteria."FD Rates Speedkey", "FD Type Speedkey");

                if criteria.FindFirst() then begin
                    SaccoGeneralSetUp.Get();
                    "Minimum Amount" := criteria."Minimum Amount";
                    "Maximum Amount" := criteria."Maximum Amount";
                    "FD Duration" := criteria."No of Months";
                    "FD Interest Rate" := criteria."Interest Rate";
                    Duration := criteria.Duration;
                    // Message('Minimum Amount-Maximum Amount-FD Duration-FD Interest Rate %1%2%3%4',"Minimum Amount","Maximum Amount","FD Duration","FD Interest Rate");
                    Rec.Modify()
                end;
        ...
        field(69265; "Minimum Amount"; Decimal)
        {

            Editable = false;

        }
        field(69266; "Maximum Amount"; Decimal)
        {

            Editable = false;

        }
        field(69267; "Child Phone No."; code[20])
        {

        }
        field(69268; "Child ID No."; code[20])
        {

        }
        field(69269; "Withdrawal Before Maturity Charges"; Decimal)
        {

            Editable = false;

        }
        field(69270; "Tax Rate %"; Decimal)
        {

            Editable = false;

        }
        field(69271; "Upon Maturity"; Option)
        {
        ...
        field(69272; "Computed Interest"; Decimal)
        {

            Editable = false;

        }
        field(69273; "Tax"; Decimal)
        {

            Editable = false;

        }
        field(69274; "Net Interest"; Decimal)
        {

            Editable = false;

        }
        field(69275; "Duration"; DateFormula)
        {

            Editable = false;

        }
        field(69276; "Fixed Deposit Certificate No."; code[30])
        {
        ...
        field(69277; "ID Front"; MediaSet)
        {

        }
        field(69278; "ID Back"; MediaSet)
        {

        }
        field(172070; "Business Name(Store)"; Code[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172071; "Business Short Code(Store)"; Code[70])
        {
            DataClassification = ToBeClassified;
        }

        field(172072; "Business Type(Store)"; Code[70])
        {
            DataClassification = ToBeClassified;
        }
        field(172073; "Business Status(Store)"; Option)
        {
            DataClassification = ToBeClassified;
            OptionMembers = " ",Active,Dormant;
        }
        field(172074; "Business Location(Store)"; Code[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172075; "Business Contact(Store)"; Code[80])
        {
            DataClassification = ToBeClassified;
        }

        field(172076; "Business Email(Store)"; Code[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172077; "Business Phone(Store)"; Code[80])
        {
            DataClassification = ToBeClassified;
        }
        field(172078; "Business Website(Store)"; Text[500])
        {
            DataClassification = ToBeClassified;
        }

        field(172079; "Business Logo(Store)"; Blob)
        {
            DataClassification = ToBeClassified;
        }

        field(172080; "Business Description(Store)"; Text[500])
        {
            DataClassification = ToBeClassified;
        }
        field(68134; "Approved By"; Code[30])
        {
        }
        field(68135; "New FOSA No."; Code[30])
        {
        }
    ...
    begin
        ...
        if (Status = Status::Approved) or (Status = Status::Pending) or (Status = Status::Rejected) then begin
            Error('This record cannot be');
        end;
    ...
    begin
        if "No." = '' then begin
           ...
           "No." := NoSeriesMgt.GetNextNo(PurchSetup."Applicants Nos.");
        end;
        if "Invoice Disc. Code" = '' then
            "Invoice Disc. Code" := "No.";
        "Created By" := UserId;
    ...
    var
        ...
        UsersID: Record User;
        FDType: Record "FD Interest Calculation Crite";
