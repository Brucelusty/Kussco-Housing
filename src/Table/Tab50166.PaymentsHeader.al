...
Table 50166 "Payments Header"
{
    ...
    fields
    {
        ...
        field(28; "Paying Bank Account"; Code[20])
        {
            ...
            TableRelation = if ("Paying Type" = const(BANK)) "Bank Account" else
            if ("Paying Type" = const(FOSAAccount)) "Vendor" else
            if ("Paying Type" = const(GLAccount)) "G/L Account" else
            if ("Paying Type" = const(Customer)) Customer;
        ...
        {
            OptionCaption = 'Bank,FOSA';
            OptionMembers = Bank,FOSA;
        }
        ...
        field(66; "Cheque No."; Code[20])
        {
            ...
            trigger OnValidate()
            begin
                if StrLen("Cheque No.") < 6 then Error('Cheque No. Can not be less than 6 Characters');
            end;
        }
        ...
        {
            OptionCaption = 'Bank,GLAccount,Customer,FOSAAccount';
            OptionMembers = Bank,GLAccount,Customer,FOSAAccount;
        }
    ...
    begin
        ...
        if "No." = '' then begin
            GenLedgerSetup.Get;
            if "Payment Type" = "payment type"::Bank then begin
                GenLedgerSetup.TestField(GenLedgerSetup."Payment Voucher Nos");
                NoSeriesMgt.GetNextNo(GenLedgerSetup."Payment Voucher Nos");
            end
            else
                if "Payment Type" = "payment type"::FOSA then begin
        ...
        UserTemplate.Reset;
        UserTemplate.SetRange(UserTemplate.UserIDS, UserId);
