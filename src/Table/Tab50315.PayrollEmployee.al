...
Table 50315 "Payroll Employee."
{
    ...
    fields
    {
        field(10; "No."; Code[20])
        {
            ...
            begin
                ...
                if HrEmployees.find('-') then begin
                    Firstname := HrEmployees."First Name";
                    Lastname := HrEmployees."Middle Name";
                    Surname := HrEmployees."Last Name";
                    "Employee Email" := HrEmployees."E-Mail";
                    ...
                    "Pays PAYE" := true;
                    "Pays NSSF" := true;
                    "Payment Mode" := "Payment Mode"::SACCO;
                end
            end;
        }
        ...
        field(95; "Payroll No"; Code[20])
        {
            ...
            begin
                if ObjCust.Get("Payroll No") then begin
                    ...
                    "PIN No" := ObjCust.Pin;
                    "Bank Name" := ObjCust.Name;
                    "Bank Account No" := ObjCust."FOSA Account No.";
        ...
        field(126; "Employer Pension %"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(127; "Employee Pension %"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(128; "Email Period"; Date)
        {
            TableRelation = "Payroll Calender."."Date Opened";
            trigger OnValidate()
            var
                payCal: Record "Payroll Calender.";
            begin
                payCal.Reset();
                payCal.SetRange("Date Opened", "Email Period");
                if payCal.Find('-') then begin
                    "Email Period Name" := payCal."Period Name";
                end;
            end;
        }
        field(129; "Email Period Name"; Code[50])
        {

        }
        field(130; "Value To Calculate"; Decimal)
        {
