...
table 50813 "Bank Acc. Recon Line FOSA"
{
    ...
    procedure FilterBankRecLinesByDate(BankAccReconciliation: Record "Bank Acc. Reconciliation FOSA"; Overwrite: Boolean)
    begin
    ...
    procedure FilterBankRecLines(BankAccReconciliation: Record "Bank Acc. Reconciliation FOSA"; Overwrite: Boolean)
    begin
        Rec.Reset();
    ...
    procedure FilterBankRecLines(BankAccReconciliation: Record "Bank Acc. Reconciliation FOSA")
    begin
        FilterBankRecLines(BankAccReconciliation, true);
    end;

    procedure LinesExist(BankAccRecon: Record "Bank Acc. Reconciliation FOSA"): Boolean
    begin
    ...
    local procedure OnAfterInitDefaultDimensionSources(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var DefaultDimSource: List of [Dictionary of [Integer, Code[20]]])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterSetUpNewLine(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; xBankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA");
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterShowDimensions(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterCreateDim(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; DefaultDimSource: List of [Dictionary of [Integer, Code[20]]])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterFilterBankRecLines(var Rec: Record "Bank Acc. Recon Line FOSA"; BankAccRecon: Record "Bank Acc. Reconciliation FOSA")
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterGetAppliedEntryAccountNo(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; AppliedToEntryNo: Integer; var AccountNo: Code[20])
    begin
    end;
    ...
    [IntegrationEvent(false, false)]
    local procedure OnAfterRemoveAppliedPaymentEntries(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterDrillDownOnNoOfLedgerEntriesBasedOnAmount(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; AmountFilter: Text)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnAfterValidateShortcutDimCode(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var xBankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; FieldNumber: Integer; var ShortcutDimCode: Code[20])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeOnModify(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var IsHandled: Boolean)
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnBeforeValidateShortcutDimCode(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var xBankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; FieldNumber: Integer; var ShortcutDimCode: Code[20])
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnDisplayApplicationOnAfterBankAccLedgEntrySetFilters(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var BankAccLedgEntry: Record "Bank Account Ledger Entry")
    begin
    end;
    ...
    local procedure OnDisplayApplicationOnAfterCheckLedgEntrySetFilters(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var CheckLedgEntry: Record "Check Ledger Entry")
    begin
    end;
#endif

    [IntegrationEvent(false, false)]
    local procedure OnRemoveApplicationOnAfterBankAccLedgEntrySetFilters(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var BankAccLedgEntry: Record "Bank Account Ledger Entry")
    begin
    end;
    ...
    local procedure OnRemoveApplicationOnAfterCheckLedgEntrySetFilters(var BankAccReconciliationLine: Record "Bank Acc. Recon Line FOSA"; var CheckLedgEntry: Record "Check Ledger Entry")
    begin
    end;
#endif
}
