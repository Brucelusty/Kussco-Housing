...
Table 50800 "Coop Dividends Header"
{
    ...
    fields
    {
        field(1; No; Code[20])
        {
            ...
            begin
                ...
                if No <> xRec.No then begin
                    NoSetup.Get();
                    NoSeriesMgt.TestManual(NoSetup."Coop Dividends");
                    "No. Series" := '';
                end;
            end;
        }
        ...
        field(23; "Account No"; Code[30])
        {
            ...
            if ("Account Type" = const(Customer)) Customer where("Checkoff Account" = const(true))
            else
        ...
        {
            CalcFormula = count("Checkoff Lines-Distributed-NT" where("Checkoff No" = field(No)));
        ...
        {
            CalcFormula = sum("Checkoff Lines-Distributed-NT".Amount where("Checkoff No" = field(No)));
            FieldClass = FlowField;
        }

        field(36; "Checkoff Type"; Option)
        {
            OptionMembers = Loans,Deposits,Shares,"FOSA Saving","BBF Fund";
            OptionCaption = 'Loans,Deposits,Shares,FOSA Saving,BBF Fund';
        }

        field(37; "Type"; Option)
        {
            OptionMembers = Member,Groups;
            OptionCaption = 'Member,Groups';
        }

        field(38; "Group Destination Account"; Code[60])
        {
    ...
    begin
        ...
        if No = '' then begin
            NoSetup.Get();
            NoSetup.TestField(NoSetup."Coop Dividends");
            NoSeriesMgt.GetNextNo(NoSetup."Coop Dividends");
        end;
