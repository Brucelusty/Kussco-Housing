...
Table 50743 "Bonus Header"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Bonus Lines".Amount where("Salary Header No." = field(No)));
            Editable = false;
            FieldClass = FlowField;
        }
        field(27; "Total Count"; Integer)
        {
            CalcFormula = count("Bonus Lines" where("Salary Header No." = field(No)));
            FieldClass = FlowField;
        }
        ...
        {
            OptionCaption = 'Normal Salary,Delayed Salary';
            OptionMembers = "Normal Salary","Delayed Salary";
            Caption = 'Salary Type';
            trigger OnValidate()
            begin
        ...
        {
            OptionMembers = ,,Milk,Tea,Bonus,Dividends,Pension,Salary;
            OptionCaption = ',,Milk,Tea,Bonus,Dividends,Pension,Salary';
