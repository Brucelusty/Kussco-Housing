...
Table 50181 "HR Employees"
{
    ...
    fields
    {
        ...
        field(2041; "Leave Code"; Code[20])
        {
            FieldClass = FlowFilter;
        }
        field(2042; "Leave Date"; Date)
        {
            FieldClass = FlowFilter;
        }
        field(2043; "Staff Leave Account"; Decimal)
        {
            CalcFormula = sum("HR Leave Ledger Entries"."No. of days" where("Leave Type" = field("Leave Code"),
                                                                             "Staff No." = field("No."),
                                                                             "Posting Date" = field("Leave Date")));
            FieldClass = FlowField;
        }
        ...
        field(3970; "Annual Leave Days"; Decimal)
        {
        }
        ...
        field(3989; "HR Manager"; Boolean)
        {

        }
        field(3990; "Staff Leave Type"; Code[20])
        {
            TableRelation = "HR Leave Types".Code;
            FieldClass = FlowFilter;
        }
        field(3991; "Staff Leave Days Taken"; Decimal)
        {
            CalcFormula = sum("HR Leave Ledger Entries"."No. of days" where("Leave Type" = field("Staff Leave Type"),
                                                                             "Staff No." = field("No.")));
            FieldClass = FlowField;
        }
        field(172002; "Bosa Member account"; Code[20])
        {
            TableRelation = "Members Register";
        }
        field(172003; "Sacco Paying Bank Code"; Code[20])
        {
        ...
        field(172004; "Sacco Paying Bank Name"; Text[30])
        {
        }
        field(172005; "Cheque No"; Code[20])
        {
        ...
        field(53950; "Responsibility Center name"; Text[2048])
        {

        }
        field(53951; "Supervisor ID"; Code[30])
        {
        }
        field(53952; "Portal Password"; Text[50])
        {
        }
        field(53953; "Changed Password"; Boolean)
        {
            InitValue = false;
        }
        field(53954; Travelaccountno; Code[60])
        {
            DataClassification = ToBeClassified;
            TableRelation = Customer."No.";
        }
        field(53955; "Contractual Gross Salary"; Decimal)
        {
        }
    }
...
/*             if "Contract Type" = "contract type"::Deployed then begin
               ...
               // if "Contract Type" = "contract type"::"Full Time" then begin
                   ...
                   "No." := NoSeriesMgt.GetNextNo(HrSetup."Employee Nos.");
               /*  end else
                    if "Contract Type" = "contract type"::Board then begin
                        HrSetup.TestField(HrSetup."Board Nos");
                        NoSeriesMgt.GetNextNo(HrSetup."Board Nos");
    ...
    begin
        if "Middle Name" = '' then
            exit("Known As" + ' ' + "First Name" + ' ' + "Last Name")
        // else
