...
/*             CalcFormula = sum("Cust. Ledger Entry"."Transaction Amount" where("Customer No." = field("No."),
        ...
        field(69297; "Reffered By Member No"; Code[100])
        {
            DataClassification = ToBeClassified;
        ...
        field(69298; "Reffered By Member Name"; Text[100])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }

        field(69299; "NHIF No"; Code[100])
        {
            DataClassification = ToBeClassified;
        ...
        field(69301; "Member Type"; Option)
        {
            OptionMembers = Member,Staff,Board;
            OptionCaption = 'Member,Staff,Board';

        }

        field(69302; "Exempted From Tax"; Boolean)
        {

        }

        field(69303; "How did you know about us?"; Text[1200])
        {

        }
        field(69304; "Sub-county"; Code[100])
        {

        }
        field(69305; "Area"; Code[100])
        {

        }
        field(69306; "Work E-Mail"; Code[100])
        {

        }

        field(69307; "Nearest Landmark"; Text[100])
        {

        }
        field(69308; "Loan Status"; Option)
        {
            OptionCaption = 'Performing,Defaulter';
            OptionMembers = Performing,Defaulter;
        }
        field(69309; "Loan Defaulter"; Boolean)
        {
        }
        field(69310; "No Of Defaulted Loans"; Integer)
        {
            CalcFormula = Count("Loans Register" WHERE("BOSA No" = FIELD("No."), "Loans Category" = FILTER(Substandard | Doubtful | Loss)));
            FieldClass = FlowField;
        }
        field(69311; "Principle Balance"; Decimal)
        {
            /*             FieldClass = FlowField;
