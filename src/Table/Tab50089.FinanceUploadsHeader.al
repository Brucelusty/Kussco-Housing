...
Table 50089 "Finance Uploads Header"
{
    ...
    fields
    {
        field(1; No; Code[20])
        {
            ...
            begin
                ...
                if No <> xRec.No then begin
                    NoSetup.Get();
                    NoSeriesMgt.TestManual(NoSetup."Finance UpLoads");
                    "No. Series" := '';
        ...
        field(36; "Account Balancing Type"; Option)
        {
            OptionCaption = 'LampSum Balancing,Detailed Balancing';
            OptionMembers = "LampSum Balancing","Detailed Balancing";
        ...
        field(39; "Debit Account Validated"; Boolean)
        {
            Editable = false;
        }
        field(40; "Upload Type"; Option)
        {
            OptionCaption = 'Normal Upload,Dividend & Interest';
            OptionMembers = "Normal Upload","Dividend & Interest";
        }
    }
    ...
    begin
        ...
        if No = '' then begin
            NoSetup.Get();
            NoSetup.TestField(NoSetup."Finance UpLoads");
            NoSeriesMgt.GetNextNo(NoSetup."Finance UpLoads");
        end;
    ...
    begin
        SUFFIX := 'SALARIES';
        if "Account Balancing Type" = "account balancing type"::"Detailed Balancing" then
            SUFFIX := 'NIS';
