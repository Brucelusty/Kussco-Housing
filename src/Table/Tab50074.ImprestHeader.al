...
Table 50074 "Imprest Header"
{
    ...
    fields
    {
        ...
        field(28; "Paying Bank Account"; Code[20])
        {
            ...
            if ("Paying Account Type" = filter("FOSA Account")) Vendor."No.";
        ...
        field(172000; Requisition; Code[20])
        {
            TableRelation = "Purchase Header"."No.";
        }
        field(172001; "Paying Account Type"; Option)
        {
            OptionCaption = 'FOSA Account,Bank Account';
            OptionMembers = "FOSA Account","Bank Account";
        }
        field(172003; "Pending Imprest Amount"; Decimal)
        {
    ...
    begin
        if "No." = '' then begin
            ...
            if "Payment Type" = "payment type"::Imprest then begin
                ...
                NoSeriesMgt.GetNextNo(GenLedgerSetup."Imprest Nos");
            end
        end;
