...
Table 50803 "Recruitment Lines"
{
    ...
    fields
    {
        ...
        field(19; "Already Posted"; Boolean)
        {
        }
        field(20; "SMS Received"; Boolean)
        {
        }
        ...
        {
            TableRelation = "Recruitment Commission Header".No where(No = field("Salary Header No."));
        }
        ...
        field(62007; "Mobile Phone Number"; Code[35])
        {
        ...
        field(62009; "Member No"; Code[20])
        {
        }
        field(62010; Region; Code[50])
        {
        }
        field(620011; Grade; Code[50])
        { }
        field(62012; "Expected Amount"; decimal)
        {
            Editable = false;
        }
        field(62013; "Amount Deducted"; decimal)
        {
            Editable = false;
        }
        field(62014; "Person Recruited"; code[60])
        {
            Editable = false;
        }
        field(62015; "Recruited Name"; Text[250])
        {
            Editable = false;
        }
    }
    ...
    keys
    {
        key(Key1; "Staff No.", "Document No.", "Salary Header No.")
        {
            Clustered = true;
        }
    ...
    var
        ...
        SalBuffer: Record "Recruitment Lines";
}
