...
Table 50333 "prPeriod Transactions."
{
    fields
    {
        ...
        field(16; "Department Code"; Code[40])
        {
        }
        field(17; Lumpsumitems; Boolean)
        {
        }
        field(18; TravelAllowance; Code[40])
        {
        }
        field(19; "GL Account"; Code[40])
        {
        ...
        field(23; "Journal Account Code"; Code[40])
        {
        }
        ...
        field(27; "coop parameters"; Option)
        {
            ...
            OptionMembers = "none",shares,loan,"loan Interest","Emergency loan","Emergency loan Interest","School Fees loan","School Fees loan Interest",Welfare,Pension,NSSF,Overtime,DevShare,NHIF,Holiday,SHIF;
        }
        field(28; "Payroll Code"; Code[40])
        {
        ...
        field(32; "Is Contribution"; Boolean)
        {
        }
    }
