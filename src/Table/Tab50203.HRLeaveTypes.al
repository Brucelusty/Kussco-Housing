...
Table 50203 "HR Leave Types"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Ignore,Carry Forward,Convert to Cash,Carry Forward Per Employee';
            OptionMembers = Ignore,"Carry Forward","Convert to Cash","Carry Forward Per Employee";
        }
