...
Table 50316 "Payroll Transaction Code."
{
    //nownPage51516323;
    //nownPage51516323;
    ...
    fields
    {
        ...
        {
            OptionCaption = 'None,Shares,Loan,Loan Interest,Emergency Loan,Emergency Loan Interest,School Fees Loan,School Fees Loan Interest,Welfare,Pension,NSSF,Overtime,Holiday,ESS,Benevolent';
            OptionMembers = "None",Shares,Loan,"Loan Interest","Emergency Loan","Emergency Loan Interest","School Fees Loan","School Fees Loan Interest",Welfare,Pension,NSSF,Overtime,Holiday,ESS,Benevolent;
        }
        ...
        field(53; "is Housing Levy"; boolean)
        {
        }
        field(54; "Housing Levy%"; Decimal)
        {
        }
        field(55; "Is Pension"; Boolean)
        {
        }
        field(56; "Is Contribution"; Boolean)
        {
        }
    }
