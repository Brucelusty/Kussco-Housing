...
Table 50394 "Sacco General Set-Up"
{
    ...
    fields
    {
        ...
        field(1500; "Savings Bal Account"; code[20])
        {
            TableRelation = "G/L Account";
        }
        ...
        field(255; "IOD Account"; Code[10])
        {
            DataClassification = ToBeClassified;
            TableRelation = "G/L Account"."No.";
        }
        field(256; "BOSA RegistrationFee (%)"; Decimal)
        {
        }
        field(257; "External Loan Account"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(258; "External Loan Comm (%)"; Decimal)
        {
        }
        field(259; "Penalties on Loans"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(260; "Salary Processing Fee Acc"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(261; "Salary Processing Fee"; Decimal)
        {

        }
        field(262; "Interest Expense on Fixed Deposit"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(263; "Withdrawal Before Maturity Charges"; Decimal)
        {



        }
        field(264; "Withdrawal Before Maturity Charges Account"; Code[15])
        {

            TableRelation = "G/L Account"."No.";

        }
        field(265; "Mobile charges(Third Party) on transaction"; Code[15])
        {
        ...
        field(267; "MPESA Commission Account"; Code[25])
        {
        ...
        field(268; "Loan Excise Duty(%)"; Decimal)
        {

            //TableRelation = "G/L Account"."No."; 

        }
        field(269; "Maximum Withdrawal Limit M"; Integer)
        {

            //TableRelation = "G/L Account"."No."; 

        }
        field(270; "Maximum Withdrawal Amount M"; Decimal)
        {

            //TableRelation = "G/L Account"."No."; 

        }
        field(271; "Cheque Deposit Fee"; Decimal)
        {



        }
        field(272; "Cheque Deposit Fee Account"; Code[20])
        {
            TableRelation = "G/L Account"."No.";


        }
        field(273; "RTGSEFT Fee"; Decimal)
        {



        }
        field(274; "RTGSEFT Fee Account"; Code[20])
        {
            TableRelation = "G/L Account"."No.";


        }
        field(275; "Express Charge Account"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(276; "Express Charge %"; Decimal)
        {
        }
        field(277; "Suspense Account"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }

        field(278; "Delayed Net Account"; Code[40])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(279; "Membership Class Tier"; Option)
        {
            OptionCaption = ' ,Class A, Class B, Class C, Class D, Class FA, Class FB, Class FC';
            OptionMembers = " ","Class A","Class B","Class C","Class D","Class FA","Class FB","Class FC";
        }
        field(280; "Min Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(281; "Max Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(282; RegistrationFee; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(283; MonthlyContributions; Decimal)
        {
            Caption = 'Monthly Contributions';
        }

        field(284; ShareCapital; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(285; BenevolentFund; Decimal)
        {
            caption = 'BBF';
        }
        field(286; "Minimum Class B Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(287; "Maximum Class B Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(288; "Class B RegistrationFee"; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(289; "Class B MonthlyContributions"; Decimal)
        {
            Caption = 'Monthly Contributions';
        }

        field(290; "Class B ShareCapital"; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(291; "Class B BenevolentFund"; Decimal)
        {
            caption = 'BBF';
        }
        field(292; "Minimum Class C Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(293; "Maximum Class C Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(294; "Class C RegistrationFee"; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(295; "Class C MonthlyContributions"; Decimal)
        {
            Caption = 'Monthly Contributions';
        }

        field(296; "Class C ShareCapital"; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(297; "Class C BenevolentFund"; Decimal)
        {
            caption = 'BBF';
        }
        field(298; "Minimum Class D Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(299; "Maximum Class D Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(300; "Class D RegistrationFee"; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(301; "Class D MonthlyContributions"; Decimal)
        {
            Caption = 'Monthly Contributions';
        }

        field(302; "Class D ShareCapital"; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(303; "Class D BenevolentFund"; Decimal)
        {
            caption = 'BBF';
        }
        field(304; "Minimum Class FA Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(305; "Maximum Class FA Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(306; "Class FA RegistrationFee"; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(307; "Class FA MonthlyContributions"; Decimal)
        {
            Caption = 'Monthly Contributions';
        }

        field(308; "Class FA ShareCapital"; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(309; "Class FA BenevolentFund"; Decimal)
        {
            caption = 'BBF';
        }
        field(310; "Closure Notice Period"; DateFormula)
        {
            caption = 'Closure Notice Period';
        }
        field(311; "UFAA Duration"; DateFormula)
        {
        }
        //New from .71
        field(312; "Express Loan Charge"; Decimal)
        {
        }
        field(313; "Overdraft App Nos."; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(314; "Boosting Commission Account"; Code[20])
        {
            TableRelation = "G/L Account";
        }

        field(315; "SMS Sender ID"; Text[200])
        {
            //  TableRelation = "G/L Account";
        }

        field(316; "SMS Sender Name"; Text[150])
        {
            //  TableRelation = "G/L Account";
        }

        field(317; "Balance Enquiry Charge"; Decimal)
        {
            caption = 'Balance Enquiry';
        }
        field(318; "Balance Enquiry Charge Account"; Code[15])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(319; "Loan Shares Deduction Amount"; Decimal)
        {

        }
        field(320; "MSG Product ID"; Integer)
        {

        }
        field(321; "Vendor Enquiry Charge"; Decimal)
        {

        }
        field(322; "Vendor G/L"; Code[40])
        {
            TableRelation = Vendor."No.";
        }
        field(323; "Ministatement Charge"; Decimal)
        {

        }
        field(324; "Vendor MiniStatement Charge"; Decimal)
        {

        }
        field(325; "Co-Op PaytoFOSA"; Code[30])
        {

        }
        field(326; "Min. Piggy Bank Bal"; Decimal)
        {

        }
        field(327; "ESS Refund Notice Maturity"; DateFormula)
        {

        }
        field(328; "ESS Refund Notice-Early"; DateFormula)
        {

        }
        field(329; "ESS Refund-Early Charges"; Decimal)
        {

        }
        field(330; "ESS Refund-Early Charges A/C"; Code[20])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(331; "Min FD to Earn Interest"; Decimal)
        {

        }
        field(332; "FD Interest A/C"; Code[30])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(333; "Min Call Days to Earn Interest"; DateFormula)
        {

        }

        field(334; "Int Calc Intervals"; DateFormula)
        {

        }
        field(335; "Interest on FOSA A/C"; Code[20])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(336; "KTDA Bank Code"; Code[20])
        {
        }
        field(337; "Reg Fee Paybill Code"; Code[20])
        {
        }
        field(338; "Bulk Payment Paybill Code"; Code[20])
        {
        }
        field(339; "Special Advance Commission"; Decimal)
        {
        }
        field(340; "Commission G/L"; Code[20])
        {
            TableRelation = "G/L Account"."No.";
        }
        field(343; "Ess Interest%"; Decimal)
        {

        }
        field(344; "Withholding Tax on Dividends"; Decimal)
        {

        }
        field(345; "Withholding Tax on Deposits"; Decimal)
        {

        }
        field(346; "Minimum Class FB Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(347; "Maximum Class FB Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(348; "Class FB RegistrationFee"; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(349; "Class FB MonthlyContributions"; Decimal)
        {
            Caption = 'Monthly Contributions';
        }
        field(350; "Class FB ShareCapital"; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(351; "Class FB BenevolentFund"; Decimal)
        {
            caption = 'BBF';
        }
        field(352; "Minimum Class FC Salary Range"; Decimal)
        {
            caption = 'Min. Salary Range';
        }
        field(353; "Maximum Class FC Salary Range"; Decimal)
        {
            caption = 'Max. Salary Range';
        }
        field(354; "Class FC RegistrationFee"; Decimal)
        {
            Caption = 'Registration Fee';
        }
        field(355; "Class FC MonthlyContributions"; Decimal)
        {
            Caption = 'Monthly Contributions';
        }
        field(356; "Class FC ShareCapital"; Decimal)
        {
            Caption = 'Share Capital';
        }
        field(357; "Class FC BenevolentFund"; Decimal)
        {
            caption = 'BBF';
        }
        field(358; "Cooperate Acc Registration Fee"; Decimal)
        {
            caption = 'Cooperate Acc Registration Fee';
        }
        field(359; "Junior Acc Registration Fee"; Decimal)
        {
            caption = 'Junior Acc Registration Fee';
        }
                field(360; "Min Cooperate Share Capital"; Decimal)
        {
            caption = 'Min Cooperate Share Capital';
        }
