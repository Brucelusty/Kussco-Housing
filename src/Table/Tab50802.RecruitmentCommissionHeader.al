...
Table 50802 "Recruitment Commission Header"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = sum("Recruitment Lines".Amount where("Salary Header No." = field(No), "Already Posted" = filter(false)));
            Editable = false;
            FieldClass = FlowField;
        }
        field(27; "Total Count"; Integer)
        {
            CalcFormula = count("Recruitment Lines" where("Salary Header No." = field(No), "Already Posted" = filter(false)));
            FieldClass = FlowField;
        }
