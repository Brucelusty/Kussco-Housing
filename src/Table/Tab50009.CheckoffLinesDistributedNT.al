...
Table 50009 "Checkoff Lines-Distributed-NT"

{
    ...
    fields
    {
        ...
        field(76; "Utafiti Housing"; Decimal)
        {
            DataClassification = ToBeClassified;
        }
        field(77; "Loan Product"; Code[60])
        {
            DataClassification = ToBeClassified;
        }
        field(78; "Amount"; Decimal)
        {
            DataClassification = ToBeClassified;
        }

        field(79; "Entry No"; integer)
        {
            DataClassification = ToBeClassified;
        }

        field(80; "Source Account No"; code[60])
        {
            DataClassification = ToBeClassified;
        }
        field(81; "Source Account Name"; Text[250])
        {
            DataClassification = ToBeClassified;
        }

        field(82; "FOSA Account"; CODE[60])
        {
            DataClassification = ToBeClassified;
        }
