...
Table 50099 "Funds User Setup"
{

    fields
    {
        field(10; UserIDS; Code[50])
        {
            NotBlank = true;

            trigger OnLookup()
            begin
                UserManager.LookupUserID(UserIDS);
            end;

            trigger OnValidate()
            begin
                UserManager.ValidateUserID(UserIDS);
            end;
        ...
        field(12; "Receipt Journal Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat
                        if (UserTemp.UserIDS <> UserID) and ("Receipt Journal Batch" <> '') then begin
        ...
        field(14; "Payment Journal Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat
                        if (UserTemp.UserIDS <> Rec.UserIDS) and ("Payment Journal Batch" <> '') then begin
        ...
        field(16; "Petty Cash Batch"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat
                        if (UserTemp.UserIDS <> Rec.UserIDS) and ("Petty Cash Batch" <> '') then begin
        ...
        field(18; "FundsTransfer Batch Name"; Code[20])
        {
            ...
            begin
                ...
                if UserTemp.FindFirst then begin
                    repeat
                        if (UserTemp.UserIDS <> Rec.UserIDS) and ("FundsTransfer Batch Name" <> '') then begin
                            Error(SameBatch, "Receipt Journal Batch", "Petty Cash Batch");
                        end;
                    until UserTemp.Next = 0;
                end;
