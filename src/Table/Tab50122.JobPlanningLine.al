...
Table 50122 "Job-Planning Line"
{
    ...
    fields
    {
        ...
        field(172002; "Income Account"; Code[20])
        {
            TableRelation = if (Type = const(Resource)) Resource else
            if (Type = const(Item)) Item else
        ...
        field(172003; "Description 3"; Text[50])
        {
        }
        field(172004; "Audit Provision"; Code[30])
        {
            // TableRelation = "Audit provision";
        }
        field(172005; "Special Condition for Travel"; Code[30])
        {
            // TableRelation = "Special Conditions for Travel";
        }
        field(172006; "Pending donor Issues"; Code[10])
        {
            // TableRelation = "Pending Donor Issues";
        }
        field(172007; "Disbursment Due dates"; Date)
        {
        }
        field(172008; Partner; Code[20])
        {
            // TableRelation = "Project Partners".PartnerID where("Grant No" = field("Grant No."));
        }
        field(172009; "Budget Period"; Code[10])
        {
            // TableRelation = "Grant Phases";
        }
        field(172010; "Total Year 1"; Decimal)
        {
        ...
        field(172011; "Total Year 2"; Decimal)
        {
        ...
        field(172012; "Total Year 3"; Decimal)
        {
        ...
        field(172013; "Transfered To Budget"; Boolean)
        {
        }
        field(172014; "Budget Grouping Code"; Code[30])
        {
            //   TableRelation = "Budget Grouping Codes";
        }
        field(172015; "ICIPE Contribution"; Decimal)
        {
        }
        field(172017; "Unaccounted Amount"; Decimal)
        {
        }
        field(172018; "Disbursed Amount"; Decimal)
        {
        ...
        field(172021; "Total Year 4"; Decimal)
        {
        ...
        field(172022; "Total Year 5"; Decimal)
        {
        ...
        field(172023; "Total Year 6"; Decimal)
        {
        ...
        field(172024; "Budget in use"; Boolean)
        {
        }
    }
