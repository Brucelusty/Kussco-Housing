...
Table 50306 "prPeriod Transactions Summary"
{
    //nownPage51516328;
    //nownPage51516328;
    ...
    fields
    {
        ...
        field(30; "Fosa Account No."; Code[20])
        {
        }
    ...
    keys
    {
        key(Key1; "Document Code", "Transaction Code", "Period Month", "Period Year", Membership, "Reference No", "Loan Number")
        {
            Clustered = true;
            SumIndexFields = Amount;
        }
        key(Key2; "Document Code", "Period Month", "Period Year", "Group Order", "Sub Group Order", Membership, "Reference No")
        {
            SumIndexFields = Amount;
        }
        ...
        key(Key7; "Document Code", "Department Code")
        {
            SumIndexFields = Amount;
        }
    }
