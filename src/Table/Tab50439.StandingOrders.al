...
Table 50439 "Standing Orders"
{
    DrillDownPageId = "Standing Orders - List Approve";
    LookupPageId = "Standing Orders - List Approve";
    ...
    fields
    {
        ...
        {
            TableRelation = if ("Destination Account Type" = const("Member Account")) Customer."No." where(ISNormalMember = const(true))
            else
        ...
        field(8; "BOSA Account No."; Code[20])
        {
            ...
            begin
                ...
                if cust.FindFirst() then begin
                    "Source Account No." := Cust."FOSA Account No.";
        ...
        field(33; "Link PaytoFOSA"; Boolean)
        {
        }
        field(34; "Portal Income Type"; Code[20])
        {
        }
        field(172000; "Company Code"; Code[30])
        {
            CalcFormula = lookup(Vendor."Employer Code" where("No." = field("Source Account No.")));
            FieldClass = FlowField;
        }
        field(172001; "Posted By"; Code[50])
        {
            TableRelation = "User Setup"."User ID";
        }
        field(172002; "Standing Order Dedution Type"; Option)
        {
        ...
        field(172003; "Is Active"; Boolean)
        {
        }
        field(172004; "No of Tolerance Days"; DateFormula)
        {
        }
        field(172005; "End of Tolerance Date"; Date)
        {
        }
        field(172006; "Next Attempt Date"; Date)
        {
        }
        field(172007; "Execute Condition"; Option)
        {
        ...
        field(172008; "Source Account Narrations"; Text[100])
        {
        }
        field(172009; "Destination Account Narrations"; Text[100])
        {
        }
        field(172010; "Last Execution Date"; Date)
        {
        }
        field(172011; "Created On"; DateTime)
        {
        }
        field(172012; "Created By"; Code[30])
        {
        }
        field(172013; "Modified On"; DateTime)
        {
        }
        field(172014; "Modified By"; Code[30])
        {
        }
        field(172015; "Stopped By"; Code[50])
        {
        }
        field(172016; "Stopped On"; DateTime)
        {
        }
        field(172017; "Source Application"; Option)
        {
            OptionCaption = 'Internet Banking,Mobile APP';
            OptionMembers = "Internet Banking","Mobile APP";
        }
        field(172018; "Source Account Type"; Option)
        {
            ...
            InitValue = "Member Standing Order";
            Editable = false;
        }
        field(172019; "Source Global Dimension 1 Code"; Code[50])
        {
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(1),
                                                          "Dimension Value Type" = const(Standard));
        }
        field(172020; "Source Global Dimension 2 Code"; Code[50])
        {
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(2),
                                                          "Dimension Value Type" = const(Standard));
        }
        field(172021; "Dest. Global Dimension 1 Code"; Code[50])
        {
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(1),
                                                          "Dimension Value Type" = const(Standard));
        }
        field(172022; "Dest. Global Dimension 2 Code"; Code[50])
        {
            TableRelation = "Dimension Value".Code where("Global Dimension No." = const(2),
                                                          "Dimension Value Type" = const(Standard));
        }
    ...
    begin
        if "No." = '' then begin
            ...
            NoSeriesMgt.GetNextNo(NoSetup."Standing Orders Nos.");
        end;
