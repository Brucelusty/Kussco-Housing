...
Table 50707 "Bank Acc. Reconciliation Lines"
{
    ...
    fields
    {
        ...
        {
            Caption = 'Account No.';
            TableRelation = if ("Account Type" = const("G/L Account")) "G/L Account" where("Account Type" = const(Posting), Blocked = const(false)) else
        ...
        field(172000; Reconcilled; Boolean)
        {
        }
        ...
        field(172005; Imported; Boolean)
        {
        }
        field(172006; "Bank Statement Entry Line No"; Integer)
        {
        }
        field(172007; "Bank Ledger Entry Line No"; Integer)
        {
        }
        field(172008; "Posting Exch. Entry No."; Integer)
        {
        }
    }
    ...
    var
    //TODO
    // PaymentApplication: Page UnknownPage173009;
    begin
        case "Statement Type" of
            ...
            "statement type"::"Payment Application":
                begin
                    ...
                    // PaymentApplication.SetBankAccReconcLine(Rec); TODO
