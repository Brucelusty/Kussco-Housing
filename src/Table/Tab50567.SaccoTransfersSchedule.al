...
Table 50567 "Sacco Transfers Schedule"
{
    ...
    fields
    {
        ...
        field(2; "Destination Account No."; Code[20])
        {
            ...
            if ("Destination Account Type" = const(CUSTOMER)) Customer."No." where(ISNormalMember = const(false))
            else
            if ("Destination Account Type" = const(MEMBER)) Customer."No." where(ISNormalMember = const(TRUE));
        ...
        {
            OptionCaption = 'VENDOR,BANK,G/L ACCOUNT,MEMBER,CUSTOMER';
            OptionMembers = VENDOR,BANK,"G/L ACCOUNT",MEMBER,CUSTOMER;
        ...
        field(6; "Destination Loan"; Code[30])
        {
            ...
            if ("Destination Account Type" = filter(Customer)) "Loans Register"."Loan  No." where("Client Code" = field("Destination Account No."));
        }
