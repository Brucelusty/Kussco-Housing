...
Table 50641 "CRM Trainings"
{
    ...
    fields
    {
        ...
        field(33; "Training Scope"; Text[200])
        {
        }
        field(34; "Total Attendees"; Integer)
        {
            CalcFormula = count("CRM Traineees" where("Training Code" = field(Code)));
            FieldClass = FlowField;
        }
    }
    ...
    begin
        if Code = '' then begin
            ...
            NoSeriesMgt.GetNextNo(SalesSetup."BD Training Nos");
        end;
