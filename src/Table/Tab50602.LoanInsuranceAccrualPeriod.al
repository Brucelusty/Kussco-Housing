...
Table 50602 "Loan Insurance Accrual Period"
{
    ...
    fields
    {
        ...
        field(172000; "Closed by User"; Code[20])
        {
        }
        field(172001; "Closing Date Time"; DateTime)
        {
        }
        field(172002; "Posting Document No."; Code[20])
        {
        }
        field(172003; "Insurance Calcuation Date"; Date)
        {
