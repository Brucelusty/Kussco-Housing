...
Table 50143 "Guarantorship Substitution H"
{
    // //nownPage51516871;
    ...
    fields
    {
                ...
                if LoanGuarantors.FindSet then begin
                    repeat
                        ...
                        if LoansRec.Get("Loan Guaranteed") then begin
                            ...
                            "Loan Type" := LoansRec."Loan Product Type Name";
        ...
        {
            OptionCaption = 'Open,Pending,Approved,Rejected,Cancelled';
            OptionMembers = Open,Pending,Approved,Rejected,Cancelled;
        }
        field(9; "Created By"; Code[50])
        {
        }
        field(10; "Substituted By"; Code[60])
        {
        }
        ...
        field(14; "Loan Type"; Text[100])
        {
        }
        field(15; "Amount Guaranteed"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("Guarantorship Substitution L"."Amount Guaranteed" where("Document No" = field("Document No"), "Member No" = field("Substituting Member")));
        }
        field(16; "Loanee Remarks"; Text[2048])
        {
        }
    }
    ...
    begin
        if "Document No" = '' then begin
            ...
            NoSeriesMgt.GetNextNo(SalesSetup."Guarantor Sub No.");
        end;
