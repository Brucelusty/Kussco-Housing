...
Table 50112 "Jobs"
{
    ...
    fields
    {
        ...
        field(172000; "Grant Phases"; Code[10])
        {
        }
        field(172001; "Approval Status"; Option)
        {
            Editable = true;
            OptionCaption = 'Open,Pending Approval,Approved';
            OptionMembers = Open,"Pending Approval",Approved;
        }
        field(172002; "Responsibility Center"; Code[10])
        {
            TableRelation = "Responsibility Center BR";
        }
        field(172003; "Total Cost"; Decimal)
        {
            CalcFormula = sum("Job-Planning Line"."Total Cost" where("Grant No." = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(172004; "Total Cost(LCY)"; Decimal)
        {
            CalcFormula = sum("Job-Planning Line"."Total Cost (LCY)" where("Grant No." = field("No.")));
            Editable = false;
            FieldClass = FlowField;
        }
        field(172005; "Contract Description"; Text[150])
        {
        }
        field(172006; "Contract Type"; Code[10])
        {
            TableRelation = "Responsibility Center";
        }
        field(172007; "Disbursed Amount"; Decimal)
        {
            CalcFormula = sum("Payment Line.".Amount where("Shortcut Dimension 2 Code" = field("No.")));
            FieldClass = FlowField;
        }
        field(172008; "Allow OverExpenditure"; Boolean)
        {
        }
        field(172009; "Accounted Amount"; Decimal)
        {
            Editable = false;
            FieldClass = FlowField;
        }
        field(172010; "Received Amount"; Decimal)
        {
            FieldClass = FlowField;
        }
        field(172011; "Proposal No"; Code[20])
        {
            Editable = false;
            TableRelation = Jobs."No." where("No." = field("Proposal No"),
                                              Status = const(Proposal));
        }
        field(172012; "Converted To Proposal"; Boolean)
        {
            Editable = false;
        }
        field(172013; "Project No"; Code[20])
        {
            Editable = true;
            TableRelation = Jobs."No." where("No." = field("Project No"),
                                              Status = const(Contract));
        }
        field(172014; "Converted To Project"; Boolean)
        {
            Editable = true;
        }
        field(172015; "Concept Number"; Code[20])
        {
        }
        field(172016; Objective; Text[150])
        {
        }
        field(172017; "Contract No"; Code[20])
        {
        }
        field(172018; "Reporting dates generated"; Boolean)
        {
            Editable = false;
            FieldClass = FlowField;
        }
        field(172019; "Condition for budget realloca"; Code[10])
        {
        }
        field(172020; "Principal Investigator"; Text[100])
        {
            TableRelation = Resource;
        ...
        field(172021; "Expected Receipt Amount"; Decimal)
        {
            FieldClass = FlowField;
        }
        field(172022; Partners; Boolean)
        {
            Caption = 'Collaborative Grants';
            Editable = false;
            FieldClass = FlowField;
        }
        field(172023; "Project Location"; Text[70])
        {
        }
        field(172024; "Income Account"; Code[10])
        {
        }
        field(172025; "Concept Approval Date"; DateTime)
        {
            Editable = false;
        }
        field(172026; "Project Filter"; Code[10])
        {
            FieldClass = Normal;
        }
        field(172027; Title; Text[30])
        {
        }
        field(172028; "Project Coordinator"; Text[100])
        {
            TableRelation = Resource;
        }
        field(172029; Task; Option)
        {
            OptionCaption = ' ,Research,Service';
            OptionMembers = " ",Research,Service;
        }
        field(172030; "Project Status"; Option)
        {
            OptionCaption = 'Setup,In Progress,Halted,Completed';
            OptionMembers = Setup,"In Progress",Halted,Completed;
        }
        field(172031; "Audit Indicator"; Boolean)
        {
        }
        field(172032; "Approved Funding Start Date"; Date)
        {
        }
        field(172033; "Approved Funding End Date"; Date)
        {
        }
        field(172034; "Justification Narration"; Text[200])
        {
            Description = 'Narrations defined esp. when modifying  the project/contract info';
        }
        field(172035; "Amount Invoiced"; Decimal)
        {
            FieldClass = FlowField;
        }
        field(172036; "Grant Level"; Option)
        {
            OptionCaption = 'Grant,Sub-Grant';
            OptionMembers = Grant,"Sub-Grant";
        }
        field(172037; "RSPO No."; Code[30])
        {
        }
        field(172038; "Alert sent"; Boolean)
        {
        }
        field(172039; "Proposal Application due Date"; Date)
        {
        }
        field(172040; Submission; Option)
        {
            OptionCaption = ' ,Paper Submission,Electronic Submission';
            OptionMembers = " ","Paper Submission","Electronic Submission";
        }
        field(172041; "PI Name"; Text[100])
        {
        ...
        field(172042; "PI Address"; Text[30])
        {
        }
        field(172043; "PI Telephone"; Text[30])
        {
        }
        field(172044; "PI EMail"; Text[30])
        {
            ExtendedDatatype = EMail;
        }
        field(172045; "Collaborative Grant"; Boolean)
        {
        }
        field(172046; "IREC Approval"; Option)
        {
            OptionCaption = 'Pending Approval,Approved,Exempt';
            OptionMembers = "Pending Approval",Approved,Exempt;
        }
        field(172047; "IREC Approval Date"; Date)
        {
        }
        field(172048; "Cost Share"; Boolean)
        {
        }
        field(172049; "Cost Share Details"; Text[100])
        {
        }
        field(172050; Matching; Boolean)
        {
        }
        field(172051; "Matching Details"; Text[150])
        {
        }
        field(172052; "Application disposition Status"; Option)
        {
        ...
        field(172053; "SubAward No."; Code[20])
        {
            Description = 'Project Sub award';
        }
        field(172054; "Payment Methods"; Code[20])
        {
            TableRelation = "Payment Method".Code;
        }
        field(172055; Schools; Code[10])
        {
            Caption = 'Kind of Program';
        }
        field(172056; "Application Due Date"; Date)
        {
        }
        field(172057; "Funding Request"; Boolean)
        {
        }
        field(172058; Budget; Boolean)
        {
        }
        field(172059; "Budget Justification"; Boolean)
        {
        }
        field(172060; "Project Summary Abstract"; Boolean)
        {
        }
        field(172061; "RSPO Completion List"; Boolean)
        {
        }
        field(172062; Donors; Boolean)
        {
            FieldClass = FlowField;
        }
        field(172063; Workplan; Boolean)
        {
            FieldClass = FlowField;
        }
        field(172064; "Period of Performance"; Option)
        {
        ...
        field(172065; "Principal Investigator name"; Text[100])
        {
        }
        field(172066; "Response To fund Opportunity"; Boolean)
        {
        }
        field(172067; "Main Donor"; Code[50])
        {
            TableRelation = Customer."No." where("Account Type" = filter(Donor));
        }
        field(172068; "Main Sub"; Code[50])
        {
            // TableRelation = Vendor."No." where (Tes=filter(1));
        }
        field(172069; "Special Contract Provision"; Text[250])
        {
        }
        field(172070; "Funding Agency No."; Code[20])
        {
        }
        field(172071; "Type Of Funding"; Option)
        {
        ...
        field(172072; "Responsible Officer"; Code[50])
        {
            //   TableRelation = Table55543.Field1 where (Field53918=const(Yes));
        }
        field(172073; "RFA/A Receipt Date"; Date)
        {
        }
        field(172074; "Project Team"; Code[20])
        {
            TableRelation = "Resource Group"."No.";
        }
        field(172075; Institution; Option)
        {
            OptionCaption = ' ,MTRH,MU,OTHERS';
            OptionMembers = " ",MTRH,MU,OTHERS;
        }
        field(172076; "Moi/MTRH Collaborator"; Boolean)
        {
            Caption = 'Do you have a previous Collaboration with Moi/MTRH ?';
        }
        field(172077; "AMPATH Affiliation Consortium"; Boolean)
        {
        }
        field(172078; "Previous MU Consortium School?"; Boolean)
        {
        }
        field(172079; "Which MU Consortium School"; Text[50])
        {
        }
        field(172080; "ASANTE Collaborator?"; Boolean)
        {
        }
        field(172081; "ASANTE Collaborator Details"; Text[50])
        {
        }
        field(172082; "Assist identifying Collabotor?"; Boolean)
        {
        }
        field(172083; "Study Type"; Option)
        {
        ...
        field(172084; "Study Type Details"; Text[50])
        {
        }
        field(172085; "Brief Description of Study"; Text[20])
        {
        }
        field(172086; "Study Funded"; Boolean)
        {
        }
        field(172087; "Funding Source/Funding Sought"; Text[50])
        {
        }
        field(172088; "Application Deadline"; Date)
        {
        }
        field(172089; "Lab Services"; Boolean)
        {
        ...
        field(172090; "AMPATH Data Mgt Core Required"; Boolean)
        {
        }
        field(172091; "Contracted To"; Text[150])
        {
            Description = 'Added:'' for capturing details of subs in commas form  -came up during data import';
        }
        field(172092; "Biostats Core Required"; Boolean)
        {
        }
        field(172093; "Prime Institution"; Code[50])
        {
            Description = 'Added:'' for capturing details prime institution -came up during data import';
        }
        field(172094; "Workgroup Recomendation"; Option)
        {
        ...
        field(172095; "Recomendation Description"; Text[50])
        {
        }
        field(172096; "Approved Budget Start Date"; Date)
        {
        }
        field(172097; "Approved Budget End Date"; Date)
        {
        }
        field(172098; "Financial Reporting Due Date"; DateFormula)
        {
        }
        field(172099; "Technical  Reporting Due Date"; DateFormula)
        {
        }
        field(172100; "Obligated Amount"; Decimal)
        {
        ...
        field(172101; "Re:"; Text[100])
        {
        }
        field(172102; "System Contract No"; Code[20])
        {
        }
        field(172103; "Converted To Contract"; Boolean)
        {
        }
        field(172104; "Indirect Cost"; Boolean)
        {
        }
        field(172105; "Allowed Indirect Cost"; Decimal)
        {
        }
        field(172106; "Consistence with inst. Objs."; Boolean)
        {
        }
    }
    ...
    begin
        if "No." = '' then begin
            ...
            NoSeriesMgt.GetNextNo(JobSetup."Concept Nos");
        end;
...
/*             if NoSeriesMgt.SelectCurrentNoSeriesLine(JobSetup."Job Nos.", OldJob."No. Series", "No. Series") then begin
                JobSetup.Get;
                JobSetup.TestField("Job Nos.");
        ...
        */
        ...
        if Status = Status::"Concept Formulation" then begin
            ...
            if "Proposal No" = '' then begin
                ...
                NoSeriesMgt.GetNextNo(JobSetup."Proposal Nos");
            end;
            //+++++++++++++++++++++++++++++++++++++++++++++++++++
            Job.Init;
            ...
            */
            ...
            if Status = Status::Proposal then begin
                ...
                if "System Contract No" = '' then begin
                    ...
                    NoSeriesMgt.GetNextNo(JobSetup."System Contract Nos");
                end;
                //+++++++++++++++++++++++++++++++++++++++++++++++++++
                ...
                if Status = Status::Contract then begin
                    ...
                    if "Project No" = '' then begin
                        ...
                        NoSeriesMgt.GetNextNo(JobSetup."Job Nos.");
                    end;
                    //+++++++++++++++++++++++++++++++++++++++++++++++++++
