    ...
    fields
    {
        ...
        field(23; "VAT Code"; Code[20])
        {
            ...
            begin
                ...
                ObjFundsTaxCodes.SetRange(ObjFundsTaxCodes.Code, Rec."VAT Code");
                if ObjFundsTaxCodes.Find('-') then begin
                    Rec."VAT Rate" := ObjFundsTaxCodes.Percentage;
                    Rec."Withholding Tax Amount" := (ObjFundsTaxCodes.Percentage * Amount) / 100;
                    Message('Rate Taxamount %1%2', Rec."VAT Rate", Rec."Withholding Tax Amount");
                end;
        ...
        field(24; "Withholding Tax Code"; Code[20])
        {
            ...
            begin
                ...
                if ObjFundsTaxCodes.Find('-') then begin
                    Rec."VAT Rate" := ObjFundsTaxCodes.Percentage;
                    Rec."Withholding Tax Amount" := ObjFundsTaxCodes.Percentage * Amount;
                end;
                Validate("Withholding Tax Amount");
            end;
        }
