...
Table 50069 "Payment Line."
{
    ...
    fields
    {
        ...
        field(172000; "Property Code"; Code[30])
        {
            //TableRelation = Table56123.Field1;
        }
        field(172001; "Transaction Code"; Code[30])
        {
            //TableRelation = Table56120.Field1;
        }
        field(172002; "Entry Type[Income/Expense]"; Option)
        {
            OptionCaption = ' ,Income,Expense';
            OptionMembers = " ",Income,Expense;
        }
        field(172003; "Asset No"; Code[10])
        {
