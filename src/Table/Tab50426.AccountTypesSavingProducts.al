...
Table 50426 "Account Types-Saving Products"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'SAVINGS,MPA,OTHERS';
        ...
        field(123; "Current Account"; boolean)
        {

        }
        field(124; "Group Account"; Boolean)
        {
        }
        field(125; "Is Share Capital"; Boolean)
        {
        }

        field(126; "Is Deposits"; Boolean)
        {
        }

        field(127; "Is ESS"; Boolean)
        {
        }
        field(128; "Withrawable"; Boolean)
        {
        }
        field(138; "Depositable"; Boolean)
        {
        }
        field(129; "Account Location"; Option)
        {
            OptionMembers = " ",FOSA,BOSA;
            OptionCaption= ' ,SAVINGS,MPA';
        }
        //New from .71
        
        field(130;"Allow Over Draft";Boolean)
        {
        }
        field(131;"Over Draft Interest %";Decimal)
        {
        }
        field(132;"Allow Multiple Over Draft";Boolean)
        {
        }
        field(133;"Over Draft Issue Charge A/C";Code[20])
        {
            TableRelation = "G/L Account";
        }
        field(134;"Store Series"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(135; "Is Business Account"; Boolean)
        {
        }
        field(136; "Paybill Code"; Code[20])
        {
        }
        field(137; "Allowable Withdrawals"; Integer)
        {
        }
        field(139; "Income Payment Code"; Code[20])
        {
        }
    }
