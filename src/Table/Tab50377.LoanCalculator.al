        ...
        field(2; "Loan Product Type"; Code[20])
        {
            ...
            begin
                ...
                if ObjLoanType.Find('-') then begin
                    ...
                    "Qualification As Per Deposit" := ("Current Deposits" * ObjLoanType."Deposits Multiplier") - "Total Loans Outstanding";
        ...
        field(32; "Total Deduction"; Decimal)
        {
            ...
            begin
                if Installments > 12 then
                    "Qualification As Per Salary" := ("Basic Pay" - ("1/3rd" + "Total Deduction")) / ((1 / Installments) + ("Interest rate" / 1200))
                else
                    "Qualification As Per Salary" := ("Basic Pay" - ("1/3rd" + "Total Deduction")) / ((1 / Installments) + ("Interest rate" / Installments))
            end;
