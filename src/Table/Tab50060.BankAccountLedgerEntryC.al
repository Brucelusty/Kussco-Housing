table 50060 "Bank Account Ledger EntryC"
{
    Caption = 'Posted Bank Account Ledger Entry';
    ...
    fields
    {
...
#if not CLEAN20
            // TableRelation = IF ("Statement Status" = FILTER("Bank Acc. Entry Applied" | "Check Entry Applied")) "Bank Acc. Statement Linevb"."Line No." WHERE("Bank Account No." = FIELD("Bank Account No."),
        ...
        field(50006; Payee; Text[2048])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(50007; "Item Specification"; Text[2048])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(50008; "Imprest Issued Doc No"; Code[100])
        {
            DataClassification = ToBeClassified;
            Editable = false;
        }
        field(50009; "Time Posted"; DateTime)
        {
            DataClassification = ToBeClassified;
            Editable = false;

        }
        field(50010; "Bank Narration"; Text[2048])
        {
            DataClassification = ToBeClassified;
        }
        field(50011; Reconciled; Boolean)
        {
    ...
    keys
    {
        key(Key1; "Entry No.", "Statement No.", "Document No.", "Statement Line No.")
        {
            Clustered = true;
        }
    ...
    procedure OnAfterCopyFromGenJnlLine(var BankAccountLedgerEntry: Record "Bank Account Ledger EntryC"; GenJournalLine: Record "Gen. Journal Line")
    begin
    end;
}
