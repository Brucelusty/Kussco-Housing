...
Table 50568 "Mpesa Transactions Header"
{
    ...
    fields
    {
        ...
        field(2; "Account No."; Code[20])
        {
            ...
            else if ("Account Type" = const("FOSA Loan")) "Members Register"."No." where("Customer Type" = const(Member))
            else if ("Account Type" = const(Vendor)) Vendor."No." where("Creditor Type" = filter("FOSA Account"));
        ...
        field(8; "Receipt Bank"; Code[20])
        {
            ...
            else if (Source = const(Fosa)) "Bank Account"."No.";
        }
        ...
        field(172003; "Mode of Payment"; Option)
        {
            OptionCaption = 'Mpesa';
            OptionMembers = Mpesa;
        }
        ...
        field(172013; "Transaction Type"; Option)
        {
