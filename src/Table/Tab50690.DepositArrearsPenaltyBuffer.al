...
Table 50690 "Deposit Arrears Penalty Buffer"
{
    Caption = 'Deposit Arrears Penalty Buffer';
    //nownPage51516799;
    //nownPage51516799;
    ...
    fields
    {
        ...
        field(51516162; Settled; Boolean)
        {
        }
        field(51516163; "Settled On"; Date)
        {
        }
        ...
        field(51516166; "Settled Amount"; Decimal)
        {
        }
