...
Table 50566 "Sacco Transfers"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = ',FOSA Account,BOSA Account,GL Account';
            OptionMembers = ,"FOSA Account","BOSA Account","GL Account";
        ...
        field(11; "Source Account No."; Code[20])
        {
            ...
            TableRelation = if ("Source Account Type" = const("FOSA Account")) Vendor."No."
            else
            if ("Source Account Type" = const("BOSA Account")) Customer."No."
            else
            if ("Source Account Type" = const("GL Account")) "G/L Account"."No.";
            ...
            begin
                ...
                if ("Source Transaction Type" = "source transaction type"::"Deposit Contribution") then begin
                    ...
                    if ObjCust.Find('-') then begin
                        ...
                        //Rec."Header Amount" := ObjCust."Current Shares";
                    end
                end;
        ...
        {
            TableRelation = if ("Source Account Type" = filter("BOSA Account")) "Loans Register"."Loan  No." where("Client Code" = field("Source Account No."));
        ...
        field(51516066; "Header Amount"; Decimal)
        {
            ...
            begin
                ...
                // if "Charge Transfer Fee" = false then
                //  NetTransferable := "Header Amount";
    ...
    begin
        if No = '' then begin
            ...
            NoSeriesMgt.GetNextNo(NoSetup."Account Transfer Nos");
        end;
