...
Table 50371 "Loan Collateral Details"
{
    ...
    fields
    {
        ...
        field(6; Value; Decimal)
        {
            ...
            begin
                ...
                if ObjCollateralReg.Get("Collateral Register Doc") then begin
        ...
        field(8; "Code"; Code[20])
        {
            ...
            begin
                ...
                SecSetup.Reset;
                SecSetup.SetRange(SecSetup.Code, "Collateral Register Doc");
                if SecSetup.Find('-') then begin

                    Type := SecSetup.Type;
                    "Security Details" := SecSetup."Security Description";
                    "Collateral Multiplier" := SecSetup."Value Considered";
                    "Guarantee Value" := Value * "Collateral Multiplier" / 100;
                    Category := SecSetup.Category;
                    //Message('Multiplier%1',SecSetup."Value Considered");
                end;
                //END;
        ...
        field(16; "Comitted Collateral Value"; Decimal)
        {
            ...
            // CalcFormula = sum("Loan Collateral Details"."Guarantee Value" where )
        }
        field(17; "Collateral Register Doc"; Code[50])
        {
            TableRelation = "Loan Collateral Register"."Document No" where(Bonded = filter(true));
            ...
            begin
                if ObjCollateralReg.Get("Collateral Register Doc") then begin
                    ...
                    Value := ObjCollateralReg."Forced Sale Value";
                    "Comitted Collateral Value" := ObjCollateralReg."Guaranteed Amount";
                    ...
                    SecSetup.Reset;
                    SecSetup.SetRange(SecSetup.Code, ObjCollateralReg."Collateral Code");
                    if SecSetup.Find('-') then begin
        ...
        field(27; "Current Value"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = lookup("Collateral Valuation"."Market Value" where("Current Valuation" = filter(true), "Collateral ID" = field("Collateral Register Doc")));
            Editable = false;
        }
    }
    ...
    keys
    {
        key(Key1; "Loan No", Type, "Security Details", "Code", "Document No", "Registration/Reference No", "Collateral Register Doc")
        {
            Clustered = true;
        }
    }
