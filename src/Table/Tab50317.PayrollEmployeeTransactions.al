...
Table 50317 "Payroll Employee Transactions."
{
    ...
    fields
    {
        ...
        {
            TableRelation = Customer where("No." = field("Sacco Membership No."));
        ...
        field(33; "Loan Number"; Code[20])
        {
            ...
            begin
                ...
                Loans.SetRange(Loans."Client Code", "Sacco Membership No.");
                if Loans.Find('-') then begin
                    ...
                    "Outstanding Interest" := Loans."Outstanding Interest";//Loans."Oustanding Interest";
        ...
        field(45; "Original Deduction Amount"; Decimal)
        {
            ...
            begin
                cust.Reset();
                cust.SetRange("Payroll No", "No.");
                if cust.Find('-') then begin
                    if "Transaction Code" = 'D001' then begin
                        cust."Monthly Contribution":= "Original Deduction Amount";
                    end;
                    if "Transaction Code" = 'D002' then begin
                        cust."ESS Contribution":= "Original Deduction Amount";
                    end;
                    cust.modify;
                end;
        ...
        field(47; FirstEntry; Boolean)
        {
        }
        field(48; "Is Redundant"; Boolean)
        {
        }
    }
