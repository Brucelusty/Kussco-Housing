...
Table 50395 "Sacco No. Series"
{
    ...
    fields
    {
        ...
        field(10; "Account Transfer Nos"; Code[10])
        {
            TableRelation = "No. Series";
        }
        ...
        field(73; "RTGS Header Nos."; Code[10])
        {
            TableRelation = "No. Series";
        }
        ...
        field(66; "FOSA Receipts Nos"; Code[10])
        {
            TableRelation = "No. Series";
        }
        field(67; "Exit Batch Nos"; Code[10])
        {
            TableRelation = "No. Series";
        }
        field(68; "Meeting Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(70; "Funeral Rider Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(71; "ESS Refund Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(72; "ESS Refund Batch Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(80; "Call Deposit Placement"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(81; "Delegate Allowance Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(82; "Savings Variation Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(83; "Pin Reset Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(77; "Petty Cash Requisition Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(74; "Insurance Claim Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(75; "Salary Registration Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(76; "Staff Payment Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        ...
        field(54266; "File Return Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(54267; "New Fixed Deposits"; Code[20])
        {
            TableRelation = "No. Series";
        }
        field(54268; "NOK Application Nos"; Code[20])
        {
            TableRelation = "No. Series";
        }

        field(284; "Sacco Correspondence Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;
        }
        ...
        field(51516084; "Delayed Salary No"; Code[20])
        {
            DataClassification = ToBeClassified;
            TableRelation = "No. Series";
        }
        field(51516085; "CLosure Notice Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;

        }
        field(51516086; "Business Comp Payroll Nos"; Code[20])
        {
            TableRelation = "No. Series".Code;

        }
        field(51516087; "Group Application Nos"; code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(51516088; "Prime Tech Payroll Nos"; code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(51516089; "Reat Security Payroll Nos"; code[20])
        {
            TableRelation = "No. Series".Code;
        }
        field(51516090; "Coop Dividends"; code[20])
        {
            TableRelation = "No. Series".Code;//"Contact Nos"
        }

        field(51516091; "Contact Nos"; code[20])
        {
            TableRelation = "No. Series".Code;//"Contact Nos"
        }
        field(51516092; "BD Partner Nos."; Code[20])
        {
            Caption = 'BD Partner Nos.';
            TableRelation = "No. Series";
        }

        field(51516093; "BD Opportunity Nos."; Code[20])
        {
            Caption = 'BD Opportunity Nos.';
            TableRelation = "No. Series";
        }

        field(51516094; "BD Activity Nos."; Code[20])
        {
            Caption = 'BD Activity Nos.';
            TableRelation = "No. Series";
        }
        field(51516095; "Defaulter Case No"; Code[20])
        {
            Caption = 'Defaulter Case No';
            TableRelation = "No. Series";
        }

        field(51516096; "Risk Nos"; Code[20])
        {
            Caption = 'Risk Numbers';
            TableRelation = "No. Series";
        }
        field(51516097; "Tranche Nos"; Code[20])
        {
            Caption = 'Tranche Numbers';
            TableRelation = "No. Series";
        }
        field(51516098; "Performance Header No"; Code[20])
        {
            Caption = 'Performance Header No';
            TableRelation = "No. Series";
        }
        field(51516099; "Commission Nos"; Code[20])
        {
            Caption = 'Commission Nos';
            TableRelation = "No. Series";
        }
        field(51516100; "Junior Account Nos"; Code[20])
        {
            Caption = 'Junior Account Nos';
            TableRelation = "No. Series";
        }
        field(51516101; "Debenture Nos"; Code[20])
        {
            Caption = 'Debenture Nos';
            TableRelation = "No. Series";
        }
    }
