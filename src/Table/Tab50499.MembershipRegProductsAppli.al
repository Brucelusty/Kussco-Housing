...
Table 50499 "Membership Reg. Products Appli"
{
    ...
    fields
    {
        ...
        {
           // TableRelation = if ("Account Category" = filter('Individual')) "Account Types-Saving Products".Code where("Individual Account" = filter(true))
           // else
           // if ("Account Category" = filter('Group')) "Account Types-Saving Products".Code where("Group Account" = filter(true))
           // else
        ...
        field(8; "Account Category"; Text[100])
        {
