...
Table 50540 "Loan Member Loans"
{
    ...
    fields
    {
            ...
            begin
                ...
                // if Confirm('Are you Sure you Want to PayOff this loan?', true) = true then begin
                    ...
                    if Loans.Find('-') then begin
                        ...
                        "Loan Type" := Loans."Loan Product Type Name";
        ...
        {
            CalcFormula = sum("Loans Guarantee Details"."Amont Guaranteed" where("Member No" = field("Guarantor Number"), "Loan Balance" = filter(<> 0)));
            FieldClass = FlowField;
        }
        ...
        field(30; "Guarantor Amount Apportioned"; Decimal)
        {
            trigger OnValidate() begin
                principalRatio := 0;
                GuarantorRecH.Reset();
                GuarantorRecH.SetRange("Document No", "Document No");
                if GuarantorRecH.Find('-') then begin
                    principalRatio := GuarantorRecH."Loan Liabilities"/ GuarantorRecH."Loan Distributed to Guarantors";

                    "Principal Liability" := "Guarantor Amount Apportioned" * principalRatio;
                    "Interest Liability" := "Guarantor Amount Apportioned" - "Principal Liability";
                end;
            end;
        }
        ...
        field(32; Cleared; Boolean)
        {
        }
        field(33; Difference; Decimal)
        {
        }
        field(34; "Total Liability"; Decimal)
        {
            FieldClass = FlowField;
            CalcFormula = sum("Loan Member Loans"."Guarantor Amount Apportioned" where("Document No" = field("Document No")));
        }
        field(35; "Principal Liability"; Decimal)
        {
            
        }
        field(36; "Interest Liability"; Decimal)
        {
