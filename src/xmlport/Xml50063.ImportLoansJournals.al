...
XmlPort 50063 "Import Loans Journals"
{
    Format = VariableText;
    ...
    schema
    {
        textelement(root)
        {
            tableelement("Gen. Journal Line"; "Gen. Journal Line")
            {
                ...
                fieldelement(F; "Gen. Journal Line"."Transaction Type")
                {
                }
                ...
                fieldelement(K; "Gen. Journal Line"."Shortcut Dimension 1 Code")
                {
                }
                fieldelement(L; "Gen. Journal Line"."Shortcut Dimension 2 Code")
                {
                }
                fieldelement(M; "Gen. Journal Line"."Loan No")
                {
                }
