...
Codeunit 50027 "Payroll Processing"
{
    // ++Note
        ...
        if curBasicPay > 0 then begin
           ...
           Coopparameters::none);
            ...
            if blnPaysNhif then begin
                ...
                curSHIF := (shifPercent*curNhif_Base_Amount);
                if curSHIF < shifMin then curSHIF := shifMin;
                ...
                fnUpdatePeriodTrans(strEmpCode, 'SHIF', TGroup, TGroupOrder, TSubGroupOrder, strTransDescription,
                 ...
                 NHIFEMPyee, Journalpostas::Credit, Journalpostingtype::"G/L Account", '', Coopparameters::SHIF);
            end;
            ...
            if prEmployeeTransactions.Find('-') then begin
             ...
             //==================================================================What Is This? Victor */
                ...
                curTotalDeductions := ROUND(curTotalDeductions, 0.01, '=') + ROUND(curNSSF, 0.01, '=') + ROUND(curSHIF, 0.01, '=') +
