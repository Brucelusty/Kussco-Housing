...
codeunit 50126 "Bank. Acc. Recon. Post Prev"
{
    ...
    procedure Preview(var Subscriber: Codeunit "Bank Acc. Reconc Post II"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    ...
    [CommitBehavior(CommitBehavior::Ignore)]
    local procedure PreviewStart(var Subscriber: Codeunit "Bank Acc. Reconc Post II"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    var
    ...
    local procedure RunPreview(var Subscriber: Codeunit "Bank Acc. Reconc Post II"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation"): Boolean
    var
        Result: Boolean;
    begin
    ...
    procedure SetContext(var Subscriber: Codeunit "Bank Acc. Reconc Post II"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    ...
    local procedure OnBeforeRunPreview(var Subscriber: Codeunit "Bank Acc. Reconc Post II"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    end;

    [IntegrationEvent(false, false)]
    local procedure OnRunPreview(var Result: Boolean; var Subscriber: Codeunit "Bank Acc. Reconc Post II"; var BankAccReconciliationSource: Record "Bank Acc. Reconciliation")
    begin
    end;
