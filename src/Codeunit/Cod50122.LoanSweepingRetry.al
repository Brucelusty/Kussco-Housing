codeunit 50122 "Loan Sweeping Retry"
{
    ...
    begin
        ...
        DOCUMENT_NO := 'LNRECOV ' + Format(Today);
        Vendor.Reset();
                ...
                if VBalance > 0 then begin
                    ...
                    IF Loans.FindSet() then BEGIN
                        repeat
                            ...
                            //     smsManagement.SendSmsWithID(Source::LOAN_DEFAULTED, Members."Mobile Phone No", CreationMessage, Members."No.", Members."FOSA Account No.", TRUE, 200, TRUE, 'CBS', CreateGuid(), 'CBS');
                            // end;
