...
Codeunit 50036 "IPRS Details"
{
    ...
    var
        ...
        SurePESATrans: Record "Mobile Transactions";
    ...
    begin
        ...
        MembApp.SetRange(MembApp."Membership Approval Status", MembApp."Membership Approval Status"::Open);
