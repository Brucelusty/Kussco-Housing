...
Codeunit 50030 "Dates Calculation"
{
    ...
    var
        AbsenceHoliday: Record "Control-Information";
        OK: Boolean;
    begin
    ...
    var
        StatutoryHoliday: Record "Control-Information";
        NextDay: Date;
    begin
        /*Holiday:= 0;
        WHILE (DateStart <= DateEnd) DO BEGIN
    ...
    procedure DetermineMonthText(nDate: Date) strDate: Text[30]
    var
        lMonth: Integer;
        StrMonth: Text[20];
    begin
    ...
    procedure GetMonth(nDate: Date) strDate: Text[30]
    var
        lDay: Integer;
        lMonth: Integer;
        lYear: Integer;
