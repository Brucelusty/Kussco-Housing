...
Codeunit 50040 "POST FB  ATM"
{
    ...
    trigger OnRun()
    begin
        //MESSAGE('%1',InsertFBAtmCharges('0200','001401012073','254713213296','002172604',3000,'0000324411515','117210115','ELDORET UGANDA RD 2 Eldoret',TODAY,'00',FALSE,TODAY));
        //MESSAGE(FORMAT(fnFBATMCHARGES('Family')));
        //MESSAGE(FORMAT(getAccountBalance('0014017200026')));
        //MESSAGE(FORMAT(fnFBATMCHARGES('FAMILY')));
        //PostTrans();
    end;
    ...
    procedure PostTrans(Reference: Code[100]): Boolean
    var
        processed: Boolean;
        time_processed: Time;
        CrNarration: Text;
        ...
        if ATMTrans.Find('-') then begin
            ...
            if ATMTrans."Transaction Type Charges" = ATMTrans."transaction type charges"::Reversal then begin
                ...
                if (Reversals2.Find('-')) then begin
                    ...
                    DrNarration := 'Reverse - ATM Withdrawal at Family Bank ' + Reversals2."Withdrawal Location" + ' Acc. ' + Reversals2."Account No" + ' ' + Acct.Name;
                    DrTax := 'Reverse - Charge: ATM Withdrawal at Family Bank ' + Reversals2."Withdrawal Location";
                    CrTax := 'Reverse - Tax: ATM Withdrawal at Family Bank ' + Reversals2."Withdrawal Location" + ' Acc. ' + Reversals2."Account No" + ' ' + Acct.Name;
                    CrNarration := 'Reverse - Charge: ATM Withdrawal at Family Bank ' + Reversals2."Withdrawal Location" + ' Acc. ' + Reversals2."Account No" + ' ' + Acct.Name;
                    DrVendor := 'Reverse - ATM Withdrawal at Family Bank ' + Reversals2."Withdrawal Location";
            ...
            if Acct.Get(ATMTrans."Account No") then begin
                ...
                if (ATMTrans."Transaction Type Charges" <> ATMTrans."transaction type charges"::Reversal) then begin
                    ...
                    DrNarration := 'ATM Withdrawal at Family Bank ' + ATMTrans."Withdrawal Location" + ' Acc. ' + ATMTrans."Account No" + ' ' + Acct.Name;
                    DrTax := 'Charge: ATM Withdrawal at Family Bank ' + ATMTrans."Withdrawal Location";
                    CrTax := 'Tax: ATM Withdrawal at Family Bank ' + ATMTrans."Withdrawal Location" + ' ' + Acct.Name;
                    CrNarration := 'Charge: ATM Withdrawal at Family Bank ' + ATMTrans."Withdrawal Location" + ' Acc. ' + ATMTrans."Account No" + ' ' + Acct.Name;
                    DrVendor := 'ATM Withdrawal at Family Bank ' + ATMTrans."Withdrawal Location";
                end;
