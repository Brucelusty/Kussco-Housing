...
Codeunit 50033 "CloudPESALive"
{
    ...
    begin
        ...
        //MESSAGE(FundsTransferBOSA('2747-007004-01','Shares Capital','7481722660',800));
                        ...
                        if (TempBalance > amount + TotalCharges + ExcDuty) then begin
                            if LoansRegister."Outstanding Balance" > 50 then begin
                                ...
                                if amount > 0 then begin
                                    ...
                                    GenJournalLine."External Document No." := '';
                                    GenJournalLine."Posting Date" := Today;
                                    GenJournalLine.Description := Format(GenJournalLine."Transaction Type"::Repayment);
                                    GenJournalLine.Amount := -amount;
                                    GenJournalLine.Validate(GenJournalLine.Amount);
    ...
    var
        MobileTariffs: Record "Mobile Tariffs";
    begin
        Charges.Reset;
