...
codeunit 50125 "Bank Acc. Reconc Post II"
{
    ...
    begin
        ...
        case BankAccRecon."Statement Type" of
            BankAccRecon."Statement Type"::"Bank Reconciliation":
                FeatureTelemetry.LogUptake('0000JLO', //BankAccRecon.GetBankReconciliationTelemetryFeatureName()
                'Bank reconciliation', Enum::"Feature Uptake Status"::Used);
            BankAccRecon."Statement Type"::"Payment Application":
                FeatureTelemetry.LogUptake('0000KMI', //BankAccReconLine.GetPaymentRecJournalTelemetryFeatureName()
                'Payment Reconciliation', Enum::"Feature Uptake Status"::Used);
        end;
            ...
            case "Statement Type" of
                "Statement Type"::"Bank Reconciliation":
                    begin
                        ...
                        FeatureTelemetry.LogUsage('0000JLP', //BankAccRecon.GetBankReconciliationTelemetryFeatureName()
                        'Bank reconciliation', EventNameTelemetryTxt);
                ...
                "Statement Type"::"Payment Application":
                    begin
                        ...
                        FeatureTelemetry.LogUsage('0000KMJ', //BankAccReconLine.GetPaymentRecJournalTelemetryFeatureName()
                        'Payment Reconciliation', EventNameTelemetryPmtTxt);
    ...
    begin
        ...
        if BankAccReconLine.Reconciled = true then begin
    ...
    begin
        ...
        // bankAcc.Reset();
        // bankAcc.SetRange("Date Filter", 0D, BankAccStmt."Statement Date");
        BankAccStmt."Cash Book Balance" := PrePostingGLBalance;
        if BankAccReconLine.LinesExist(BankAccRecon) then
            repeat
                BankAccStmtLine.TransferFields(BankAccReconLine);
                BankAccStmtLine."Statement No." := BankAccStmt."Statement No.";
                BankAccStmtLine.Reconciled := BankAccReconLine.Reconciled;
                // BankAccStmtLine."Reconciling Date" := 
    ...
    var
        BankAccReconPostPreview: Codeunit "Bank. Acc. Recon. Post Prev";
        BankAccountReconciliationPost: Codeunit "Bank Acc. Reconc Post II";
    begin
    ...
    [EventSubscriber(ObjectType::Codeunit, Codeunit::"Bank. Acc. Recon. Post Prev", 'OnRunPreview', '', false, false)]
