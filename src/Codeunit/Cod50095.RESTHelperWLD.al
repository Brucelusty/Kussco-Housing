codeunit 50095 "REST Helper WLD"
{
    Access = Public;
    ...
    procedure Send(body: Text; url: Text) SendSuccess: Boolean
    var
    ...
    begin
        if ContentTypeSet then begin
            ...
            WebRequest.GetHeaders(WebContentHeaders);
        ...
        SendSuccess := WebClient.Post(url, WebContent, WebResponse);
