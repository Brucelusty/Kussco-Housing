...
Codeunit 50031 "CloudPESABulkSMS"
{
    ...
    procedure PollPendingSMSNew() MessageDetails: Text
    begin
        ...
        if SMSMessages.Find('-') then begin
            ...
            if (SMSMessages."Telephone No" = '') or (SMSMessages."Telephone No" = '+') or (SMSMessages."SMS Message" = '') then begin
                ...
                MessageDetails += ' {';
                MessageDetails += ' "api_key":"PgDWYcC9BrZEkHo4GysMfT5QvSK3xeRObJta7F21NimzLhUwV6I8Ap0nludqjX",';
                MessageDetails += '"service_id":0,';
                MessageDetails += '"mobile":"' + SMSMessages."Telephone No" + '",';
                MessageDetails += '"response_type":"json",';
                MessageDetails += '"shortcode":"Tilil",';
                MessageDetails += '"message":"' + SMSMessages."SMS Message" + '",';
                MessageDetails += '"date_send":"' + FORMAT(CurrentDateTime, 0, '<Year4>-<Month,2>-<Day,2> <Hours24,2>:<Minutes,2>:<Seconds,2>') + '",';
                MessageDetails += '}';
