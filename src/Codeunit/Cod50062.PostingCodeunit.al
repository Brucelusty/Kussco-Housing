//************************************************************************
codeunit 50062 "PostingCodeunit"
{
    trigger OnRun()
    begin
    ...
    begin
        with GenJournalLine do begin
            ...
            if (GenJournalLine."Transaction Type" = GenJournalLine."transaction type"::" ") then begin
                MembPostingGr.TestField(MembPostingGr."Coop Shares Account");
                MembPostingGr."Receivables Account" := MembPostingGr."Coop Shares Account";
                Found := true;
            end;
    ...
    var
        ...
        TransferCustomFields: Codeunit "Transfer Custom Field";
        ...
        ComputerName: Codeunit "Au Factory";
        NextEntryNo: Integer;
